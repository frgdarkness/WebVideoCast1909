...
.method private createCallAdapter()Lretrofit2/CallAdapter;
    ...
    invoke-virtual {v4, v2, v3}, Lretrofit2/Retrofit;->callAdapter(Ljava/lang/reflect/Type;[Ljava/lang/annotation/Annotation;)Lretrofit2/CallAdapter;
    ...
    invoke-direct {p0, v3, v4, v0}, Lretrofit2/ServiceMethod$Builder;->methodError(Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/RuntimeException;
...
.method private parseHeaders([Ljava/lang/String;)Lokhttp3/Headers;
    ...
    iput-object v6, p0, Lretrofit2/ServiceMethod$Builder;->contentType:Lokhttp3/MediaType;
...
.method private validatePathName(ILjava/lang/String;)V
    ...
    sget-object v3, Lretrofit2/ServiceMethod;->PARAM_NAME_REGEX:Ljava/util/regex/Pattern;
    ...
    iget-object v3, p0, Lretrofit2/ServiceMethod$Builder;->relativeUrlParamNames:Ljava/util/Set;
    ...
    invoke-direct {p0, p1, p2, v2}, Lretrofit2/ServiceMethod$Builder;->parameterError(ILjava/lang/String;[Ljava/lang/Object;)Ljava/lang/RuntimeException;
...
.method public build()Lretrofit2/ServiceMethod;
    ...
    iput-object v1, p0, Lretrofit2/ServiceMethod$Builder;->callAdapter:Lretrofit2/CallAdapter;

    invoke-interface {v1}, Lretrofit2/CallAdapter;->responseType()Ljava/lang/reflect/Type;

    move-result-object v1

    iput-object v1, p0, Lretrofit2/ServiceMethod$Builder;->responseType:Ljava/lang/reflect/Type;
    ...
    iput-object v1, p0, Lretrofit2/ServiceMethod$Builder;->responseConverter:Lretrofit2/Converter;
    ...
    invoke-direct {p0, v5}, Lretrofit2/ServiceMethod$Builder;->parseMethodAnnotation(Ljava/lang/annotation/Annotation;)V
    ...
    :cond_3
    :goto_1
    iget-object v1, p0, Lretrofit2/ServiceMethod$Builder;->parameterAnnotationsArray:[[Ljava/lang/annotation/Annotation;

    array-length v1, v1

    new-array v2, v1, [Lretrofit2/ParameterHandler;

    iput-object v2, p0, Lretrofit2/ServiceMethod$Builder;->parameterHandlers:[Lretrofit2/ParameterHandler;
    ...
    iget-object v6, p0, Lretrofit2/ServiceMethod$Builder;->parameterHandlers:[Lretrofit2/ParameterHandler;

    invoke-direct {p0, v2, v4, v5}, Lretrofit2/ServiceMethod$Builder;->parseParameter(ILjava/lang/reflect/Type;[Ljava/lang/annotation/Annotation;)Lretrofit2/ParameterHandler;
    ...
    invoke-direct {p0, v2, v0, v1}, Lretrofit2/ServiceMethod$Builder;->parameterError(ILjava/lang/String;[Ljava/lang/Object;)Ljava/lang/RuntimeException;
    ...
    invoke-direct {p0, v2, v1, v0}, Lretrofit2/ServiceMethod$Builder;->parameterError(ILjava/lang/String;[Ljava/lang/Object;)Ljava/lang/RuntimeException;
