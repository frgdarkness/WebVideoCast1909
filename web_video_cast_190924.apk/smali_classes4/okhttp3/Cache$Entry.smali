...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lokhttp3/Cache$Entry$Companion;-><init>(Ljx;)V
...
.method public constructor <init>(LcN0;)V
    ...
    invoke-interface {v0}, Lsf;->readUtf8LineStrict()Ljava/lang/String;
    ...
    invoke-virtual {v2, v0}, Lokhttp3/Cache$Companion;->readInt$okhttp(Lsf;)I
    ...
    invoke-direct {p0, v0}, Lokhttp3/Cache$Entry;->readCertificateList(Lsf;)Ljava/util/List;
...
.method private final readCertificateList(Lsf;)Ljava/util/List;
    .locals 7
    ...
    invoke-virtual {v0, p1}, Lokhttp3/Cache$Companion;->readInt$okhttp(Lsf;)I
    ...
    invoke-interface {p1}, Lsf;->readUtf8LineStrict()Ljava/lang/String;

    move-result-object v4

    new-instance v5, Lif;

    invoke-direct {v5}, Lif;-><init>()V

    sget-object v6, Lmg;->d:Lmg$a;

    invoke-virtual {v6, v4}, Lmg$a;->a(Ljava/lang/String;)Lmg;

    move-result-object v4

    if-eqz v4, :cond_1

    invoke-virtual {v5, v4}, Lif;->W(Lmg;)Lif;

    invoke-virtual {v5}, Lif;->inputStream()Ljava/io/InputStream;
...
.method private final writeCertList(Lrf;Ljava/util/List;)V
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p1, v0, v1}, Lrf;->writeDecimalLong(J)Lrf;
    ...
    invoke-static/range {v2 .. v7}, Lmg$a;->g(Lmg$a;[BIIILjava/lang/Object;)Lmg;
...
.method public final writeTo(Lokhttp3/internal/cache/DiskLruCache$Editor;)V
    ...
    invoke-virtual {p1, v0}, Lokhttp3/internal/cache/DiskLruCache$Editor;->newSink(I)LfM0;
    ...
    invoke-interface {p1, v3, v4}, Lrf;->writeDecimalLong(J)Lrf;
    ...
    invoke-interface {p1, v5}, Lrf;->writeUtf8(Ljava/lang/String;)Lrf;

    move-result-object v5

    invoke-interface {v5, v4}, Lrf;->writeUtf8(Ljava/lang/String;)Lrf;
    ...
    invoke-interface {v4, v5}, Lrf;->writeUtf8(Ljava/lang/String;)Lrf;

    move-result-object v4

    invoke-interface {v4, v2}, Lrf;->writeByte(I)Lrf;
    ...
    invoke-interface {p1, v5, v6}, Lrf;->writeDecimalLong(J)Lrf;
    ...
    invoke-interface {p1, v3}, Lrf;->writeUtf8(Ljava/lang/String;)Lrf;

    move-result-object v3

    invoke-interface {v3, v4}, Lrf;->writeUtf8(Ljava/lang/String;)Lrf;
    ...
    invoke-interface {v3, v5}, Lrf;->writeUtf8(Ljava/lang/String;)Lrf;

    move-result-object v3

    invoke-interface {v3, v2}, Lrf;->writeByte(I)Lrf;
    ...
    invoke-interface {v0, v5, v6}, Lrf;->writeDecimalLong(J)Lrf;
    ...
    invoke-interface {p1, v2}, Lrf;->writeByte(I)Lrf;
    ...
    invoke-direct {p0, p1, v0}, Lokhttp3/Cache$Entry;->writeCertList(Lrf;Ljava/util/List;)V
