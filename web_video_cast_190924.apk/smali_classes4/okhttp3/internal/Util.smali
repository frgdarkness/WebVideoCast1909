...
.field private static final UNICODE_BOMS:Lor0;

.field public static final UTC:Ljava/util/TimeZone;

.field private static final VERIFY_AS_IP_ADDRESS:LqB0;
...
.method static constructor <clinit>()V
    ...
    sget-object v1, Lor0;->d:Lor0$a;

    sget-object v2, Lmg;->d:Lmg$a;

    const-string v3, "efbbbf"

    invoke-virtual {v2, v3}, Lmg$a;->b(Ljava/lang/String;)Lmg;

    move-result-object v3

    const-string v4, "feff"

    invoke-virtual {v2, v4}, Lmg$a;->b(Ljava/lang/String;)Lmg;

    move-result-object v4

    const-string v5, "fffe"

    invoke-virtual {v2, v5}, Lmg$a;->b(Ljava/lang/String;)Lmg;

    move-result-object v5

    const-string v6, "0000ffff"

    invoke-virtual {v2, v6}, Lmg$a;->b(Ljava/lang/String;)Lmg;

    move-result-object v6

    const-string v7, "ffff0000"

    invoke-virtual {v2, v7}, Lmg$a;->b(Ljava/lang/String;)Lmg;
    ...
    invoke-virtual {v1, v7}, Lor0$a;->d([Lmg;)Lor0;

    move-result-object v1

    sput-object v1, Lokhttp3/internal/Util;->UNICODE_BOMS:Lor0;
    ...
    sput-object v1, Lokhttp3/internal/Util;->VERIFY_AS_IP_ADDRESS:LqB0;
    ...
    invoke-static {v0, v1}, LhQ0;->s0(Ljava/lang/String;Ljava/lang/CharSequence;)Ljava/lang/String;

    move-result-object v0

    const-string v1, "Client"

    invoke-static {v0, v1}, LhQ0;->t0(Ljava/lang/String;Ljava/lang/CharSequence;)Ljava/lang/String;
...
.method public static final asFactory(Lokhttp3/EventListener;)Lokhttp3/EventListener$Factory;
    ...
    invoke-direct {v0, p0}, Ln41;-><init>(Lokhttp3/EventListener;)V
...
.method public static final canParseAsIpAddress(Ljava/lang/String;)Z
    ...
    sget-object v0, Lokhttp3/internal/Util;->VERIFY_AS_IP_ADDRESS:LqB0;

    invoke-virtual {v0, p0}, LqB0;->e(Ljava/lang/CharSequence;)Z
...
.method public static final concat([Ljava/lang/String;Ljava/lang/String;)[Ljava/lang/String;
    ...
    invoke-static {p0}, Lt8;->E([Ljava/lang/Object;)I
...
.method public static final delimiterOffset(Ljava/lang/String;Ljava/lang/String;II)I
    ...
    invoke-static {p1, v0, v3, v1, v2}, LhQ0;->O(Ljava/lang/CharSequence;CZILjava/lang/Object;)Z
...
.method public static final discard(LcN0;ILjava/util/concurrent/TimeUnit;)Z
    .locals 1
    ...
    :try_start_0
    invoke-static {p0, p1, p2}, Lokhttp3/internal/Util;->skipAll(LcN0;ILjava/util/concurrent/TimeUnit;)Z
...
.method public static final filterList(Ljava/lang/Iterable;LVM;)Ljava/util/List;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-static {v0}, Ll01;->c(Ljava/lang/Object;)Ljava/util/List;
...
.method public static final ignoreIoExceptions(LTM;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static final isCivilized(Lokhttp3/internal/io/FileSystem;Ljava/io/File;)Z
    ...
    invoke-interface {p0, p1}, Lokhttp3/internal/io/FileSystem;->sink(Ljava/io/File;)LfM0;
...
.method public static final isHealthy(Ljava/net/Socket;Lsf;)Z
    .locals 2
    ...
    invoke-interface {p1}, Lsf;->exhausted()Z
...
.method public static final isSensitiveHeader(Ljava/lang/String;)Z
    ...
    invoke-static {p0, v0, v1}, LhQ0;->w(Ljava/lang/String;Ljava/lang/String;Z)Z
...
.method public static final readBomAsCharset(Lsf;Ljava/nio/charset/Charset;)Ljava/nio/charset/Charset;
    .locals 1
    ...
    sget-object v0, Lokhttp3/internal/Util;->UNICODE_BOMS:Lor0;

    invoke-interface {p0, v0}, Lsf;->u(Lor0;)I
    ...
    sget-object p0, LDi;->a:LDi;

    invoke-virtual {p0}, LDi;->b()Ljava/nio/charset/Charset;
    ...
    invoke-virtual {p0}, LDi;->a()Ljava/nio/charset/Charset;
...
.method public static final readMedium(Lsf;)I
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-interface {p0}, Lsf;->readByte()B
...
.method public static final skipAll(Lif;B)I
    .locals 3
...
.method public static final skipAll(LcN0;ILjava/util/concurrent/TimeUnit;)Z
    .locals 11
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-interface {p0}, LcN0;->timeout()LmX0;

    move-result-object v2

    invoke-virtual {v2}, LmX0;->hasDeadline()Z
    ...
    invoke-virtual {v2}, LmX0;->deadlineNanoTime()J
    ...
    invoke-virtual {v2, p1, p2}, LmX0;->deadlineNanoTime(J)LmX0;
    ...
    invoke-interface {p0, p1, v7, v8}, LcN0;->read(Lif;J)J
...
.method public static final threadFactory(Ljava/lang/String;Z)Ljava/util/concurrent/ThreadFactory;
    ...
    invoke-direct {v0, p0, p1}, Lo41;-><init>(Ljava/lang/String;Z)V
...
.method public static final threadName(Ljava/lang/String;LTM;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p0}, LSU;->b(I)V

    invoke-virtual {v0, v1}, Ljava/lang/Thread;->setName(Ljava/lang/String;)V

    invoke-static {p0}, LSU;->a(I)V
...
.method public static final toHeaderList(Lokhttp3/Headers;)Ljava/util/List;
    ...
    invoke-static {v1, v0}, LvA0;->k(II)LwV;
...
.method public static final toHeaders(Ljava/util/List;)Lokhttp3/Headers;
    ...
    invoke-virtual {v1}, Lokhttp3/internal/http2/Header;->component1()Lmg;

    move-result-object v2

    invoke-virtual {v1}, Lokhttp3/internal/http2/Header;->component2()Lmg;

    move-result-object v1

    invoke-virtual {v2}, Lmg;->z()Ljava/lang/String;
...
.method public static final withSuppressed(Ljava/lang/Exception;Ljava/util/List;)Ljava/lang/Throwable;
    ...
    invoke-static {p0, v0}, LdG;->a(Ljava/lang/Throwable;Ljava/lang/Throwable;)V
...
.method public static final writeMedium(Lrf;I)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-interface {p0, v0}, Lrf;->writeByte(I)Lrf;
    ...
    invoke-interface {p0, p1}, Lrf;->writeByte(I)Lrf;
