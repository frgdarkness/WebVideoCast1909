...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lokhttp3/internal/ws/RealWebSocket$Companion;-><init>(Ljx;)V
...
.method public constructor <init>(Lokhttp3/internal/concurrent/TaskRunner;Lokhttp3/Request;Lokhttp3/WebSocketListener;Ljava/util/Random;JLokhttp3/internal/ws/WebSocketExtensions;J)V
    ...
    invoke-static/range {p2 .. p7}, Lmg$a;->g(Lmg$a;[BIIILjava/lang/Object;)Lmg;
...
.method private final isValid(Lokhttp3/internal/ws/WebSocketExtensions;)Z
    ...
    invoke-direct {v0, v2, v3}, LwV;-><init>(II)V
...
.method private final declared-synchronized send(Lmg;I)Z
    .locals 6
    ...
    invoke-direct {v1, p2, p1}, Lokhttp3/internal/ws/RealWebSocket$Message;-><init>(ILmg;)V
...
.method public final declared-synchronized close(ILjava/lang/String;J)Z
    ...
    invoke-direct {v2, p1, v0, p3, p4}, Lokhttp3/internal/ws/RealWebSocket$Close;-><init>(ILmg;J)V
...
.method public final initReaderAndWriter(Ljava/lang/String;Lokhttp3/internal/ws/RealWebSocket$Streams;)V
    ...
    invoke-virtual {p2}, Lokhttp3/internal/ws/RealWebSocket$Streams;->getSink()Lrf;
    ...
    invoke-direct/range {v1 .. v8}, Lokhttp3/internal/ws/WebSocketWriter;-><init>(ZLrf;Ljava/util/Random;ZZJ)V
    ...
    invoke-virtual {p2}, Lokhttp3/internal/ws/RealWebSocket$Streams;->getSource()Lsf;
    ...
    invoke-direct/range {v1 .. v6}, Lokhttp3/internal/ws/WebSocketReader;-><init>(ZLsf;Lokhttp3/internal/ws/WebSocketReader$FrameCallback;ZZ)V
...
.method public onReadMessage(Lmg;)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-virtual {v0, p0, p1}, Lokhttp3/WebSocketListener;->onMessage(Lokhttp3/WebSocket;Lmg;)V

    return-void
.end method

.method public declared-synchronized onReadPing(Lmg;)V
    .locals 1
...
.method public declared-synchronized onReadPong(Lmg;)V
    .locals 1
...
.method public final declared-synchronized pong(Lmg;)Z
    .locals 1
...
.method public send(Ljava/lang/String;)Z
    ...
    invoke-direct {p0, p1, v0}, Lokhttp3/internal/ws/RealWebSocket;->send(Lmg;I)Z
...
.method public final writeOneFrame$okhttp()Z
    ...
    invoke-virtual {v0, v2}, Lokhttp3/internal/ws/WebSocketWriter;->writePong(Lmg;)V
    ...
    invoke-virtual {v4}, Lokhttp3/internal/ws/RealWebSocket$Message;->getData()Lmg;

    move-result-object v2

    invoke-virtual {v0, v1, v2}, Lokhttp3/internal/ws/WebSocketWriter;->writeMessageFrame(ILmg;)V
    ...
    invoke-virtual {v4}, Lokhttp3/internal/ws/RealWebSocket$Close;->getReason()Lmg;

    move-result-object v4

    invoke-virtual {v0, v2, v4}, Lokhttp3/internal/ws/WebSocketWriter;->writeClose(ILmg;)V
...
.method public final writePingFrame$okhttp()V
    ...
    :cond_3
    :try_start_3
    sget-object v1, Lmg;->f:Lmg;

    invoke-virtual {v0, v1}, Lokhttp3/internal/ws/WebSocketWriter;->writePing(Lmg;)V
    :try_end_3
