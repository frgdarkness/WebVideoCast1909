...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lokhttp3/internal/connection/RealConnection$Companion;-><init>(Ljx;)V
...
.method private final certificateSupportHost(Lokhttp3/HttpUrl;Lokhttp3/Handshake;)Z
    ...
    invoke-static {p2, v3}, LJW;->c(Ljava/lang/Object;Ljava/lang/String;)V
...
.method private final connectSocket(IILokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    :try_start_1
    invoke-static {v1}, Lyq0;->m(Ljava/net/Socket;)LcN0;
    ...
    iput-object p1, p0, Lokhttp3/internal/connection/RealConnection;->source:Lsf;

    invoke-static {v1}, Lyq0;->i(Ljava/net/Socket;)LfM0;
    ...
    iput-object p1, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lrf;
    :try_end_1
    ...
    invoke-static {p2, p3}, LJW;->a(Ljava/lang/Object;Ljava/lang/Object;)Z
...
.method private final connectTls(Lokhttp3/internal/connection/ConnectionSpecSelector;)V
    ...
    invoke-static {p1, v2, v6, v2}, LhQ0;->h(Ljava/lang/String;Ljava/lang/String;ILjava/lang/Object;)Ljava/lang/String;
    ...
    invoke-direct {v5, v6, v7, v8, v9}, Lokhttp3/Handshake;-><init>(Lokhttp3/TlsVersion;Lokhttp3/CipherSuite;Ljava/util/List;LTM;)V
    ...
    invoke-virtual {v3, v0, v4}, Lokhttp3/CertificatePinner;->check$okhttp(Ljava/lang/String;LTM;)V
...
.method private final connectTunnel(IIILokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    iput-object v3, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lrf;

    iput-object v3, p0, Lokhttp3/internal/connection/RealConnection;->source:Lsf;
...
.method private final createTunnel(IILokhttp3/Request;Lokhttp3/HttpUrl;)Lokhttp3/Request;
    ...
    :goto_0
    iget-object v0, p0, Lokhttp3/internal/connection/RealConnection;->source:Lsf;

    invoke-static {v0}, LJW;->b(Ljava/lang/Object;)V

    iget-object v2, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lrf;
    ...
    invoke-direct {v3, v4, p0, v0, v2}, Lokhttp3/internal/http1/Http1ExchangeCodec;-><init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/RealConnection;Lsf;Lrf;)V
    ...
    invoke-virtual {v5, v6, v7, v8}, LmX0;->timeout(JLjava/util/concurrent/TimeUnit;)LmX0;

    invoke-interface {v2}, LfM0;->timeout()LmX0;
    ...
    invoke-static {v2, p3, v1}, LhQ0;->w(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    invoke-virtual {p1}, Lif;->exhausted()Z

    move-result p1

    if-eqz p1, :cond_4

    invoke-interface {v2}, Lrf;->getBuffer()Lif;
...
.method private final startHttp2(I)V
    ...
    iget-object v1, p0, Lokhttp3/internal/connection/RealConnection;->source:Lsf;
    ...
    invoke-virtual {v4, v0, v5, v1, v2}, Lokhttp3/internal/http2/Http2Connection$Builder;->socket(Ljava/net/Socket;Ljava/lang/String;Lsf;Lrf;)Lokhttp3/internal/http2/Http2Connection$Builder;
...
.method public final connect(IIIIZLokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    iput-object v11, v7, Lokhttp3/internal/connection/RealConnection;->source:Lsf;

    iput-object v11, v7, Lokhttp3/internal/connection/RealConnection;->sink:Lrf;
...
.method public final isHealthy(Z)Z
    ...
    iget-object v4, p0, Lokhttp3/internal/connection/RealConnection;->source:Lsf;
    ...
    invoke-static {v3, v4}, Lokhttp3/internal/Util;->isHealthy(Ljava/net/Socket;Lsf;)Z
...
.method public final newCodec$okhttp(Lokhttp3/OkHttpClient;Lokhttp3/internal/http/RealInterceptorChain;)Lokhttp3/internal/http/ExchangeCodec;
    ...
    invoke-interface {v1}, LcN0;->timeout()LmX0;
    ...
    invoke-virtual {v0, v3, v4, v5}, LmX0;->timeout(JLjava/util/concurrent/TimeUnit;)LmX0;
    ...
    invoke-direct {v0, p1, p0, v1, v2}, Lokhttp3/internal/http1/Http1ExchangeCodec;-><init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/RealConnection;Lsf;Lrf;)V
...
.method public final newWebSocketStreams$okhttp(Lokhttp3/internal/connection/Exchange;)Lokhttp3/internal/ws/RealWebSocket$Streams;
    ...
    invoke-direct {v0, v1, v2, p1}, Lokhttp3/internal/connection/RealConnection$newWebSocketStreams$1;-><init>(Lsf;Lrf;Lokhttp3/internal/connection/Exchange;)V
