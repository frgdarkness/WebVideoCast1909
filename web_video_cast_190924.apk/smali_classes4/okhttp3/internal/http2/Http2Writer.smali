...
.field private final hpackBuffer:Lif;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lokhttp3/internal/http2/Http2Writer$Companion;-><init>(Ljx;)V
...
.method public constructor <init>(Lrf;Z)V
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lrf;
    ...
    iput-object v4, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lif;
...
.method private final writeContinuationFrames(IJ)V
    ...
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lrf;

    iget-object v1, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lif;
...
.method public final declared-synchronized applyAndAckSettings(Lokhttp3/internal/http2/Settings;)V
    ...
    iget-object p1, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lrf;
...
.method public final declared-synchronized connectionPreface()V
    ...
    sget-object v2, Lokhttp3/internal/http2/Http2;->CONNECTION_PREFACE:Lmg;

    invoke-virtual {v2}, Lmg;->k()Ljava/lang/String;
    ...
    sget-object v1, Lokhttp3/internal/http2/Http2;->CONNECTION_PREFACE:Lmg;

    invoke-interface {v0, v1}, Lrf;->j(Lmg;)Lrf;
...
.method public final declared-synchronized data(ZILif;I)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-virtual {p0, p2, p1, p3, p4}, Lokhttp3/internal/http2/Http2Writer;->dataFrame(IILif;I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final dataFrame(IILif;I)V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-interface {p1, p3, v0, v1}, LfM0;->write(Lif;J)V
...
.method public final frameHeader(IIII)V
    ...
    invoke-static {v0, p2}, Lokhttp3/internal/Util;->writeMedium(Lrf;I)V

    iget-object p2, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lrf;

    and-int/lit16 p3, p3, 0xff

    invoke-interface {p2, p3}, Lrf;->writeByte(I)Lrf;
    ...
    invoke-interface {p2, p1}, Lrf;->writeInt(I)Lrf;
...
.method public final declared-synchronized goAway(ILokhttp3/internal/http2/ErrorCode;[B)V
    ...
    invoke-interface {v0, p1}, Lrf;->writeInt(I)Lrf;
    ...
    invoke-interface {p1, p2}, Lrf;->writeInt(I)Lrf;
    ...
    invoke-interface {p1, p3}, Lrf;->write([B)Lrf;
...
.method public final declared-synchronized headers(ZILjava/util/List;)V
    ...
    iget-object p3, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lif;

    invoke-virtual {p3}, Lif;->size()J
    ...
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lif;

    invoke-interface {p1, v4, v2, v3}, LfM0;->write(Lif;J)V
...
.method public final declared-synchronized ping(ZII)V
    ...
    invoke-interface {p1, p3}, Lrf;->writeInt(I)Lrf;
...
.method public final declared-synchronized pushPromise(IILjava/util/List;)V
    ...
    iget-object v2, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lrf;

    const v5, 0x7fffffff

    and-int/2addr p2, v5

    invoke-interface {v2, p2}, Lrf;->writeInt(I)Lrf;

    iget-object p2, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lrf;

    iget-object v2, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lif;

    invoke-interface {p2, v2, v3, v4}, LfM0;->write(Lif;J)V
...
.method public final declared-synchronized settings(Lokhttp3/internal/http2/Settings;)V
    ...
    :goto_1
    iget-object v3, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lrf;

    invoke-interface {v3, v0}, Lrf;->writeShort(I)Lrf;
    ...
    invoke-interface {v0, v3}, Lrf;->writeInt(I)Lrf;
