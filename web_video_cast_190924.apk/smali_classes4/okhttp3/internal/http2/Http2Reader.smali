...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lokhttp3/internal/http2/Http2Reader$Companion;-><init>(Ljx;)V
...
.method public constructor <init>(Lsf;Z)V
    .locals 7
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lsf;

    iput-boolean p2, p0, Lokhttp3/internal/http2/Http2Reader;->client:Z

    new-instance v2, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;

    invoke-direct {v2, p1}, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;-><init>(Lsf;)V
    ...
    invoke-direct/range {v1 .. v6}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(LcN0;IIILjx;)V
...
.method private final readData(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    iget-object v1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lsf;

    invoke-interface {v1}, Lsf;->readByte()B
    ...
    iget-object p3, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lsf;

    invoke-interface {p1, v0, p4, p3, p2}, Lokhttp3/internal/http2/Http2Reader$Handler;->data(ZILsf;I)V

    iget-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lsf;

    int-to-long p2, v1

    invoke-interface {p1, p2, p3}, Lsf;->skip(J)V
...
.method private final readGoAway(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    iget-object p4, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lsf;

    invoke-interface {p4}, Lsf;->readInt()I

    move-result p4

    iget-object v0, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lsf;

    invoke-interface {v0}, Lsf;->readInt()I
    ...
    invoke-interface {v0, v1, v2}, Lsf;->readByteString(J)Lmg;

    move-result-object v0

    :cond_0
    invoke-interface {p1, p4, p3, v0}, Lokhttp3/internal/http2/Http2Reader$Handler;->goAway(ILokhttp3/internal/http2/ErrorCode;Lmg;)V
...
.method private final readPing(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    iget-object p2, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lsf;

    invoke-interface {p2}, Lsf;->readInt()I
...
.method private final readPriority(Lokhttp3/internal/http2/Http2Reader$Handler;I)V
    ...
    iget-object v3, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lsf;

    invoke-interface {v3}, Lsf;->readByte()B
...
.method private final readPushPromise(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    invoke-interface {v1}, Lsf;->readInt()I
...
.method private final readSettings(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    invoke-static {p2, v1}, LvA0;->j(LuV;I)LuV;
    ...
    invoke-virtual {p2}, LuV;->d()I

    move-result v2

    invoke-virtual {p2}, LuV;->f()I
    ...
    invoke-interface {v3}, Lsf;->readShort()S
    ...
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lsf;

    invoke-interface {v4}, Lsf;->readInt()I
...
.method public final nextFrame(ZLokhttp3/internal/http2/Http2Reader$Handler;)Z
    ...
    invoke-static {v0}, Lokhttp3/internal/Util;->readMedium(Lsf;)I
    ...
    invoke-interface {p1, v0, v1}, Lsf;->skip(J)V
...
.method public final readConnectionPreface(Lokhttp3/internal/http2/Http2Reader$Handler;)V
    ...
    sget-object v0, Lokhttp3/internal/http2/Http2;->CONNECTION_PREFACE:Lmg;
    ...
    invoke-interface {p1, v1, v2}, Lsf;->readByteString(J)Lmg;
    ...
    invoke-virtual {p1}, Lmg;->z()Ljava/lang/String;
