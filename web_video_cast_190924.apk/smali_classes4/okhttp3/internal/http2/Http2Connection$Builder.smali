...
.field public sink:Lrf;

.field public socket:Ljava/net/Socket;

.field public source:Lsf;
...
.method public static synthetic socket$default(Lokhttp3/internal/http2/Http2Connection$Builder;Ljava/net/Socket;Ljava/lang/String;Lsf;Lrf;ILjava/lang/Object;)Lokhttp3/internal/http2/Http2Connection$Builder;
    .locals 0
    ...
    invoke-static {p1}, Lyq0;->m(Ljava/net/Socket;)LcN0;

    move-result-object p3

    invoke-static {p3}, Lyq0;->d(LcN0;)Lsf;
    ...
    invoke-static {p1}, Lyq0;->i(Ljava/net/Socket;)LfM0;

    move-result-object p4

    invoke-static {p4}, Lyq0;->c(LfM0;)Lrf;

    move-result-object p4

    :cond_2
    invoke-virtual {p0, p1, p2, p3, p4}, Lokhttp3/internal/http2/Http2Connection$Builder;->socket(Ljava/net/Socket;Ljava/lang/String;Lsf;Lrf;)Lokhttp3/internal/http2/Http2Connection$Builder;
...
.method public final getSink$okhttp()Lrf;
    .locals 1

    iget-object v0, p0, Lokhttp3/internal/http2/Http2Connection$Builder;->sink:Lrf;
...
.method public final getSource$okhttp()Lsf;
    .locals 1

    iget-object v0, p0, Lokhttp3/internal/http2/Http2Connection$Builder;->source:Lsf;
...
.method public final setSink$okhttp(Lrf;)V
    .locals 1
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Connection$Builder;->sink:Lrf;
...
.method public final setSource$okhttp(Lsf;)V
    .locals 1
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Connection$Builder;->source:Lsf;
...
.method public final socket(Ljava/net/Socket;)Lokhttp3/internal/http2/Http2Connection$Builder;
    ...
    invoke-static/range {v1 .. v7}, Lokhttp3/internal/http2/Http2Connection$Builder;->socket$default(Lokhttp3/internal/http2/Http2Connection$Builder;Ljava/net/Socket;Ljava/lang/String;Lsf;Lrf;ILjava/lang/Object;)Lokhttp3/internal/http2/Http2Connection$Builder;
...
.method public final socket(Ljava/net/Socket;Ljava/lang/String;Lsf;)Lokhttp3/internal/http2/Http2Connection$Builder;
    .locals 8
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public final socket(Ljava/net/Socket;Ljava/lang/String;Lsf;Lrf;)Lokhttp3/internal/http2/Http2Connection$Builder;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-virtual {p0, p3}, Lokhttp3/internal/http2/Http2Connection$Builder;->setSource$okhttp(Lsf;)V

    invoke-virtual {p0, p4}, Lokhttp3/internal/http2/Http2Connection$Builder;->setSink$okhttp(Lrf;)V
