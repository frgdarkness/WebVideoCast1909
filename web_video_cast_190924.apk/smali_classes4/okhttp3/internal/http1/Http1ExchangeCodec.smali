...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lokhttp3/internal/http1/Http1ExchangeCodec$Companion;-><init>(Ljx;)V
...
.method public constructor <init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/RealConnection;Lsf;Lrf;)V
    .locals 1
    ...
    iput-object p3, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->source:Lsf;

    iput-object p4, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->sink:Lrf;

    new-instance p1, Lokhttp3/internal/http1/HeadersReader;

    invoke-direct {p1, p3}, Lokhttp3/internal/http1/HeadersReader;-><init>(Lsf;)V
...
.method public static final synthetic access$detachTimeout(Lokhttp3/internal/http1/Http1ExchangeCodec;LML;)V
    .locals 0

    invoke-direct {p0, p1}, Lokhttp3/internal/http1/Http1ExchangeCodec;->detachTimeout(LML;)V
...
.method public static final synthetic access$getSink$p(Lokhttp3/internal/http1/Http1ExchangeCodec;)Lrf;
    .locals 0

    iget-object p0, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->sink:Lrf;

    return-object p0
.end method

.method public static final synthetic access$getSource$p(Lokhttp3/internal/http1/Http1ExchangeCodec;)Lsf;
    .locals 0

    iget-object p0, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->source:Lsf;
...
.method private final detachTimeout(LML;)V
    .locals 2

    invoke-virtual {p1}, LML;->a()LmX0;

    move-result-object v0

    sget-object v1, LmX0;->NONE:LmX0;

    invoke-virtual {p1, v1}, LML;->b(LmX0;)LML;
...
.method private final isChunked(Lokhttp3/Request;)Z
    ...
    invoke-static {v1, p1, v0}, LhQ0;->w(Ljava/lang/String;Ljava/lang/String;Z)Z
...
.method private final newChunkedSink()LfM0;
    .locals 2
...
.method private final newChunkedSource(Lokhttp3/HttpUrl;)LcN0;
    .locals 2
...
.method private final newFixedLengthSource(J)LcN0;
    .locals 2
...
.method private final newKnownLengthSink()LfM0;
    .locals 2
...
.method private final newUnknownLengthSource()LcN0;
    .locals 2
...
.method public createRequestBody(Lokhttp3/Request;J)LfM0;
    .locals 2
    ...
    invoke-direct {p0}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newChunkedSink()LfM0;
    ...
    invoke-direct {p0}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newKnownLengthSink()LfM0;
...
.method public finishRequest()V
    ...
    iget-object v0, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->sink:Lrf;
...
.method public openResponseBodySource(Lokhttp3/Response;)LcN0;
    .locals 4
    ...
    invoke-direct {p0, v0, v1}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newFixedLengthSource(J)LcN0;
    ...
    invoke-direct {p0, p1}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newChunkedSource(Lokhttp3/HttpUrl;)LcN0;
    ...
    :cond_2
    invoke-direct {p0}, Lokhttp3/internal/http1/Http1ExchangeCodec;->newUnknownLengthSource()LcN0;
...
.method public final skipConnectBody(Lokhttp3/Response;)V
    ...
    invoke-static {p1, v0, v1}, Lokhttp3/internal/Util;->skipAll(LcN0;ILjava/util/concurrent/TimeUnit;)Z

    invoke-interface {p1}, LcN0;->close()V
...
.method public final writeRequest(Lokhttp3/Headers;Ljava/lang/String;)V
    ...
    invoke-interface {v0, p2}, Lrf;->writeUtf8(Ljava/lang/String;)Lrf;

    move-result-object p2

    const-string v0, "\r\n"

    invoke-interface {p2, v0}, Lrf;->writeUtf8(Ljava/lang/String;)Lrf;
    ...
    iget-object v2, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->sink:Lrf;

    invoke-virtual {p1, v1}, Lokhttp3/Headers;->name(I)Ljava/lang/String;

    move-result-object v3

    invoke-interface {v2, v3}, Lrf;->writeUtf8(Ljava/lang/String;)Lrf;
    ...
    invoke-interface {v2, v0}, Lrf;->writeUtf8(Ljava/lang/String;)Lrf;
    ...
    :cond_0
    iget-object p1, p0, Lokhttp3/internal/http1/Http1ExchangeCodec;->sink:Lrf;

    invoke-interface {p1, v0}, Lrf;->writeUtf8(Ljava/lang/String;)Lrf;
