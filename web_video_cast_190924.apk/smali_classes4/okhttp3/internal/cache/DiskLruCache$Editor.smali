...
.method public final newSink(I)LfM0;
    .locals 3
    ...
    invoke-interface {v1, p1}, Lokhttp3/internal/io/FileSystem;->sink(Ljava/io/File;)LfM0;
    ...
    invoke-direct {v1, p1, v2}, Lokhttp3/internal/cache/FaultHidingSink;-><init>(LfM0;LVM;)V
    :try_end_3
...
.method public final newSource(I)LcN0;
    .locals 4
    ...
    invoke-interface {v1, p1}, Lokhttp3/internal/io/FileSystem;->source(Ljava/io/File;)LcN0;
