...
# instance fields
.field private final boundaryByteString:Lmg;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Lokhttp3/MultipartBody$Companion;-><init>(Ljx;)V
...
.method public constructor <init>(Lmg;Lokhttp3/MediaType;Ljava/util/List;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lokhttp3/MultipartBody;->boundaryByteString:Lmg;
...
.method private final writeOrCountBytes(Lrf;Z)J
    ...
    invoke-interface {p1, v8}, Lrf;->write([B)Lrf;

    iget-object v8, p0, Lokhttp3/MultipartBody;->boundaryByteString:Lmg;

    invoke-interface {p1, v8}, Lrf;->j(Lmg;)Lrf;
    ...
    invoke-interface {p1, v10}, Lrf;->writeUtf8(Ljava/lang/String;)Lrf;

    move-result-object v10

    sget-object v11, Lokhttp3/MultipartBody;->COLONSPACE:[B

    invoke-interface {v10, v11}, Lrf;->write([B)Lrf;
    ...
    invoke-interface {v10, v11}, Lrf;->writeUtf8(Ljava/lang/String;)Lrf;
    ...
    invoke-interface {p1, v8}, Lrf;->writeUtf8(Ljava/lang/String;)Lrf;
    ...
    invoke-interface {v8, v7}, Lrf;->writeUtf8(Ljava/lang/String;)Lrf;

    move-result-object v7

    sget-object v8, Lokhttp3/MultipartBody;->CRLF:[B

    invoke-interface {v7, v8}, Lrf;->write([B)Lrf;
    ...
    invoke-interface {p1, v9}, Lrf;->writeUtf8(Ljava/lang/String;)Lrf;

    move-result-object v9

    invoke-interface {v9, v7, v8}, Lrf;->writeDecimalLong(J)Lrf;

    move-result-object v9

    sget-object v10, Lokhttp3/MultipartBody;->CRLF:[B

    invoke-interface {v9, v10}, Lrf;->write([B)Lrf;
    ...
    invoke-interface {p1, v9}, Lrf;->write([B)Lrf;
    ...
    :cond_5
    invoke-virtual {v6, p1}, Lokhttp3/RequestBody;->writeTo(Lrf;)V
    ...
    invoke-interface {p1, v1}, Lrf;->write([B)Lrf;

    iget-object v2, p0, Lokhttp3/MultipartBody;->boundaryByteString:Lmg;

    invoke-interface {p1, v2}, Lrf;->j(Lmg;)Lrf;
...
.method public final boundary()Ljava/lang/String;
    ...
    iget-object v0, p0, Lokhttp3/MultipartBody;->boundaryByteString:Lmg;

    invoke-virtual {v0}, Lmg;->z()Ljava/lang/String;
...
.method public contentLength()J
    ...
    invoke-direct {p0, v0, v1}, Lokhttp3/MultipartBody;->writeOrCountBytes(Lrf;Z)J
...
.method public writeTo(Lrf;)V
    ...
    invoke-direct {p0, p1, v0}, Lokhttp3/MultipartBody;->writeOrCountBytes(Lrf;Z)J
