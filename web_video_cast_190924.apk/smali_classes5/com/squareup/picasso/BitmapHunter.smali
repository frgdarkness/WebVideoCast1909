...
.method static decodeStream(LcN0;Lcom/squareup/picasso/Request;)Landroid/graphics/Bitmap;
    .locals 6
    ...
    invoke-static {p0}, Lyq0;->d(LcN0;)Lsf;

    move-result-object p0

    invoke-static {p0}, Lcom/squareup/picasso/Utils;->isWebPFile(Lsf;)Z
    ...
    invoke-interface {p0}, Lsf;->inputStream()Ljava/io/InputStream;
    ...
    :cond_2
    invoke-interface {p0}, Lsf;->readByteArray()[B
...
.method hunt()Landroid/graphics/Bitmap;
    ...
    invoke-virtual {v1}, Lcom/squareup/picasso/RequestHandler$Result;->getSource()LcN0;
    ...
    invoke-static {v0, v1}, Lcom/squareup/picasso/BitmapHunter;->decodeStream(LcN0;Lcom/squareup/picasso/Request;)Landroid/graphics/Bitmap;
