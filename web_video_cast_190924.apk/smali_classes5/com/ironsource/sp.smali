...
# direct methods
.method public constructor <init>(Lcom/ironsource/mediationsdk/testSuite/TestSuiteActivity;Lcom/ironsource/fe;Lorg/json/JSONObject;Ljava/lang/String;)V
    .locals 2
    ...
    iput-object v0, p0, Lcom/ironsource/sp;->a:Landroid/os/Handler;

    new-instance v0, Landroid/webkit/WebView;

    invoke-direct {v0, p1}, Landroid/webkit/WebView;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/ironsource/sp;->b:Landroid/webkit/WebView;

    new-instance v0, Landroid/webkit/WebView;

    invoke-direct {v0, p1}, Landroid/webkit/WebView;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/ironsource/sp;->c:Landroid/webkit/WebView;

    iput-object p3, p0, Lcom/ironsource/sp;->d:Lorg/json/JSONObject;

    invoke-direct {p0, p1, p2, p4}, Lcom/ironsource/sp;->a(Lcom/ironsource/mediationsdk/testSuite/TestSuiteActivity;Lcom/ironsource/fe;Ljava/lang/String;)V

    return-void
.end method

.method public static final synthetic a(Lcom/ironsource/sp;)Landroid/os/Handler;
    .locals 0

    iget-object p0, p0, Lcom/ironsource/sp;->a:Landroid/os/Handler;
...
.method private static final a(Lcom/ironsource/fe;)V
    ...
    invoke-interface {p0}, Lcom/ironsource/fe;->onUIReady()V

    return-void
.end method

.method private final a(Lcom/ironsource/mediationsdk/testSuite/TestSuiteActivity;Lcom/ironsource/fe;Ljava/lang/String;)V
    .locals 3
    ...
    iget-object v0, p0, Lcom/ironsource/sp;->b:Landroid/webkit/WebView;
    ...
    :goto_1
    iget-object v0, p0, Lcom/ironsource/sp;->c:Landroid/webkit/WebView;
    ...
    iget-object v1, p0, Lcom/ironsource/sp;->a:Landroid/os/Handler;

    invoke-direct {v0, p1, v1}, Lcom/ironsource/fp;-><init>(Lcom/ironsource/mediationsdk/testSuite/TestSuiteActivity;Landroid/os/Handler;)V

    new-instance p1, Lcom/ironsource/sp$b;

    invoke-direct {p1, p0, p2}, Lcom/ironsource/sp$b;-><init>(Lcom/ironsource/sp;Lcom/ironsource/fe;)V

    iget-object v1, p0, Lcom/ironsource/sp;->c:Landroid/webkit/WebView;

    new-instance v2, Lcom/ironsource/jp;

    invoke-direct {v2, v0, p1, p0}, Lcom/ironsource/jp;-><init>(Lcom/ironsource/fp;Lcom/ironsource/fe;Lcom/ironsource/kp;)V
    ...
    iget-object p1, p0, Lcom/ironsource/sp;->c:Landroid/webkit/WebView;

    new-instance v0, Lcom/ironsource/sp$a;

    invoke-direct {v0, p0, p3}, Lcom/ironsource/sp$a;-><init>(Lcom/ironsource/sp;Ljava/lang/String;)V
    ...
    :cond_3
    :goto_2
    iget-object p1, p0, Lcom/ironsource/sp;->b:Landroid/webkit/WebView;
    ...
    :cond_4
    iget-object p1, p0, Lcom/ironsource/sp;->a:Landroid/os/Handler;

    new-instance p3, LWs1;

    invoke-direct {p3, p0}, LWs1;-><init>(Lcom/ironsource/sp;)V
    ...
    invoke-direct {p3, p2}, LXs1;-><init>(Lcom/ironsource/fe;)V
...
.method private static final a(Lcom/ironsource/sp;Ljava/lang/String;)V
    .locals 2
    ...
    iget-object p0, p0, Lcom/ironsource/sp;->c:Landroid/webkit/WebView;
...
.method public static final synthetic a(Lcom/ironsource/sp;Z)V
    .locals 0

    iput-boolean p1, p0, Lcom/ironsource/sp;->e:Z

    return-void
.end method

.method public static synthetic b(Lcom/ironsource/sp;Ljava/lang/String;)V
    .locals 0

    invoke-static {p0, p1}, Lcom/ironsource/sp;->a(Lcom/ironsource/sp;Ljava/lang/String;)V

    return-void
.end method

.method public static final synthetic b(Lcom/ironsource/sp;)Z
    .locals 0

    iget-boolean p0, p0, Lcom/ironsource/sp;->e:Z

    return p0
.end method

.method public static final synthetic c(Lcom/ironsource/sp;)Lorg/json/JSONObject;
    .locals 0

    iget-object p0, p0, Lcom/ironsource/sp;->d:Lorg/json/JSONObject;

    return-object p0
.end method

.method public static final synthetic d(Lcom/ironsource/sp;)Z
    .locals 0

    iget-boolean p0, p0, Lcom/ironsource/sp;->f:Z

    return p0
.end method

.method private static final e(Lcom/ironsource/sp;)V
    .locals 1
    ...
    iput-boolean v0, p0, Lcom/ironsource/sp;->f:Z

    return-void
.end method

.method public static synthetic f(Lcom/ironsource/sp;)V
    .locals 0

    invoke-static {p0}, Lcom/ironsource/sp;->e(Lcom/ironsource/sp;)V

    return-void
.end method

.method public static synthetic g(Lcom/ironsource/fe;)V
    .locals 0

    invoke-static {p0}, Lcom/ironsource/sp;->a(Lcom/ironsource/fe;)V
...
.method public final a(Ljava/lang/String;Ljava/util/List;)Ljava/lang/String;
    ...
    sget-object v0, Lcom/ironsource/rp;->a:Lcom/ironsource/rp;

    invoke-virtual {v0, p2}, Lcom/ironsource/rp;->b(Ljava/util/List;)Ljava/lang/String;
...
.method public final a()V
    ...
    invoke-virtual {p0}, Lcom/ironsource/sp;->b()V
...
.method public final a(Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lcom/ironsource/sp;->a:Landroid/os/Handler;

    new-instance v1, LYs1;

    invoke-direct {v1, p0, p1}, LYs1;-><init>(Lcom/ironsource/sp;Ljava/lang/String;)V
...
.method public a(Ljava/lang/String;Lcom/ironsource/mediationsdk/IronSource$AD_UNIT;Ljava/util/List;)V
    ...
    iget-boolean v0, p0, Lcom/ironsource/sp;->e:Z
    ...
    invoke-virtual {p0, p2, p1}, Lcom/ironsource/sp;->a(Ljava/lang/String;Ljava/util/List;)Ljava/lang/String;

    move-result-object p1

    invoke-virtual {p0, p1}, Lcom/ironsource/sp;->a(Ljava/lang/String;)V
