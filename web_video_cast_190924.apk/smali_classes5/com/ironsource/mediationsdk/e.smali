...
.field private h:Lcom/ironsource/p4;

.field private i:Lcom/ironsource/t3;

.field private j:Lcom/ironsource/mediationsdk/ISBannerSize;


# direct methods
.method public constructor <init>(Lcom/ironsource/mediationsdk/IronSource$AD_UNIT;Lcom/ironsource/p4;Lcom/ironsource/t3;)V
    .locals 1
    ...
    iput-object p2, p0, Lcom/ironsource/mediationsdk/e;->h:Lcom/ironsource/p4;

    iput-object p3, p0, Lcom/ironsource/mediationsdk/e;->i:Lcom/ironsource/t3;
...
.method private a(Landroid/content/Context;Ljava/util/Map;Ljava/util/List;Lcom/ironsource/mediationsdk/h;IZLcom/ironsource/mediationsdk/IronSourceSegment;)Lorg/json/JSONObject;
    ...
    invoke-virtual {v3}, Lcom/ironsource/mediationsdk/p;->i()Lcom/ironsource/wn;

    move-result-object v3

    invoke-virtual {v3}, Lcom/ironsource/wn;->c()Lcom/ironsource/i7;

    move-result-object v3

    invoke-virtual {v3}, Lcom/ironsource/i7;->b()Lcom/ironsource/d3;

    move-result-object v3

    invoke-virtual {v3}, Lcom/ironsource/d3;->j()Lcom/ironsource/hq;

    move-result-object v3

    invoke-virtual {v3}, Lcom/ironsource/hq;->f()Z
    ...
    iget-object v12, v0, Lcom/ironsource/mediationsdk/e;->h:Lcom/ironsource/p4;
    ...
    invoke-virtual/range {v5 .. v16}, Lcom/ironsource/mediationsdk/d;->a(Landroid/content/Context;Ljava/util/Map;Ljava/util/List;Lcom/ironsource/mediationsdk/h;ILjava/lang/String;Lcom/ironsource/p4;Lcom/ironsource/mediationsdk/ISBannerSize;Lorg/json/JSONObject;ZZ)Lorg/json/JSONObject;
...
# virtual methods
.method public a(Landroid/content/Context;Lcom/ironsource/mediationsdk/i;Lcom/ironsource/t3;)V
    .locals 8

    :try_start_0
    iget-object v0, p0, Lcom/ironsource/mediationsdk/e;->e:Lcom/ironsource/mediationsdk/f;

    invoke-virtual {v0, p1, p2, p3}, Lcom/ironsource/mediationsdk/f;->a(Landroid/content/Context;Lcom/ironsource/mediationsdk/i;Lcom/ironsource/t3;)Lcom/ironsource/mediationsdk/e$a;
    ...
    invoke-interface/range {v1 .. v7}, Lcom/ironsource/t3;->a(ILjava/lang/String;ILjava/lang/String;J)V
...
.method public a(Landroid/content/Context;Ljava/util/Map;Ljava/util/List;Lcom/ironsource/mediationsdk/h;ILcom/ironsource/mediationsdk/IronSourceSegment;)V
    ...
    iget-object v11, v9, Lcom/ironsource/mediationsdk/e;->i:Lcom/ironsource/t3;

    new-instance v12, Ljava/net/URL;

    iget-object v1, v9, Lcom/ironsource/mediationsdk/e;->h:Lcom/ironsource/p4;

    const/4 v2, 0x0

    invoke-virtual {v1, v2}, Lcom/ironsource/p4;->a(Z)Ljava/lang/String;
    ...
    invoke-virtual {v1}, Lcom/ironsource/p4;->g()I

    move-result v15

    iget-object v1, v9, Lcom/ironsource/mediationsdk/e;->h:Lcom/ironsource/p4;

    invoke-virtual {v1}, Lcom/ironsource/p4;->m()J

    move-result-wide v16

    iget-object v1, v9, Lcom/ironsource/mediationsdk/e;->h:Lcom/ironsource/p4;

    invoke-virtual {v1}, Lcom/ironsource/p4;->n()Z

    move-result v18

    iget-object v1, v9, Lcom/ironsource/mediationsdk/e;->h:Lcom/ironsource/p4;

    invoke-virtual {v1}, Lcom/ironsource/p4;->o()Z

    move-result v19

    iget-object v1, v9, Lcom/ironsource/mediationsdk/e;->h:Lcom/ironsource/p4;

    invoke-virtual {v1}, Lcom/ironsource/p4;->d()I

    move-result v20

    move-object v10, v0

    invoke-direct/range {v10 .. v20}, Lcom/ironsource/mediationsdk/e$a;-><init>(Lcom/ironsource/t3;Ljava/net/URL;Lorg/json/JSONObject;ZIJZZI)V
    ...
    iget-object v10, v9, Lcom/ironsource/mediationsdk/e;->i:Lcom/ironsource/t3;
    ...
    invoke-interface/range {v10 .. v16}, Lcom/ironsource/t3;->a(ILjava/lang/String;ILjava/lang/String;J)V
...
.method public a(Lcom/ironsource/n4;ILcom/ironsource/n4;)V
    .locals 10
    ...
    invoke-virtual/range {v3 .. v9}, Lcom/ironsource/mediationsdk/d;->a(Ljava/lang/String;ILcom/ironsource/n4;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p3}, Lcom/ironsource/n4;->g()Ljava/util/List;
...
.method public a(Lcom/ironsource/n4;ILcom/ironsource/n4;Ljava/lang/String;)V
    .locals 10
    ...
    invoke-virtual {p3}, Lcom/ironsource/n4;->b()Ljava/util/List;
...
.method public a(Ljava/util/ArrayList;Lj$/util/concurrent/ConcurrentHashMap;ILcom/ironsource/n4;Lcom/ironsource/n4;)V
    .locals 15
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual/range {p5 .. p5}, Lcom/ironsource/n4;->i()I
    ...
    invoke-virtual/range {p5 .. p5}, Lcom/ironsource/n4;->c()Ljava/lang/String;
    ...
    invoke-virtual {v2}, Lcom/ironsource/n4;->i()I

    move-result v5

    invoke-virtual {v2}, Lcom/ironsource/n4;->h()Ljava/lang/String;
    ...
    invoke-virtual {v2}, Lcom/ironsource/n4;->f()Ljava/util/List;
    ...
    invoke-virtual/range {v6 .. v12}, Lcom/ironsource/mediationsdk/d;->a(Ljava/lang/String;ILcom/ironsource/n4;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual/range {p4 .. p4}, Lcom/ironsource/n4;->f()Ljava/util/List;
    ...
    invoke-virtual/range {v4 .. v10}, Lcom/ironsource/mediationsdk/d;->a(Ljava/lang/String;ILcom/ironsource/n4;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public a(Ljava/util/concurrent/CopyOnWriteArrayList;Lj$/util/concurrent/ConcurrentHashMap;ILcom/ironsource/n4;Lcom/ironsource/n4;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual/range {v0 .. v5}, Lcom/ironsource/mediationsdk/e;->a(Ljava/util/ArrayList;Lj$/util/concurrent/ConcurrentHashMap;ILcom/ironsource/n4;Lcom/ironsource/n4;)V
