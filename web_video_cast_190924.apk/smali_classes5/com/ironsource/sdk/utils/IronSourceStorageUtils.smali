...
.field private static b:Lcom/ironsource/yo; = null
...
.method private static a(Landroid/content/Context;)V
    ...
    sget-object v0, Lcom/ironsource/sdk/utils/IronSourceStorageUtils;->b:Lcom/ironsource/yo;

    if-eqz v0, :cond_0

    invoke-virtual {v0}, Lcom/ironsource/yo;->b()Z
    ...
    invoke-virtual {v0}, Lcom/ironsource/yo;->c()Z
...
.method private static a()Z
    ...
    invoke-virtual {v0}, Lcom/ironsource/yo;->a()Z
...
.method private static b(Landroid/content/Context;)Ljava/io/File;
    ...
    sget-object v1, Lcom/ironsource/sdk/utils/IronSourceStorageUtils;->b:Lcom/ironsource/yo;

    if-eqz v1, :cond_0

    invoke-virtual {v1}, Lcom/ironsource/yo;->d()Z

    move-result v1

    if-eqz v1, :cond_0

    invoke-interface {v0, p0}, Lcom/ironsource/bc;->e(Landroid/content/Context;)Ljava/io/File;
    ...
    :cond_0
    invoke-interface {v0, p0}, Lcom/ironsource/bc;->t(Landroid/content/Context;)Ljava/io/File;
...
.method public static buildFilesMapOfDirectory(Lcom/ironsource/sd;Lorg/json/JSONObject;)Lorg/json/JSONObject;
    .locals 6
    ...
    invoke-direct {v4, v3}, Lcom/ironsource/sd;-><init>(Ljava/lang/String;)V
    ...
    invoke-static {v4, p1}, Lcom/ironsource/sdk/utils/IronSourceStorageUtils;->buildFilesMapOfDirectory(Lcom/ironsource/sd;Lorg/json/JSONObject;)Lorg/json/JSONObject;
...
.method private static c(Landroid/content/Context;)Ljava/io/File;
    ...
    invoke-interface {v0, p0}, Lcom/ironsource/bc;->k(Landroid/content/Context;)Ljava/io/File;
    ...
    :cond_0
    invoke-interface {v0, p0}, Lcom/ironsource/bc;->v(Landroid/content/Context;)Ljava/io/File;
...
.method public static declared-synchronized deleteFile(Lcom/ironsource/sd;)Z
    .locals 2
...
.method public static ensurePathSafety(Ljava/io/File;Ljava/lang/String;)V
    ...
    invoke-virtual {v0}, Lcom/ironsource/yo;->e()Z
...
.method public static getFilesInFolderRecursive(Lcom/ironsource/sd;)Ljava/util/ArrayList;
    .locals 5
    ...
    invoke-static {v4}, Lcom/ironsource/sdk/utils/IronSourceStorageUtils;->getFilesInFolderRecursive(Lcom/ironsource/sd;)Ljava/util/ArrayList;
...
.method public static getTotalSizeOfDir(Lcom/ironsource/sd;)J
    .locals 6
    ...
    invoke-direct {v5, v4}, Lcom/ironsource/sd;-><init>(Ljava/lang/String;)V
    ...
    invoke-static {v5}, Lcom/ironsource/sdk/utils/IronSourceStorageUtils;->getTotalSizeOfDir(Lcom/ironsource/sd;)J
...
.method public static initializeCacheDirectory(Landroid/content/Context;Lcom/ironsource/yo;)V
    .locals 0

    sput-object p1, Lcom/ironsource/sdk/utils/IronSourceStorageUtils;->b:Lcom/ironsource/yo;
...
.method public static readFile(Lcom/ironsource/sd;)Ljava/lang/String;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
