.class public Lcom/nimbusds/srp6/SRP6Routines;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/nimbusds/srp6/SRP6Routines;->a:Ljava/security/SecureRandom;
...
.method public a(Ljava/security/MessageDigest;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)Ljava/math/BigInteger;
    ...
    invoke-static {p3}, Lcom/nimbusds/srp6/BigIntegerUtils;->b(Ljava/math/BigInteger;)[B

    move-result-object p2

    invoke-virtual {p1, p2}, Ljava/security/MessageDigest;->update([B)V

    invoke-static {p4}, Lcom/nimbusds/srp6/BigIntegerUtils;->b(Ljava/math/BigInteger;)[B
...
.method public b(Ljava/security/MessageDigest;Ljava/math/BigInteger;Ljava/math/BigInteger;)Ljava/math/BigInteger;
    ...
    invoke-virtual {p0, p1, p2, p2, p3}, Lcom/nimbusds/srp6/SRP6Routines;->j(Ljava/security/MessageDigest;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)Ljava/math/BigInteger;
...
.method public f(Ljava/security/MessageDigest;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)Ljava/math/BigInteger;
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, Lcom/nimbusds/srp6/SRP6Routines;->j(Ljava/security/MessageDigest;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)Ljava/math/BigInteger;
...
.method public h(Ljava/math/BigInteger;Ljava/security/SecureRandom;)Ljava/math/BigInteger;
    .locals 3
...
.method protected i(Ljava/math/BigInteger;I)[B
    .locals 3
...
.method protected j(Ljava/security/MessageDigest;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)Ljava/math/BigInteger;
    .locals 0
    ...
    invoke-virtual {p0, p3, p2}, Lcom/nimbusds/srp6/SRP6Routines;->i(Ljava/math/BigInteger;I)[B

    move-result-object p3

    invoke-virtual {p0, p4, p2}, Lcom/nimbusds/srp6/SRP6Routines;->i(Ljava/math/BigInteger;I)[B
...
.method public k(Ljava/math/BigInteger;Ljava/math/BigInteger;)Z
    .locals 0
