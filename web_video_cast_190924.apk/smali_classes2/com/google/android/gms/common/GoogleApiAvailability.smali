...
.method public showErrorDialogFragment(Landroid/app/Activity;ILX1;Landroid/content/DialogInterface$OnCancelListener;)Z
    .locals 6
    .param p1    # Landroid/app/Activity;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-direct {v5, p0, p1, p2, p3}, Lcom/google/android/gms/common/zac;-><init>(Lcom/google/android/gms/common/GoogleApiAvailability;Landroid/app/Activity;ILX1;)V
...
.method final zae(Landroid/content/Context;ILjava/lang/String;Landroid/app/PendingIntent;)V
    ...
    invoke-direct {v6, p1}, Landroidx/core/app/NotificationCompat$f;-><init>(Landroid/content/Context;)V

    invoke-virtual {v6, v3}, Landroidx/core/app/NotificationCompat$f;->p(Z)Landroidx/core/app/NotificationCompat$f;

    move-result-object v6

    invoke-virtual {v6, v3}, Landroidx/core/app/NotificationCompat$f;->g(Z)Landroidx/core/app/NotificationCompat$f;

    move-result-object v6

    invoke-virtual {v6, p3}, Landroidx/core/app/NotificationCompat$f;->k(Ljava/lang/CharSequence;)Landroidx/core/app/NotificationCompat$f;
    ...
    invoke-virtual {v6, v1}, Landroidx/core/app/NotificationCompat$d;->h(Ljava/lang/CharSequence;)Landroidx/core/app/NotificationCompat$d;

    move-result-object v6

    invoke-virtual {p3, v6}, Landroidx/core/app/NotificationCompat$f;->v(Landroidx/core/app/NotificationCompat$g;)Landroidx/core/app/NotificationCompat$f;
    ...
    invoke-virtual {p3, v1}, Landroidx/core/app/NotificationCompat$f;->u(I)Landroidx/core/app/NotificationCompat$f;

    move-result-object v1

    invoke-virtual {v1, v0}, Landroidx/core/app/NotificationCompat$f;->r(I)Landroidx/core/app/NotificationCompat$f;
    ...
    invoke-virtual {p3, v1, v4, p4}, Landroidx/core/app/NotificationCompat$f;->a(ILjava/lang/CharSequence;Landroid/app/PendingIntent;)Landroidx/core/app/NotificationCompat$f;

    goto :goto_0

    :cond_3
    invoke-virtual {p3, p4}, Landroidx/core/app/NotificationCompat$f;->i(Landroid/app/PendingIntent;)Landroidx/core/app/NotificationCompat$f;
    ...
    invoke-virtual {p3, v6}, Landroidx/core/app/NotificationCompat$f;->u(I)Landroidx/core/app/NotificationCompat$f;
    ...
    invoke-virtual {v6, v4}, Landroidx/core/app/NotificationCompat$f;->w(Ljava/lang/CharSequence;)Landroidx/core/app/NotificationCompat$f;
    ...
    invoke-virtual {v4, v6, v7}, Landroidx/core/app/NotificationCompat$f;->y(J)Landroidx/core/app/NotificationCompat$f;

    move-result-object v4

    invoke-virtual {v4, p4}, Landroidx/core/app/NotificationCompat$f;->i(Landroid/app/PendingIntent;)Landroidx/core/app/NotificationCompat$f;

    move-result-object p4

    invoke-virtual {p4, v1}, Landroidx/core/app/NotificationCompat$f;->j(Ljava/lang/CharSequence;)Landroidx/core/app/NotificationCompat$f;
    ...
    invoke-static {v5, v1}, LGo0;->a(Landroid/app/NotificationManager;Ljava/lang/String;)Landroid/app/NotificationChannel;
    ...
    invoke-static {v1, p1, p4}, Lkn0;->a(Ljava/lang/String;Ljava/lang/CharSequence;I)Landroid/app/NotificationChannel;

    move-result-object p1

    invoke-static {v5, p1}, Lxo0;->a(Landroid/app/NotificationManager;Landroid/app/NotificationChannel;)V

    goto :goto_1

    :cond_6
    invoke-static {p4}, LSm0;->a(Landroid/app/NotificationChannel;)Ljava/lang/CharSequence;
    ...
    invoke-static {p4, p1}, LCO;->a(Landroid/app/NotificationChannel;Ljava/lang/CharSequence;)V

    invoke-static {v5, p4}, Lxo0;->a(Landroid/app/NotificationManager;Landroid/app/NotificationChannel;)V

    :cond_7
    :goto_1
    invoke-virtual {p3, v1}, Landroidx/core/app/NotificationCompat$f;->h(Ljava/lang/String;)Landroidx/core/app/NotificationCompat$f;

    :goto_2
    invoke-virtual {p3}, Landroidx/core/app/NotificationCompat$f;->c()Landroid/app/Notification;
