...
.field private final transitionToUnchecked:Lr4;
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
.end field

.field private final transitionToUncheckedCallback:Ln4;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-static {p1, v0}, Lr4;->a(Landroid/content/Context;I)Lr4;

    move-result-object p1

    iput-object p1, p0, Lcom/google/android/material/checkbox/MaterialCheckBox;->transitionToUnchecked:Lr4;
    ...
    iput-object p1, p0, Lcom/google/android/material/checkbox/MaterialCheckBox;->transitionToUncheckedCallback:Ln4;

    invoke-virtual {p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object p1

    invoke-static {p0}, Lun;->a(Landroid/widget/CompoundButton;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-interface {p0, v6}, LuX0;->setSupportButtonTintList(Landroid/content/res/ColorStateList;)V
    ...
    invoke-static/range {v0 .. v5}, Lcom/google/android/material/internal/ThemeEnforcement;->obtainTintedStyledAttributes(Landroid/content/Context;Landroid/util/AttributeSet;[III[I)Landroidx/appcompat/widget/C;

    move-result-object p2

    sget p3, Lcom/google/android/material/R$styleable;->MaterialCheckBox_buttonIcon:I

    invoke-virtual {p2, p3}, Landroidx/appcompat/widget/C;->g(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, p2}, Lcom/google/android/material/checkbox/MaterialCheckBox;->isButtonDrawableLegacy(Landroidx/appcompat/widget/C;)Z
    ...
    invoke-static {p1, p3}, LC6;->b(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p1, p2, p3}, Lcom/google/android/material/resources/MaterialResources;->getColorStateList(Landroid/content/Context;Landroidx/appcompat/widget/C;I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {p2, p1, p3}, Landroidx/appcompat/widget/C;->k(II)I
    ...
    invoke-virtual {p2, p1, v7}, Landroidx/appcompat/widget/C;->a(IZ)Z
    ...
    invoke-virtual {p2, p1, v0}, Landroidx/appcompat/widget/C;->a(IZ)Z
    ...
    invoke-virtual {p2, p1}, Landroidx/appcompat/widget/C;->p(I)Ljava/lang/CharSequence;
    ...
    invoke-virtual {p2, p1, v7}, Landroidx/appcompat/widget/C;->k(II)I
...
.method private getSuperButtonTintList()Landroid/content/res/ColorStateList;
    ...
    :cond_1
    invoke-interface {p0}, LuX0;->getSupportButtonTintList()Landroid/content/res/ColorStateList;
...
.method private isButtonDrawableLegacy(Landroidx/appcompat/widget/C;)Z
    .locals 3
...
.method private refreshButtonDrawable()V
    ...
    invoke-static {p0}, Lun;->c(Landroid/widget/CompoundButton;)Landroid/graphics/PorterDuff$Mode;
...
.method private setUpDefaultButtonDrawableAnimationIfNeeded()V
    ...
    :cond_0
    iget-object v0, p0, Lcom/google/android/material/checkbox/MaterialCheckBox;->transitionToUnchecked:Lr4;

    if-eqz v0, :cond_1

    iget-object v1, p0, Lcom/google/android/material/checkbox/MaterialCheckBox;->transitionToUncheckedCallback:Ln4;

    invoke-virtual {v0, v1}, Lr4;->g(Ln4;)Z

    iget-object v0, p0, Lcom/google/android/material/checkbox/MaterialCheckBox;->transitionToUnchecked:Lr4;

    iget-object v1, p0, Lcom/google/android/material/checkbox/MaterialCheckBox;->transitionToUncheckedCallback:Ln4;

    invoke-virtual {v0, v1}, Lr4;->c(Ln4;)V
    ...
    iget-object v1, p0, Lcom/google/android/material/checkbox/MaterialCheckBox;->transitionToUnchecked:Lr4;
    ...
    iget-object v2, p0, Lcom/google/android/material/checkbox/MaterialCheckBox;->transitionToUnchecked:Lr4;
...
.method private updateButtonTints()V
    ...
    invoke-static {v0, v1}, LhC;->o(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)V
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v0, v1, v3, v4, p1}, LhC;->l(Landroid/graphics/drawable/Drawable;IIII)V
...
.method public setButtonTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-interface {p0, p1}, LuX0;->setSupportButtonTintMode(Landroid/graphics/PorterDuff$Mode;)V
...
.method public setCheckedState(I)V
    ...
    invoke-static {}, Ls70;->a()Ljava/lang/Class;

    move-result-object v1

    invoke-static {p1, v1}, LAK0;->a(Landroid/content/Context;Ljava/lang/Class;)Ljava/lang/Object;

    move-result-object p1

    invoke-static {p1}, Lt70;->a(Ljava/lang/Object;)Landroid/view/autofill/AutofillManager;

    move-result-object p1

    if-eqz p1, :cond_4

    invoke-static {p1, p0}, Lu70;->a(Landroid/view/autofill/AutofillManager;Landroid/view/View;)V
...
.method public setUseMaterialThemeColors(Z)V
    ...
    invoke-static {p0, p1}, Lun;->d(Landroid/widget/CompoundButton;Landroid/content/res/ColorStateList;)V
