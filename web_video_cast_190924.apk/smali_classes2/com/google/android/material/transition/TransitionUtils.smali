...
.method static maybeAddTransition(LkZ0;LeZ0;)V
    .locals 0
    .param p1    # LeZ0;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    ...
    invoke-virtual {p0, p1}, LkZ0;->x(LeZ0;)LkZ0;

    :cond_0
    return-void
.end method

.method static maybeApplyThemeDuration(LeZ0;Landroid/content/Context;I)Z
    .locals 5
    ...
    invoke-virtual {p0, p1, p2}, LeZ0;->setDuration(J)LeZ0;
...
.method static maybeApplyThemeInterpolator(LeZ0;Landroid/content/Context;ILandroid/animation/TimeInterpolator;)Z
    .locals 1
    ...
    invoke-virtual {p0, p1}, LeZ0;->setInterpolator(Landroid/animation/TimeInterpolator;)LeZ0;
...
.method static maybeApplyThemePath(LeZ0;Landroid/content/Context;I)Z
    .locals 0

    if-eqz p2, :cond_0

    invoke-static {p1, p2}, Lcom/google/android/material/transition/TransitionUtils;->resolveThemePath(Landroid/content/Context;I)LKs0;

    move-result-object p1

    if-eqz p1, :cond_0

    invoke-virtual {p0, p1}, LeZ0;->setPathMotion(LKs0;)V
...
.method static maybeRemoveTransition(LkZ0;LeZ0;)V
    .locals 0
    .param p1    # LeZ0;
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    ...
    invoke-virtual {p0, p1}, LkZ0;->G(LeZ0;)LkZ0;

    :cond_0
    return-void
.end method

.method static resolveThemePath(Landroid/content/Context;I)LKs0;
    .locals 3
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
    ...
    invoke-static {p0}, LLs0;->e(Ljava/lang/String;)Landroid/graphics/Path;

    move-result-object p0

    invoke-direct {p1, p0}, LNs0;-><init>(Landroid/graphics/Path;)V
