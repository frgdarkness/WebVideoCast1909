...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    invoke-virtual {p3, p1}, Landroidx/appcompat/view/menu/e;->addMenuPresenter(Landroidx/appcompat/view/menu/j;)V

    invoke-virtual {p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v1

    invoke-virtual {p1, v1, p3}, Lcom/google/android/material/navigation/NavigationBarPresenter;->initForMenu(Landroid/content/Context;Landroidx/appcompat/view/menu/e;)V
    ...
    invoke-virtual {p2, p1}, Landroidx/appcompat/widget/C;->c(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {p2, p1, v1}, Landroidx/appcompat/widget/C;->f(II)I

    move-result p1

    invoke-virtual {p0, p1}, Lcom/google/android/material/navigation/NavigationBarView;->setItemIconSize(I)V

    invoke-virtual {p2, v7}, Landroidx/appcompat/widget/C;->s(I)Z
    ...
    invoke-virtual {p2, v7, v1}, Landroidx/appcompat/widget/C;->n(II)I
    ...
    :cond_1
    invoke-virtual {p2, v8}, Landroidx/appcompat/widget/C;->s(I)Z

    move-result p1

    if-eqz p1, :cond_2

    invoke-virtual {p2, v8, v1}, Landroidx/appcompat/widget/C;->n(II)I
    ...
    invoke-static {v6, p2, p1}, Lcom/google/android/material/resources/MaterialResources;->getColorStateList(Landroid/content/Context;Landroidx/appcompat/widget/C;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {v2, p1}, LhC;->o(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)V

    sget p1, Lcom/google/android/material/R$styleable;->NavigationBarView_labelVisibilityMode:I

    const/4 v2, -0x1

    invoke-virtual {p2, p1, v2}, Landroidx/appcompat/widget/C;->l(II)I
    ...
    invoke-virtual {p2, p1, v1}, Landroidx/appcompat/widget/C;->n(II)I
...
.method public setSelectedItemId(I)V
    ...
    invoke-virtual {v0, p1, v1, v2}, Landroidx/appcompat/view/menu/e;->performItemAction(Landroid/view/MenuItem;Landroidx/appcompat/view/menu/j;I)Z
