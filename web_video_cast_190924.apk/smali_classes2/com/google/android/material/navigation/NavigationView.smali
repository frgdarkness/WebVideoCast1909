...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-virtual {v1, v3, v12}, Landroidx/appcompat/widget/C;->n(II)I
    ...
    invoke-virtual {v1, v6}, Landroidx/appcompat/widget/C;->c(I)Landroid/content/res/ColorStateList;
    ...
    invoke-direct {v0, v1}, Lcom/google/android/material/navigation/NavigationView;->hasShapeAppearance(Landroidx/appcompat/widget/C;)Z

    move-result v9

    if-eqz v9, :cond_d

    invoke-direct {v0, v1}, Lcom/google/android/material/navigation/NavigationView;->createDefaultItemBackground(Landroidx/appcompat/widget/C;)Landroid/graphics/drawable/Drawable;

    move-result-object v8

    sget v9, Lcom/google/android/material/R$styleable;->NavigationView_itemRippleColor:I

    invoke-static {v13, v1, v9}, Lcom/google/android/material/resources/MaterialResources;->getColorStateList(Landroid/content/Context;Landroidx/appcompat/widget/C;I)Landroid/content/res/ColorStateList;

    move-result-object v9

    if-eqz v9, :cond_d

    invoke-direct {v0, v1, v4}, Lcom/google/android/material/navigation/NavigationView;->createDefaultItemDrawable(Landroidx/appcompat/widget/C;Landroid/content/res/ColorStateList;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v1, v4, v12}, Landroidx/appcompat/widget/C;->f(II)I
    ...
    invoke-virtual {v1, v4, v9}, Landroidx/appcompat/widget/C;->a(IZ)Z
    ...
    invoke-virtual {v14, v9}, Landroidx/appcompat/view/menu/e;->setCallback(Landroidx/appcompat/view/menu/e$a;)V

    invoke-virtual {v10, v11}, Lcom/google/android/material/internal/NavigationMenuPresenter;->setId(I)V

    invoke-virtual {v10, v13, v14}, Lcom/google/android/material/internal/NavigationMenuPresenter;->initForMenu(Landroid/content/Context;Landroidx/appcompat/view/menu/e;)V
    ...
    invoke-virtual {v14, v10}, Landroidx/appcompat/view/menu/e;->addMenuPresenter(Landroidx/appcompat/view/menu/j;)V
...
.method private createDefaultColorStateList(I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v3}, LC6;->a(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
...
.method private createDefaultItemBackground(Landroidx/appcompat/widget/C;)Landroid/graphics/drawable/Drawable;
    .locals 2
    .param p1    # Landroidx/appcompat/widget/C;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    .end param
    .annotation build Landroidx/annotation/NonNull;
    ...
    invoke-static {v0, p1, v1}, Lcom/google/android/material/resources/MaterialResources;->getColorStateList(Landroid/content/Context;Landroidx/appcompat/widget/C;I)Landroid/content/res/ColorStateList;

    move-result-object v0

    invoke-direct {p0, p1, v0}, Lcom/google/android/material/navigation/NavigationView;->createDefaultItemDrawable(Landroidx/appcompat/widget/C;Landroid/content/res/ColorStateList;)Landroid/graphics/drawable/Drawable;
...
.method private createDefaultItemDrawable(Landroidx/appcompat/widget/C;Landroid/content/res/ColorStateList;)Landroid/graphics/drawable/Drawable;
    .locals 9
    .param p1    # Landroidx/appcompat/widget/C;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
...
.method private hasShapeAppearance(Landroidx/appcompat/widget/C;)Z
    .locals 1
    .param p1    # Landroidx/appcompat/widget/C;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
...
.method private maybeUpdateCornerSizeForDrawerLayout(II)V
    ...
    invoke-static {v2, v3}, LcP;->b(II)I
...
.method protected onInsetsChanged(Landroidx/core/view/f;)V
    .locals 1
    ...
    invoke-virtual {v0, p1}, Lcom/google/android/material/internal/NavigationMenuPresenter;->dispatchApplyWindowInsets(Landroidx/core/view/f;)V
