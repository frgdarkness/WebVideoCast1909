...
.field private touchExplorationStateChangeListener:LN0$b;
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
.end field
...
.method constructor <init>(Lcom/google/android/material/textfield/TextInputLayout;Landroidx/appcompat/widget/C;)V
    ...
    invoke-direct {v4, p0, p2}, Lcom/google/android/material/textfield/EndCompoundLayout$EndIconDelegates;-><init>(Lcom/google/android/material/textfield/EndCompoundLayout;Landroidx/appcompat/widget/C;)V
    ...
    invoke-direct {p0, p2}, Lcom/google/android/material/textfield/EndCompoundLayout;->initErrorIconView(Landroidx/appcompat/widget/C;)V

    invoke-direct {p0, p2}, Lcom/google/android/material/textfield/EndCompoundLayout;->initEndIconView(Landroidx/appcompat/widget/C;)V

    invoke-direct {p0, p2}, Lcom/google/android/material/textfield/EndCompoundLayout;->initSuffixTextView(Landroidx/appcompat/widget/C;)V
...
.method private addTouchExplorationStateChangeListenerIfNeeded()V
    ...
    iget-object v0, p0, Lcom/google/android/material/textfield/EndCompoundLayout;->touchExplorationStateChangeListener:LN0$b;
    ...
    iget-object v1, p0, Lcom/google/android/material/textfield/EndCompoundLayout;->touchExplorationStateChangeListener:LN0$b;

    invoke-static {v0, v1}, LN0;->a(Landroid/view/accessibility/AccessibilityManager;LN0$b;)Z
...
.method private createIconView(Landroid/view/ViewGroup;Landroid/view/LayoutInflater;I)Lcom/google/android/material/internal/CheckableImageButton;
    ...
    invoke-static {p2, v1}, LN60;->d(Landroid/view/ViewGroup$MarginLayoutParams;I)V
...
.method private initEndIconView(Landroidx/appcompat/widget/C;)V
    .locals 6
    ...
    invoke-static {v4, p1, v1}, Lcom/google/android/material/resources/MaterialResources;->getColorStateList(Landroid/content/Context;Landroidx/appcompat/widget/C;I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {p1, v1, v5}, Landroidx/appcompat/widget/C;->k(II)I
    ...
    :cond_5
    invoke-virtual {p1, v0, v5}, Landroidx/appcompat/widget/C;->a(IZ)Z
...
.method private initErrorIconView(Landroidx/appcompat/widget/C;)V
    .locals 2
    ...
    invoke-static {v1, p1, v0}, Lcom/google/android/material/resources/MaterialResources;->getColorStateList(Landroid/content/Context;Landroidx/appcompat/widget/C;I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {p1, v0, v1}, Landroidx/appcompat/widget/C;->k(II)I
...
.method private initSuffixTextView(Landroidx/appcompat/widget/C;)V
    .locals 4
...
.method private removeTouchExplorationStateChangeListenerIfNeeded()V
    ...
    invoke-static {v1, v0}, LN0;->b(Landroid/view/accessibility/AccessibilityManager;LN0$b;)Z
...
.method private setUpDelegate(Lcom/google/android/material/textfield/EndIconDelegate;)V
    ...
    invoke-virtual {p1}, Lcom/google/android/material/textfield/EndIconDelegate;->getTouchExplorationStateChangeListener()LN0$b;

    move-result-object p1

    iput-object p1, p0, Lcom/google/android/material/textfield/EndCompoundLayout;->touchExplorationStateChangeListener:LN0$b;
...
.method private tearDownDelegate(Lcom/google/android/material/textfield/EndIconDelegate;)V
    ...
    iput-object v0, p0, Lcom/google/android/material/textfield/EndCompoundLayout;->touchExplorationStateChangeListener:LN0$b;
