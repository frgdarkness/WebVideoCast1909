...
.method public onInitializeAccessibilityNodeInfo(Landroid/view/View;Ls1;)V
    ...
    invoke-virtual {v8, p2}, Lcom/google/android/material/textfield/StartCompoundLayout;->setupAccessibilityNodeInfo(Ls1;)V

    const-string v8, ", "

    if-eqz v7, :cond_4

    invoke-virtual {p2, v0}, Ls1;->G0(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p2, v1}, Ls1;->G0(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p2, v3}, Ls1;->G0(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p2, v1}, Ls1;->o0(Ljava/lang/CharSequence;)V
    ...
    :goto_4
    invoke-virtual {p2, v6}, Ls1;->C0(Z)V
    ...
    :goto_5
    invoke-virtual {p2, v4}, Ls1;->r0(I)V
    ...
    :goto_6
    invoke-virtual {p2, v2}, Ls1;->k0(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p2, v0}, Ls1;->p0(Landroid/view/View;)V
    ...
    invoke-virtual {v0, p1, p2}, Lcom/google/android/material/textfield/EndIconDelegate;->onInitializeAccessibilityNodeInfo(Landroid/view/View;Ls1;)V
