...
# static fields
.field private static final INDICATOR_LENGTH_IN_LEVEL:LLK;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "LLK;"
        }
...
.field private final springAnimation:LDN0;

.field private final springForce:LEN0;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/android/material/progressindicator/DeterminateDrawable;->INDICATOR_LENGTH_IN_LEVEL:LLK;
...
.method constructor <init>(Landroid/content/Context;Lcom/google/android/material/progressindicator/BaseProgressIndicatorSpec;Lcom/google/android/material/progressindicator/DrawingDelegate;)V
    ...
    invoke-direct {p1}, LEN0;-><init>()V

    iput-object p1, p0, Lcom/google/android/material/progressindicator/DeterminateDrawable;->springForce:LEN0;

    const/high16 p2, 0x3f800000    # 1.0f

    invoke-virtual {p1, p2}, LEN0;->d(F)LEN0;

    const/high16 p3, 0x42480000    # 50.0f

    invoke-virtual {p1, p3}, LEN0;->f(F)LEN0;

    new-instance p3, LDN0;

    sget-object v0, Lcom/google/android/material/progressindicator/DeterminateDrawable;->INDICATOR_LENGTH_IN_LEVEL:LLK;

    invoke-direct {p3, p0, v0}, LDN0;-><init>(Ljava/lang/Object;LLK;)V

    iput-object p3, p0, Lcom/google/android/material/progressindicator/DeterminateDrawable;->springAnimation:LDN0;

    invoke-virtual {p3, p1}, LDN0;->s(LEN0;)LDN0;
...
# virtual methods
.method public addSpringAnimationEndListener(LxD$p;)V
    .locals 1
    .param p1    # LxD$p;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    iget-object v0, p0, Lcom/google/android/material/progressindicator/DeterminateDrawable;->springAnimation:LDN0;

    invoke-virtual {v0, p1}, LxD;->b(LxD$p;)LxD;
...
.method protected onLevelChange(I)Z
    ...
    invoke-virtual {v0, v2}, LxD;->k(F)LxD;

    iget-object v0, p0, Lcom/google/android/material/progressindicator/DeterminateDrawable;->springAnimation:LDN0;

    int-to-float p1, p1

    invoke-virtual {v0, p1}, LDN0;->o(F)V
...
.method public bridge synthetic registerAnimationCallback(Ln4;)V
    .locals 0
    .param p1    # Ln4;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-super {p0, p1}, Lcom/google/android/material/progressindicator/DrawableWithAnimatedVisibilityChange;->registerAnimationCallback(Ln4;)V

    return-void
.end method

.method public removeSpringAnimationEndListener(LxD$p;)V
    .locals 1
    .param p1    # LxD$p;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-virtual {v0, p1}, LxD;->g(LxD$p;)V
...
.method setVisibleInternal(ZZZ)Z
    ...
    iget-object p3, p0, Lcom/google/android/material/progressindicator/DeterminateDrawable;->springForce:LEN0;

    const/high16 v0, 0x42480000    # 50.0f

    div-float/2addr v0, p2

    invoke-virtual {p3, v0}, LEN0;->f(F)LEN0;
...
.method public bridge synthetic unregisterAnimationCallback(Ln4;)Z
    .locals 0
    .param p1    # Ln4;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-super {p0, p1}, Lcom/google/android/material/progressindicator/DrawableWithAnimatedVisibilityChange;->unregisterAnimationCallback(Ln4;)Z
