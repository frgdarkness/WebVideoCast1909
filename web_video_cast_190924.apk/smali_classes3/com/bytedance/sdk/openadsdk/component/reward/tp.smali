.class public Lcom/bytedance/sdk/openadsdk/component/reward/tp;
.super Ljava/lang/Object;
.source "SourceFile"


# direct methods
.method public static EYQ(Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    .locals 5
    ...
    invoke-virtual {v3, p0}, Lcom/bykv/vk/openvk/component/video/api/Td/mZx;->Pm(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p2}, Lcom/bytedance/sdk/openadsdk/core/model/Td;->EYQ(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0}, Lcom/bytedance/sdk/openadsdk/core/model/Td;->mZx(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v3}, Lcom/bytedance/sdk/openadsdk/core/model/Td;->EYQ(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p3}, Lcom/bytedance/sdk/openadsdk/core/model/Td;->Td(Ljava/lang/String;)V
    ...
    invoke-virtual {v1}, Lcom/bytedance/sdk/openadsdk/core/model/UB;->dVQ()Lcom/bytedance/sdk/openadsdk/core/model/tp;
    ...
    invoke-virtual {p0, p2}, Lcom/bytedance/sdk/openadsdk/core/model/tp;->EYQ(Ljava/lang/String;)V

    goto :goto_3

    :cond_3
    new-instance p0, Lcom/bytedance/sdk/openadsdk/core/model/tp;

    invoke-direct {p0}, Lcom/bytedance/sdk/openadsdk/core/model/tp;-><init>()V

    invoke-virtual {p0, p2}, Lcom/bytedance/sdk/openadsdk/core/model/tp;->EYQ(Ljava/lang/String;)V

    invoke-virtual {v1, p0}, Lcom/bytedance/sdk/openadsdk/core/model/UB;->EYQ(Lcom/bytedance/sdk/openadsdk/core/model/tp;)V
    ...
    invoke-virtual {v1, p0}, Lcom/bytedance/sdk/openadsdk/core/model/UB;->hYh(I)V
    ...
    new-instance p0, Lcom/bytedance/sdk/openadsdk/core/model/EYQ;

    invoke-direct {p0}, Lcom/bytedance/sdk/openadsdk/core/model/EYQ;-><init>()V
    ...
    invoke-virtual {p0, p1}, Lcom/bytedance/sdk/openadsdk/core/model/EYQ;->EYQ(Ljava/util/List;)V

    new-instance p1, Lcom/bytedance/sdk/openadsdk/component/reward/nWX;

    invoke-static {}, Lcom/bytedance/sdk/openadsdk/core/hu;->EYQ()Landroid/content/Context;

    move-result-object p2

    invoke-direct {p1, p2, p0}, Lcom/bytedance/sdk/openadsdk/component/reward/nWX;-><init>(Landroid/content/Context;Lcom/bytedance/sdk/openadsdk/core/model/EYQ;)V

    invoke-virtual {p1, v2}, Lcom/bytedance/sdk/openadsdk/component/reward/nWX;->EYQ(Z)V

    invoke-static {}, Lcom/bytedance/sdk/openadsdk/core/nWX;->EYQ()Lcom/bytedance/sdk/openadsdk/core/nWX;

    move-result-object p0

    invoke-virtual {p0}, Lcom/bytedance/sdk/openadsdk/core/nWX;->Kbd()Lcom/bytedance/sdk/openadsdk/utils/EYQ;

    move-result-object p0

    invoke-virtual {p0}, Lcom/bytedance/sdk/openadsdk/utils/EYQ;->mZx()Landroid/app/Activity;

    move-result-object p0

    invoke-virtual {p1}, Lcom/bytedance/sdk/openadsdk/component/reward/nWX;->EYQ()Lcom/bytedance/sdk/openadsdk/component/reward/IPb;

    move-result-object p1

    invoke-virtual {p1, p0}, Lcom/bytedance/sdk/openadsdk/component/reward/IPb;->show(Landroid/app/Activity;)V
    :try_end_0
