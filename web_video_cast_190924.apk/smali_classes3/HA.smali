...
.method private constructor <init>(Ljava/io/File;IIJ)V
    ...
    iput-object v1, v0, LHA;->a:Ljava/io/File;
    ...
    iput-object v2, v0, LHA;->b:Ljava/io/File;
...
.method private static N(Ljava/io/Writer;)V
    ...
    invoke-static {v1}, LGA;->a(Landroid/os/StrictMode$ThreadPolicy$Builder;)Landroid/os/StrictMode$ThreadPolicy$Builder;
...
.method public static U(Ljava/io/File;IIJ)LHA;
    .locals 9
    ...
    invoke-static {v0, v1, v2}, LHA;->b0(Ljava/io/File;Ljava/io/File;Z)V
    ...
    iget-object v1, v0, LHA;->b:Ljava/io/File;
    ...
    :try_start_0
    invoke-direct {v0}, LHA;->X()V

    invoke-direct {v0}, LHA;->W()V
    :try_end_0
...
.method private W()V
    ...
    invoke-static {v0}, LHA;->q(Ljava/io/File;)V
    ...
    invoke-static {v2}, LHA;->q(Ljava/io/File;)V
...
.method private X()V
    ...
    iget-object v3, p0, LHA;->b:Ljava/io/File;

    invoke-direct {v2, v3}, Ljava/io/FileInputStream;-><init>(Ljava/io/File;)V

    sget-object v3, Ls41;->a:Ljava/nio/charset/Charset;

    invoke-direct {v1, v2, v3}, LKP0;-><init>(Ljava/io/InputStream;Ljava/nio/charset/Charset;)V

    :try_start_0
    invoke-virtual {v1}, LKP0;->e()Ljava/lang/String;
    ...
    invoke-direct {p0, v2}, LHA;->Y(Ljava/lang/String;)V
    :try_end_1
    ...
    invoke-virtual {v1}, LKP0;->d()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-direct {p0}, LHA;->Z()V
    ...
    iget-object v4, p0, LHA;->b:Ljava/io/File;

    const/4 v5, 0x1

    invoke-direct {v3, v4, v5}, Ljava/io/FileOutputStream;-><init>(Ljava/io/File;Z)V

    sget-object v4, Ls41;->a:Ljava/nio/charset/Charset;
    ...
    :goto_1
    invoke-static {v1}, Ls41;->a(Ljava/io/Closeable;)V
...
.method private declared-synchronized Z()V
    ...
    invoke-static {v0}, LHA;->n(Ljava/io/Writer;)V
    ...
    iget-object v2, p0, LHA;->d:Ljava/io/File;

    invoke-static {v0, v2, v1}, LHA;->b0(Ljava/io/File;Ljava/io/File;Z)V

    :cond_3
    iget-object v0, p0, LHA;->c:Ljava/io/File;

    iget-object v2, p0, LHA;->b:Ljava/io/File;

    const/4 v3, 0x0

    invoke-static {v0, v2, v3}, LHA;->b0(Ljava/io/File;Ljava/io/File;Z)V
    ...
    sget-object v1, Ls41;->a:Ljava/nio/charset/Charset;
...
.method static synthetic a(LHA;)Ljava/io/Writer;
    .locals 0
...
.method static synthetic b(LHA;)I
    .locals 0
...
.method private static b0(Ljava/io/File;Ljava/io/File;Z)V
    ...
    invoke-static {p1}, LHA;->q(Ljava/io/File;)V
...
.method private c0()V
    ...
    invoke-virtual {p0, v0}, LHA;->a0(Ljava/lang/String;)Z
...
.method static synthetic d(LHA;)V
    .locals 0

    invoke-direct {p0}, LHA;->c0()V

    return-void
.end method

.method static synthetic e(LHA;)Ljava/io/File;
    .locals 0

    iget-object p0, p0, LHA;->a:Ljava/io/File;

    return-object p0
.end method

.method static synthetic g(LHA;LHA$c;Z)V
    .locals 0

    invoke-direct {p0, p1, p2}, LHA;->o(LHA$c;Z)V

    return-void
.end method

.method static synthetic i(LHA;)Z
    .locals 0

    invoke-direct {p0}, LHA;->S()Z
...
.method static synthetic k(LHA;)V
    .locals 0
...
.method static synthetic l(LHA;I)I
    .locals 0
...
.method private declared-synchronized o(LHA$c;Z)V
    .locals 9
    ...
    invoke-static {p1}, LHA;->N(Ljava/io/Writer;)V
...
.method private declared-synchronized v(Ljava/lang/String;J)LHA$c;
    .locals 5

    monitor-enter p0

    :try_start_0
    invoke-direct {p0}, LHA;->m()V
    ...
    invoke-direct {v0, p0, p1, v3}, LHA$d;-><init>(LHA;Ljava/lang/String;LHA$a;)V
    ...
    invoke-direct {p2, p0, v0, v3}, LHA$c;-><init>(LHA;LHA$d;LHA$a;)V
...
# virtual methods
.method public declared-synchronized Q(Ljava/lang/String;)LHA$e;
    .locals 9
...
.method public p()V
    ...
    iget-object v0, p0, LHA;->a:Ljava/io/File;

    invoke-static {v0}, Ls41;->b(Ljava/io/File;)V

    return-void
.end method

.method public s(Ljava/lang/String;)LHA$c;
    .locals 2

    const-wide/16 v0, -0x1

    invoke-direct {p0, p1, v0, v1}, LHA;->v(Ljava/lang/String;J)LHA$c;
