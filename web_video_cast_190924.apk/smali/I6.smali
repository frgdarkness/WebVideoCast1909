...
.field private static final sConstructorMap:LiL0;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, LI6;->sConstructorSignature:[Ljava/lang/Class;
    ...
    sput-object v0, LI6;->sOnClickAttrs:[I
    ...
    sput-object v0, LI6;->sAccessibilityHeading:[I
    ...
    sput-object v0, LI6;->sAccessibilityPaneTitle:[I
    ...
    sput-object v0, LI6;->sScreenReaderFocusable:[I
    ...
    sput-object v0, LI6;->sClassPrefixList:[Ljava/lang/String;

    new-instance v0, LiL0;

    invoke-direct {v0}, LiL0;-><init>()V

    sput-object v0, LI6;->sConstructorMap:LiL0;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, LI6;->mConstructorArgs:[Ljava/lang/Object;
...
.method private a(Landroid/content/Context;Landroid/view/View;Landroid/util/AttributeSet;)V
    ...
    :cond_0
    sget-object v0, LI6;->sAccessibilityHeading:[I
    ...
    sget-object v0, LI6;->sAccessibilityPaneTitle:[I
    ...
    sget-object v0, LI6;->sScreenReaderFocusable:[I
...
.method private b(Landroid/view/View;Landroid/util/AttributeSet;)V
    ...
    :cond_0
    sget-object v1, LI6;->sOnClickAttrs:[I
    ...
    invoke-direct {v1, p1, v0}, LI6$a;-><init>(Landroid/view/View;Ljava/lang/String;)V
...
.method private c(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
    ...
    sget-object v0, LI6;->sConstructorMap:LiL0;

    invoke-virtual {v0, p2}, LiL0;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    sget-object p3, LI6;->sConstructorSignature:[Ljava/lang/Class;

    invoke-virtual {p1, p3}, Ljava/lang/Class;->getConstructor([Ljava/lang/Class;)Ljava/lang/reflect/Constructor;

    move-result-object v1

    invoke-virtual {v0, p2, v1}, LiL0;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object p1, p0, LI6;->mConstructorArgs:[Ljava/lang/Object;
...
.method private d(Landroid/content/Context;Ljava/lang/String;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    :try_start_0
    iget-object v3, p0, LI6;->mConstructorArgs:[Ljava/lang/Object;
    ...
    :goto_0
    sget-object v3, LI6;->sClassPrefixList:[Ljava/lang/String;
    ...
    invoke-direct {p0, p1, p2, v3}, LI6;->c(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
    ...
    :cond_3
    :try_start_1
    invoke-direct {p0, p1, p2, v1}, LI6;->c(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
    ...
    iget-object p2, p0, LI6;->mConstructorArgs:[Ljava/lang/Object;
...
.method private static e(Landroid/content/Context;Landroid/util/AttributeSet;ZZ)Landroid/content/Context;
    ...
    invoke-direct {p1, p0, p2}, Lbq;-><init>(Landroid/content/Context;I)V
...
.method public final createView(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;ZZZZ)Landroid/view/View;
    ...
    :cond_1
    invoke-static {p1, p4, p6, p7}, LI6;->e(Landroid/content/Context;Landroid/util/AttributeSet;ZZ)Landroid/content/Context;
    ...
    invoke-virtual {p0, p1, p2, p4}, LI6;->createView(Landroid/content/Context;Ljava/lang/String;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    :pswitch_0
    invoke-virtual {p0, p1, p4}, LI6;->createButton(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatButton;

    move-result-object p5

    invoke-direct {p0, p5, p2}, LI6;->f(Landroid/view/View;Ljava/lang/String;)V

    goto/16 :goto_2

    :pswitch_1
    invoke-virtual {p0, p1, p4}, LI6;->createEditText(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatEditText;
    ...
    :pswitch_2
    invoke-virtual {p0, p1, p4}, LI6;->createCheckBox(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatCheckBox;
    ...
    :pswitch_3
    invoke-virtual {p0, p1, p4}, LI6;->createAutoCompleteTextView(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatAutoCompleteTextView;
    ...
    :pswitch_4
    invoke-virtual {p0, p1, p4}, LI6;->createImageView(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatImageView;
    ...
    :pswitch_5
    invoke-virtual {p0, p1, p4}, LI6;->createToggleButton(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatToggleButton;
    ...
    :pswitch_6
    invoke-virtual {p0, p1, p4}, LI6;->createRadioButton(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatRadioButton;
    ...
    :pswitch_7
    invoke-virtual {p0, p1, p4}, LI6;->createSpinner(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatSpinner;
    ...
    :pswitch_8
    invoke-virtual {p0, p1, p4}, LI6;->createSeekBar(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatSeekBar;
    ...
    :pswitch_9
    invoke-virtual {p0, p1, p4}, LI6;->createImageButton(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatImageButton;
    ...
    :pswitch_a
    invoke-virtual {p0, p1, p4}, LI6;->createTextView(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatTextView;
    ...
    :pswitch_b
    invoke-virtual {p0, p1, p4}, LI6;->createMultiAutoCompleteTextView(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatMultiAutoCompleteTextView;
    ...
    :pswitch_c
    invoke-virtual {p0, p1, p4}, LI6;->createCheckedTextView(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatCheckedTextView;
    ...
    :pswitch_d
    invoke-virtual {p0, p1, p4}, LI6;->createRatingBar(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatRatingBar;
    ...
    invoke-direct {p0, p1, p2, p4}, LI6;->d(Landroid/content/Context;Ljava/lang/String;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    invoke-direct {p0, p5, p4}, LI6;->b(Landroid/view/View;Landroid/util/AttributeSet;)V

    invoke-direct {p0, p1, p5, p4}, LI6;->a(Landroid/content/Context;Landroid/view/View;Landroid/util/AttributeSet;)V
