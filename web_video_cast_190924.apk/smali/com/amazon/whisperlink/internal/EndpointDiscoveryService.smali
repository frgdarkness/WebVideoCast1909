...
.method private addCallbackConnection(Lcom/amazon/whisperlink/service/DeviceCallback;)V
    ...
    invoke-virtual {v0, p1, v1, v2}, Lcom/amazon/whisperlink/internal/CallbackConnectionCache;->addCallbackConnection(Lcom/amazon/whisperlink/service/DeviceCallback;Lorg/apache/thrift/TServiceClientFactory;Ljava/lang/Class;)V
    :try_end_0
...
.method private getServicesForFilter(Lcom/amazon/whisperplay/impl/FilterMatcher;Ljava/util/List;)Ljava/util/List;
    ...
    check-cast v3, Lcom/amazon/whisperlink/service/DeviceServices;

    invoke-virtual {v3}, Lcom/amazon/whisperlink/service/DeviceServices;->getDevice()Lcom/amazon/whisperlink/service/Device;

    move-result-object v4

    invoke-virtual {v3}, Lcom/amazon/whisperlink/service/DeviceServices;->getServices()Ljava/util/List;
    ...
    invoke-direct {p0, p1, v4, v5, v0}, Lcom/amazon/whisperlink/internal/EndpointDiscoveryService;->matchFilter(Lcom/amazon/whisperplay/impl/FilterMatcher;Lcom/amazon/whisperlink/service/Device;Ljava/util/List;Z)Lcom/amazon/whisperlink/internal/EndpointDiscoveryService$MatchFilterResult;
    ...
    invoke-static {v4}, Lcom/amazon/whisperlink/util/WhisperLinkUtil;->getFormattedDeviceUuid(Lcom/amazon/whisperlink/service/Device;)Ljava/lang/String;
    ...
    const-string v6, "getServicesForFilter: adding: Device: %s, Description: %s, channel: %s"

    invoke-static {v6, v9}, Ljava/lang/String;->format(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;

    move-result-object v6

    invoke-static {v7, v6}, Lcom/amazon/whisperlink/util/Log;->debug(Ljava/lang/String;Ljava/lang/String;)V

    new-instance v6, Lcom/amazon/whisperlink/service/ServiceEndpointData;

    invoke-static {v5}, Lcom/amazon/whisperlink/internal/EndpointDiscoveryService$MatchFilterResult;->access$600(Lcom/amazon/whisperlink/internal/EndpointDiscoveryService$MatchFilterResult;)Ljava/util/List;

    move-result-object v5

    invoke-direct {v6, v4, v3, v5}, Lcom/amazon/whisperlink/service/ServiceEndpointData;-><init>(Lcom/amazon/whisperlink/service/Device;Lcom/amazon/whisperlink/service/Description;Ljava/util/List;)V

    invoke-interface {v1, v6}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    invoke-direct {p0, v2, v4}, Lcom/amazon/whisperlink/internal/EndpointDiscoveryService;->addIfAbsent(Ljava/util/List;Lcom/amazon/whisperlink/service/Device;)V
    ...
    const-string v5, "getServicesForFilter: did not pass filter, uuid="
    ...
    invoke-static {v7, v3}, Lcom/amazon/whisperlink/util/Log;->debug(Ljava/lang/String;Ljava/lang/String;)V

    goto :goto_0

    :cond_1
    invoke-direct {p0, v2}, Lcom/amazon/whisperlink/internal/EndpointDiscoveryService;->verifyConnectivity(Ljava/util/List;)V
...
.method private invokeCallbacks(Lcom/amazon/whisperplay/impl/FilterMatcher;Lcom/amazon/whisperlink/internal/EndpointDiscoveryService$CallbackMethod;Ljava/util/List;)V
    ...
    iget-object v2, p0, Lcom/amazon/whisperlink/internal/EndpointDiscoveryService;->filterRegistry:Lcom/amazon/whisperlink/internal/DiscoveryFilterRegistry;

    invoke-virtual {v2, p1}, Lcom/amazon/whisperlink/internal/DiscoveryFilterRegistry;->getCallbacks(Lcom/amazon/whisperplay/impl/FilterMatcher;)Ljava/util/List;
    ...
    const-string p2, "There is no callback for filter:%s"
    ...
    const-string v0, "Listener count for %s is %d"
...
.method private scheduleSearchComplete()V
    ...
    sget v0, Lcom/amazon/whisperlink/internal/EndpointDiscoveryService;->SEARCH_TIMEOUT:I
    ...
    const-string v0, "scheduled search complete, %d"
...
.method private turnOnAnyAccountSearch(Lcom/amazon/whisperplay/impl/FilterMatcher;)V
    ...
    const-string v2, "skip passive all account search: %s"
    ...
    const-string v0, "turnOnAnyAccountSearch, any account: %b"
...
.method protected searchComplete(Ljava/lang/String;)V
    ...
    :try_start_0
    iget-object v5, p0, Lcom/amazon/whisperlink/internal/EndpointDiscoveryService;->refreshExplorerIds:Ljava/util/List;
    ...
    const-string v6, "searchComplete with %s, refreshingExplorerIds is now: %s"
    ...
    iget-object v5, p0, Lcom/amazon/whisperlink/internal/EndpointDiscoveryService;->refreshList:Ljava/util/List;
    ...
    check-cast v6, Lcom/amazon/whisperlink/internal/EndpointDiscoveryService$RefreshCallback;

    if-nez p1, :cond_2

    iget-object v7, v6, Lcom/amazon/whisperlink/internal/EndpointDiscoveryService$RefreshCallback;->activeExplorerIds:Ljava/util/List;
    ...
    const-string v8, "updated activeExplorerIds to %s for filter %s"

    iget-object v9, v6, Lcom/amazon/whisperlink/internal/EndpointDiscoveryService$RefreshCallback;->activeExplorerIds:Ljava/util/List;

    iget-object v10, v6, Lcom/amazon/whisperlink/internal/EndpointDiscoveryService$RefreshCallback;->filterMatcher:Lcom/amazon/whisperplay/impl/FilterMatcher;
    ...
    invoke-static {v7, v8}, Lcom/amazon/whisperlink/util/Log;->debug(Ljava/lang/String;Ljava/lang/String;)V
