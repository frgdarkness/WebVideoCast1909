...
.method private removeCallback(Lcom/amazon/whisperplay/impl/FilterMatcher;Lcom/amazon/whisperlink/service/DeviceCallback;)Z
    ...
    iget-object v2, p0, Lcom/amazon/whisperlink/internal/DiscoveryFilterRegistry;->filterToCallbacksMap:Ljava/util/concurrent/ConcurrentMap;
    ...
    const-string v4, "DiscoveryFilterRegistry"

    const-string v5, "removeCallback: %s, removing %s, has %d"
    ...
    invoke-static {v4, p2}, Lcom/amazon/whisperlink/util/Log;->debug(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v3, "removeCallback, removed entry: %s"
...
.method addFilter(Lcom/amazon/whisperplay/impl/FilterMatcher;Lcom/amazon/whisperlink/service/DeviceCallback;)V
    ...
    const-string v2, "addFilter: creating new list for %s"
    ...
    :cond_1
    const-string v2, "DiscoveryFilterRegistry"

    const-string v4, "addFilter: %s, adding %s, has %d"
