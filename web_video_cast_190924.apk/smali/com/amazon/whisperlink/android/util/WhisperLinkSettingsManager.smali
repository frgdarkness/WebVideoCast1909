...
.method private modifyDeviceSet(Ljava/lang/String;Lcom/amazon/whisperlink/service/Device;Z)V
    ...
    :try_start_0
    iget-object v0, p0, Lcom/amazon/whisperlink/android/util/WhisperLinkSettingsManager;->context:Landroid/content/Context;

    invoke-virtual {v0}, Landroid/content/Context;->getContentResolver()Landroid/content/ContentResolver;

    move-result-object v0

    sget-object v1, Lcom/amazon/whisperlink/android/util/WhisperLinkSettingsManager;->SETTINGS_URI:Landroid/net/Uri;
    ...
    :goto_0
    :try_start_2
    const-string v2, "WhisperLinkSettingsManager"

    new-instance v3, Ljava/lang/StringBuilder;

    invoke-direct {v3}, Ljava/lang/StringBuilder;-><init>()V

    const-string v4, "Exception when query uuids="
    ...
    :goto_1
    invoke-direct {p0, v1}, Lcom/amazon/whisperlink/android/util/WhisperLinkSettingsManager;->getUuids(Ljava/lang/String;)Ljava/util/Set;
    ...
    invoke-direct {p0, v0}, Lcom/amazon/whisperlink/android/util/WhisperLinkSettingsManager;->convertToCommaSeparatedStrings(Ljava/util/Set;)Ljava/lang/String;
    ...
    invoke-virtual {p1, p3, p2, v6, v6}, Landroid/content/ContentResolver;->update(Landroid/net/Uri;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
...
.method private queryBoolean(Ljava/lang/String;)Z
    ...
    const-string v4, "Exception when query boolean="
    ...
    invoke-static {v2, p1, v1}, Lcom/amazon/whisperlink/util/Log;->error(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
...
.method private queryDevices(Ljava/lang/String;)Ljava/util/Set;
    ...
    const-string v4, "Exception when query devices="
    ...
    :cond_0
    :goto_2
    invoke-direct {p0, v6}, Lcom/amazon/whisperlink/android/util/WhisperLinkSettingsManager;->getDevices(Ljava/lang/String;)Ljava/util/Set;
