...
.method public process(Lorg/apache/thrift/protocol/TProtocol;Lorg/apache/thrift/protocol/TProtocol;)Z
    ...
    invoke-virtual {p0, p1, p2, v0}, Lcom/amazon/whisperlink/service/event/PropertySubscriptionManager$Processor;->process(Lorg/apache/thrift/protocol/TProtocol;Lorg/apache/thrift/protocol/TProtocol;Lorg/apache/thrift/protocol/TMessage;)Z
...
.method public process(Lorg/apache/thrift/protocol/TProtocol;Lorg/apache/thrift/protocol/TProtocol;Lorg/apache/thrift/protocol/TMessage;)Z
    ...
    invoke-virtual {v0, p1}, Lcom/amazon/whisperlink/service/event/PropertySubscriptionManager$subscribeListener_args;->read(Lorg/apache/thrift/protocol/TProtocol;)V
    ...
    invoke-direct {v0, v2, v7, v3}, Lorg/apache/thrift/protocol/TMessage;-><init>(Ljava/lang/String;BI)V

    invoke-virtual {p2, v0}, Lorg/apache/thrift/protocol/TProtocol;->writeMessageBegin(Lorg/apache/thrift/protocol/TMessage;)V

    invoke-virtual {v1, p2}, Lcom/amazon/whisperlink/service/event/PropertySubscriptionManager$subscribeListener_result;->write(Lorg/apache/thrift/protocol/TProtocol;)V
    ...
    invoke-virtual {v0, p1}, Lcom/amazon/whisperlink/service/event/PropertySubscriptionManager$renewSubscription_args;->read(Lorg/apache/thrift/protocol/TProtocol;)V
    ...
    invoke-direct {v0, v1, v7, v3}, Lorg/apache/thrift/protocol/TMessage;-><init>(Ljava/lang/String;BI)V

    invoke-virtual {p2, v0}, Lorg/apache/thrift/protocol/TProtocol;->writeMessageBegin(Lorg/apache/thrift/protocol/TMessage;)V

    invoke-virtual {v2, p2}, Lcom/amazon/whisperlink/service/event/PropertySubscriptionManager$renewSubscription_result;->write(Lorg/apache/thrift/protocol/TProtocol;)V
    ...
    invoke-virtual {v1, p1}, Lcom/amazon/whisperlink/service/event/PropertySubscriptionManager$cancelSubscription_args;->read(Lorg/apache/thrift/protocol/TProtocol;)V
    ...
    invoke-direct {v1, v0, v7, v3}, Lorg/apache/thrift/protocol/TMessage;-><init>(Ljava/lang/String;BI)V

    invoke-virtual {p2, v1}, Lorg/apache/thrift/protocol/TProtocol;->writeMessageBegin(Lorg/apache/thrift/protocol/TMessage;)V

    invoke-virtual {v2, p2}, Lcom/amazon/whisperlink/service/event/PropertySubscriptionManager$cancelSubscription_result;->write(Lorg/apache/thrift/protocol/TProtocol;)V
    ...
    invoke-direct {v0, v6, v1}, Lorg/apache/thrift/TApplicationException;-><init>(ILjava/lang/String;)V

    new-instance v1, Lorg/apache/thrift/protocol/TMessage;

    iget-object v2, p3, Lorg/apache/thrift/protocol/TMessage;->name:Ljava/lang/String;

    iget v5, p3, Lorg/apache/thrift/protocol/TMessage;->seqid:I

    invoke-direct {v1, v2, v4, v5}, Lorg/apache/thrift/protocol/TMessage;-><init>(Ljava/lang/String;BI)V
