...
.method private createOrResetService(Lcom/amazon/whisperlink/service/Description;)V
    ...
    const-string v3, "Creating or resetting service for Description: "
    ...
    const-string v1, "Description not supported. Unable to create or reset service for Description: "
    ...
    iget-object v2, p0, Lcom/amazon/whisperlink/core/android/explorers/ThreadSafeJmdnsManager$JmdnsManager;->discoveryStore:Lcom/amazon/whisperlink/internal/DiscoveryStore;

    invoke-virtual {v2}, Lcom/amazon/whisperlink/internal/DiscoveryStore;->getLocalSnapshotHash()Ljava/lang/String;
    ...
    iget-object v5, p0, Lcom/amazon/whisperlink/core/android/explorers/ThreadSafeJmdnsManager$JmdnsManager;->lastUpdatedDevice:Lcom/amazon/whisperlink/service/Device;

    invoke-virtual {v4, v5}, Lcom/amazon/whisperlink/service/Device;->equals(Lcom/amazon/whisperlink/service/Device;)Z

    move-result v5

    if-eqz v5, :cond_2

    iget-object v5, p0, Lcom/amazon/whisperlink/core/android/explorers/ThreadSafeJmdnsManager$JmdnsManager;->lastUpdatedSnapshot:Ljava/lang/String;

    invoke-static {v5, v2}, Lcom/amazon/whisperlink/util/StringUtil;->sameString(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    :goto_1
    iget-object v6, p0, Lcom/amazon/whisperlink/core/android/explorers/ThreadSafeJmdnsManager$JmdnsManager;->lastUpdatedSnapshot:Ljava/lang/String;
    ...
    const-string v0, "Last updated snapshot: %s Current snapshot: %s Changed: %s"
    ...
    invoke-direct {p0, v4, p1, v2, v5}, Lcom/amazon/whisperlink/core/android/explorers/ThreadSafeJmdnsManager$JmdnsManager;->registerService(Lcom/amazon/whisperlink/service/Device;Lcom/amazon/whisperlink/service/Description;Ljava/lang/String;Z)V
    ...
    invoke-static {v3, v0, p1}, Lcom/amazon/whisperlink/util/Log;->error(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private resolve(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v0, "Requesting to resolve service Service Type: %s Service Name: %s Subtype: %s"
