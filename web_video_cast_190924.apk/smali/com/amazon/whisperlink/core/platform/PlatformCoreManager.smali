...
.method private createServerTransport(Lorg/apache/thrift/transport/TServerTransport;Ljava/lang/String;Z)Lcom/amazon/whisperlink/transport/TWhisperLinkServerTransport;
    .locals 6
    ...
    invoke-direct {p3, p1, p2}, Lcom/amazon/whisperlink/transport/TWhisperLinkServerTransport;-><init>(Lorg/apache/thrift/transport/TServerTransport;Ljava/lang/String;)V
...
.method private createThreadPoolRouterByTransport(Lcom/amazon/whisperlink/transport/TExternalCommunicationChannelFactory;Z)Lcom/amazon/whisperlink/internal/TThreadPoolServiceRouter;
    ...
    :try_start_0
    invoke-direct {p0, p1, p2}, Lcom/amazon/whisperlink/core/platform/PlatformCoreManager;->getDelegateServerTransportWithRetries(Lcom/amazon/whisperlink/transport/TExternalCommunicationChannelFactory;Z)Lorg/apache/thrift/transport/TServerTransport;
    ...
    invoke-direct {p0, p1, v8, p2}, Lcom/amazon/whisperlink/core/platform/PlatformCoreManager;->createServerTransport(Lorg/apache/thrift/transport/TServerTransport;Ljava/lang/String;Z)Lcom/amazon/whisperlink/transport/TWhisperLinkServerTransport;
    ...
    invoke-direct/range {v2 .. v7}, Lcom/amazon/whisperlink/internal/TThreadPoolServiceRouter;-><init>(Lorg/apache/thrift/transport/TServerTransport;Lcom/amazon/whisperlink/internal/RegistrarService;ZLcom/amazon/whisperlink/util/TaskExecutor;Ljava/lang/String;)V
    :try_end_0
...
.method private getDelegateServerTransportWithRetries(Lcom/amazon/whisperlink/transport/TExternalCommunicationChannelFactory;Z)Lorg/apache/thrift/transport/TServerTransport;
    .locals 7
    ...
    :try_start_0
    invoke-interface {p1}, Lcom/amazon/whisperlink/transport/TExternalCommunicationChannelFactory;->getSecureServerTransport()Lorg/apache/thrift/transport/TServerTransport;
    ...
    instance-of v4, v0, Lorg/apache/thrift/transport/TServerSocket;
    ...
    check-cast v5, Lorg/apache/thrift/transport/TServerSocket;

    invoke-virtual {v5}, Lorg/apache/thrift/transport/TServerSocket;->getServerSocket()Ljava/net/ServerSocket;
    ...
    :cond_1
    invoke-interface {p1}, Lcom/amazon/whisperlink/transport/TExternalCommunicationChannelFactory;->getServerTransport()Lorg/apache/thrift/transport/TServerTransport;
...
.method private hasConnectableServiceWhileSleeping()Z
    ...
    invoke-static {v1, v2}, Lcom/amazon/whisperlink/util/ThriftEnumBitFieldUtil;->contains(ILorg/apache/thrift/TEnum;)Z
...
.method private reinitializeRouter(Lcom/amazon/whisperlink/internal/TThreadPoolServiceRouter;)Z
    ...
    invoke-direct {p0, v3, v4}, Lcom/amazon/whisperlink/core/platform/PlatformCoreManager;->getDelegateServerTransportWithRetries(Lcom/amazon/whisperlink/transport/TExternalCommunicationChannelFactory;Z)Lorg/apache/thrift/transport/TServerTransport;

    move-result-object v5

    if-eqz v5, :cond_0

    invoke-direct {p0, v5, v2, v4}, Lcom/amazon/whisperlink/core/platform/PlatformCoreManager;->createServerTransport(Lorg/apache/thrift/transport/TServerTransport;Ljava/lang/String;Z)Lcom/amazon/whisperlink/transport/TWhisperLinkServerTransport;

    move-result-object v2

    invoke-virtual {p1, v2}, Lcom/amazon/whisperlink/internal/TThreadPoolServiceRouter;->setServerTransport(Lorg/apache/thrift/transport/TServerTransport;)V
...
.method private reinitializeRouters()V
    ...
    invoke-direct {p0, v4, v3}, Lcom/amazon/whisperlink/core/platform/PlatformCoreManager;->getDelegateServerTransportWithRetries(Lcom/amazon/whisperlink/transport/TExternalCommunicationChannelFactory;Z)Lorg/apache/thrift/transport/TServerTransport;
    ...
    :try_start_0
    invoke-direct {p0, v4, v2, v3}, Lcom/amazon/whisperlink/core/platform/PlatformCoreManager;->createServerTransport(Lorg/apache/thrift/transport/TServerTransport;Ljava/lang/String;Z)Lcom/amazon/whisperlink/transport/TWhisperLinkServerTransport;

    move-result-object v2

    invoke-virtual {v1, v2}, Lcom/amazon/whisperlink/internal/TThreadPoolServiceRouter;->setServerTransport(Lorg/apache/thrift/transport/TServerTransport;)V
