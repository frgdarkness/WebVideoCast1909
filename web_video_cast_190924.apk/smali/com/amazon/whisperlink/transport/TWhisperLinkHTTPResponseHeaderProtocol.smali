...
.method public constructor <init>(Lorg/apache/thrift/transport/TTransport;)V
    ...
    invoke-direct {p0, p1}, Lcom/amazon/whisperlink/transport/TWhisperLinkHTTPHeaderBaseProtocol;-><init>(Lorg/apache/thrift/transport/TTransport;)V
...
.method protected readHeaderStart(Ljava/io/ByteArrayOutputStream;)I
    ...
    invoke-virtual {v0, v1, v2, v4}, Lorg/apache/thrift/transport/TTransport;->readAll([BII)I
    ...
    invoke-virtual {v4, v5, v2, v3}, Lorg/apache/thrift/transport/TTransport;->readAll([BII)I
