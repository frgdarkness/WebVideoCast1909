...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lcom/amazon/whisperlink/rcm/RemoteConfiguration;->mManager:LLB0;
...
.method public getConfiguration(Lcom/amazon/whisperlink/rcm/RemoteConfiguration$Listener;)Ljava/lang/String;
    ...
    :goto_2
    :try_start_1
    iget-object p1, p0, Lcom/amazon/whisperlink/rcm/RemoteConfiguration;->mManager:LLB0;

    invoke-virtual {p1}, LLB0;->e()Lbo;
...
.method public declared-synchronized initializeConfiguration(Landroid/content/Context;Ljava/util/Map;Z)V
    ...
    :try_start_0
    iget-object v0, p0, Lcom/amazon/whisperlink/rcm/RemoteConfiguration;->mManager:LLB0;
    ...
    invoke-static {p1, v1}, LLB0;->c(Landroid/content/Context;Ljava/lang/String;)LLB0$b;

    move-result-object v1

    invoke-virtual {v1, v0}, LLB0$b;->f(Lorg/json/JSONObject;)LLB0$b;

    move-result-object v0

    invoke-virtual {v0}, LLB0$b;->d()LLB0;
    ...
    iget-object v2, p0, Lcom/amazon/whisperlink/rcm/RemoteConfiguration;->mManager:LLB0;

    invoke-virtual {v2}, LLB0;->d()Lz9;
    ...
    invoke-interface {v2, v1, v3}, Lz9;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v1, p0, Lcom/amazon/whisperlink/rcm/RemoteConfiguration;->mManager:LLB0;

    invoke-virtual {v1}, LLB0;->d()Lz9;

    move-result-object v1

    invoke-interface {v1}, Lz9;->a()Ljava/util/Map;
    ...
    invoke-direct {p2, v0, p1, p3}, Lcom/amazon/whisperlink/rcm/ConfigurationSyncOperation;-><init>(LLB0;Landroid/content/Context;Z)V
