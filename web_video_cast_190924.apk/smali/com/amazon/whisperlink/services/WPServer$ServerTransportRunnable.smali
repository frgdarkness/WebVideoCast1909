...
.field private serverTrans:Lorg/apache/thrift/transport/TServerTransport;
...
# direct methods
.method public constructor <init>(Lcom/amazon/whisperlink/services/WPServer;Lorg/apache/thrift/transport/TServerTransport;Ljava/lang/String;Ljava/lang/String;)V
    .locals 1
    ...
    iput-object p2, p0, Lcom/amazon/whisperlink/services/WPServer$ServerTransportRunnable;->serverTrans:Lorg/apache/thrift/transport/TServerTransport;
...
.method private enforceConnectionPolicyOnOpen(Lcom/amazon/whisperlink/services/WPServer$ServerTransportRunnable$WorkerProcess;)Z
    ...
    iget-object v3, p0, Lcom/amazon/whisperlink/services/WPServer$ServerTransportRunnable;->workersLock:Ljava/lang/Object;

    monitor-enter v3

    :try_start_0
    iget-object v4, p0, Lcom/amazon/whisperlink/services/WPServer$ServerTransportRunnable;->workers:Ljava/util/Map;

    const/4 v5, 0x0

    if-eqz v4, :cond_0

    invoke-virtual {v2}, Lcom/amazon/whisperlink/transport/TWhisperLinkTransport;->getUUID()Ljava/lang/String;
    ...
    invoke-virtual {p1}, Lcom/amazon/whisperlink/services/WPServer$ServerTransportRunnable$WorkerProcess;->getClient()Lorg/apache/thrift/transport/TTransport;
    ...
    const-string v4, "ONE_PER_REMOTE_DEVICE_"

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v4, p0, Lcom/amazon/whisperlink/services/WPServer$ServerTransportRunnable;->service:Ljava/lang/String;
    ...
    invoke-static {v5, v3, v4, v6, v7}, Lcom/amazon/whisperlink/util/Log;->metric(Lcom/amazon/whisperlink/util/Log$LogHandler$MetricEventHolder;Ljava/lang/String;Lcom/amazon/whisperlink/util/Log$LogHandler$Metrics;D)V

    const-string v3, "WPServer"

    const-string v4, "CONNECTION_POLICY_ONE_PER_REMOTE_DEVICE Interrupting client: UUID: %s Service Id: %s, Connection Id: %s Channel: %s "
    ...
    invoke-virtual {v2}, Lcom/amazon/whisperlink/transport/TWhisperLinkTransport;->getConnectionIdentifier()Ljava/lang/String;

    move-result-object v7

    invoke-virtual {v2}, Lcom/amazon/whisperlink/transport/TWhisperLinkTransport;->getChannel()Ljava/lang/String;
...
.method protected doRun()V
    ...
    :try_start_0
    iget-object v0, p0, Lcom/amazon/whisperlink/services/WPServer$ServerTransportRunnable;->serverTrans:Lorg/apache/thrift/transport/TServerTransport;

    invoke-virtual {v0}, Lorg/apache/thrift/transport/TServerTransport;->listen()V
    :try_end_0
    .catch Lorg/apache/thrift/transport/TTransportException; {:try_start_0 .. :try_end_0} :catch_4
    ...
    invoke-static {v1}, Lcom/amazon/whisperlink/services/WPServer;->access$500(Lcom/amazon/whisperlink/services/WPServer;)Lorg/apache/thrift/server/TServerEventHandler;
    ...
    invoke-static {v1}, Lcom/amazon/whisperlink/services/WPServer;->access$600(Lcom/amazon/whisperlink/services/WPServer;)Lorg/apache/thrift/server/TServerEventHandler;
    ...
    :try_start_2
    iget-object v4, p0, Lcom/amazon/whisperlink/services/WPServer$ServerTransportRunnable;->serverTrans:Lorg/apache/thrift/transport/TServerTransport;

    invoke-virtual {v4}, Lorg/apache/thrift/transport/TServerTransport;->accept()Lorg/apache/thrift/transport/TTransport;
    ...
    invoke-interface {v5}, Lcom/amazon/whisperlink/services/WPProcessor;->createProcessor()Lorg/apache/thrift/TProcessor;
    ...
    invoke-static {v5, v4, v6}, Lcom/amazon/whisperlink/services/WPServer;->access$800(Lcom/amazon/whisperlink/services/WPServer;Lorg/apache/thrift/transport/TTransport;Ljava/lang/String;)V
    ...
    invoke-direct/range {v5 .. v10}, Lcom/amazon/whisperlink/services/WPServer$ServerTransportRunnable$WorkerProcess;-><init>(Lcom/amazon/whisperlink/services/WPServer$ServerTransportRunnable;Ljava/lang/String;Lorg/apache/thrift/transport/TTransport;Lorg/apache/thrift/TProcessor;Lcom/amazon/whisperlink/services/WPServer$1;)V
    ...
    :cond_9
    :goto_9
    iget-object v1, p0, Lcom/amazon/whisperlink/services/WPServer$ServerTransportRunnable;->serverTrans:Lorg/apache/thrift/transport/TServerTransport;
    ...
    :try_start_a
    iput-object v0, p0, Lcom/amazon/whisperlink/services/WPServer$ServerTransportRunnable;->serverTrans:Lorg/apache/thrift/transport/TServerTransport;
    ...
    :goto_a
    iget-object v2, p0, Lcom/amazon/whisperlink/services/WPServer$ServerTransportRunnable;->serverTrans:Lorg/apache/thrift/transport/TServerTransport;

    invoke-virtual {v2}, Lorg/apache/thrift/transport/TServerTransport;->close()V
...
.method public interrupt()V
    ...
    invoke-virtual {v1}, Lorg/apache/thrift/transport/TServerTransport;->interrupt()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
