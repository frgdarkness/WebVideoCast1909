...
.method getCurrentInetRoute()Lcom/amazon/whisperlink/service/Route;
    ...
    :cond_1
    const-string v5, "Android 11+ does not allow to use Mac address"

    invoke-static {v0, v5}, Lcom/amazon/whisperlink/util/Log;->warning(Ljava/lang/String;Ljava/lang/String;)V
...
.method public getLocalTransportConnInfo(Lorg/apache/thrift/transport/TTransport;)Ljava/lang/String;
    .locals 1
...
.method public getRouteFromConnectionMetadata(Ljava/lang/String;Lorg/apache/thrift/transport/TTransport;)Lcom/amazon/whisperlink/service/Route;
    .locals 4
    ...
    invoke-virtual {p2}, Lorg/apache/thrift/transport/TTransport;->getRemoteEndpointIdentifier()Ljava/lang/String;
...
.method public getSecureServerTransport()Lorg/apache/thrift/transport/TServerTransport;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/apache/thrift/transport/TTransportException;
...
.method public getSecureTransport(Lcom/amazon/whisperlink/transport/TransportOptions;)Lorg/apache/thrift/transport/TTransport;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/apache/thrift/transport/TTransportException;
...
.method public getServerTransport()Lorg/apache/thrift/transport/TServerTransport;
    .locals 7
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/apache/thrift/transport/TTransportException;
    ...
    :try_start_0
    new-instance v3, Lorg/apache/thrift/transport/TServerSocket;
    ...
    invoke-direct {v3, v4, v5}, Lorg/apache/thrift/transport/TServerSocket;-><init>(II)V
    :try_end_0
    ...
    invoke-direct {v3, v2, v4}, Lorg/apache/thrift/transport/TServerSocket;-><init>(II)V

    :goto_1
    invoke-virtual {v3}, Lorg/apache/thrift/transport/TServerSocket;->getServerSocket()Ljava/net/ServerSocket;
...
.method public getServerTransportConnInfo(Lorg/apache/thrift/transport/TServerTransport;Z)Ljava/lang/String;
    .locals 8
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/apache/thrift/transport/TTransportException;
    ...
    instance-of v0, p1, Lorg/apache/thrift/transport/TServerSocket;

    if-eqz v0, :cond_1

    :try_start_0
    check-cast p1, Lorg/apache/thrift/transport/TServerSocket;

    invoke-virtual {p1}, Lorg/apache/thrift/transport/TServerSocket;->getServerSocket()Ljava/net/ServerSocket;
...
.method public getTransport(Lcom/amazon/whisperlink/transport/TransportOptions;)Lorg/apache/thrift/transport/TTransport;
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/apache/thrift/transport/TTransportException;
    ...
    invoke-direct {v2, v1, v0, v3, p1}, Lorg/apache/thrift/transport/TSocket;-><init>(Ljava/lang/String;III)V
    ...
    invoke-direct {v1, v2, v0, v3, p1}, Lorg/apache/thrift/transport/TSocket;-><init>(Ljava/lang/String;III)V
...
.method public updateTransport(Lorg/apache/thrift/transport/TTransport;Lcom/amazon/whisperlink/transport/TransportOptions;)V
    .locals 2

    instance-of v0, p1, Lorg/apache/thrift/transport/TSocket;

    const-string v1, "TExternalSocketFactory"

    if-eqz v0, :cond_0

    check-cast p1, Lorg/apache/thrift/transport/TSocket;

    invoke-virtual {p2}, Lcom/amazon/whisperlink/transport/TransportOptions;->getReadTimeout()I

    move-result v0

    invoke-virtual {p1, v0}, Lorg/apache/thrift/transport/TSocket;->setReadTimeout(I)V
