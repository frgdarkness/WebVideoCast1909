...
.method private setUpNetworkChangeListener(Landroid/os/Handler;)V
    ...
    const-string v2, "Registering network state change listener, listener="
    ...
    invoke-virtual {v3}, Lcom/amazon/whisperlink/port/android/listener/NetworkStateChangeListener;->getIntentFilter()Landroid/content/IntentFilter;
    ...
    invoke-static/range {v2 .. v7}, LWp;->registerReceiver(Landroid/content/Context;Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;Ljava/lang/String;Landroid/os/Handler;I)Landroid/content/Intent;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method private setUpTimeChangeListener(Landroid/os/Handler;)V
    ...
    new-instance v2, Lcom/amazon/whisperlink/core/android/listener/TimeChangeListener;

    invoke-direct {v2}, Lcom/amazon/whisperlink/core/android/listener/TimeChangeListener;-><init>()V

    iput-object v2, p0, Lcom/amazon/whisperlink/platform/GenericAndroidPlatform;->timeChangeListener:Lcom/amazon/whisperlink/core/android/listener/TimeChangeListener;

    :try_start_0
    iget-object v1, p0, Lcom/amazon/whisperlink/platform/GenericAndroidPlatform;->ctx:Landroid/content/Context;

    invoke-virtual {v2}, Lcom/amazon/whisperlink/core/android/listener/TimeChangeListener;->getIntentFilter()Landroid/content/IntentFilter;
    ...
    invoke-static/range {v1 .. v6}, LWp;->registerReceiver(Landroid/content/Context;Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;Ljava/lang/String;Landroid/os/Handler;I)Landroid/content/Intent;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    iput-object p1, p0, Lcom/amazon/whisperlink/platform/GenericAndroidPlatform;->timeChangeListener:Lcom/amazon/whisperlink/core/android/listener/TimeChangeListener;
