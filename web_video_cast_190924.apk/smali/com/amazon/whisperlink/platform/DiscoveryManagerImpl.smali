...
.method private canRefreshListener(Lcom/amazon/whisperplay/discovery/DiscoveryManager$DiscoveryListener;)Z
    ...
    :try_start_0
    iget-object v3, p0, Lcom/amazon/whisperlink/platform/DiscoveryManagerImpl;->listenerStateMap:Ljava/util/concurrent/ConcurrentMap;

    invoke-interface {v3, p1}, Ljava/util/Map;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v3

    check-cast v3, Lcom/amazon/whisperlink/platform/DiscoveryManagerImpl$ListenerState;

    monitor-exit v2
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    sget-object v2, Lcom/amazon/whisperlink/platform/DiscoveryManagerImpl$ListenerState;->REFRESH_STARTED:Lcom/amazon/whisperlink/platform/DiscoveryManagerImpl$ListenerState;

    if-ne v2, v3, :cond_0

    const-string v2, "DiscoveryManagerImpl"

    const-string v3, "Refresh is ongoing, skipping refresh"
    ...
    const-string v3, "This is an ongoing filter, skipping refresh"
...
.method private declared-synchronized createCallbackHandler()V
    ...
    iget-object v1, p0, Lcom/amazon/whisperlink/platform/DiscoveryManagerImpl;->serviceDiscoveryCB:Lcom/amazon/whisperlink/platform/ServiceDiscoveryCB;
    ...
    invoke-static {v0, v2, v1}, Lcom/amazon/whisperlink/util/WhisperLinkUtil;->createDefaultServer(Ljava/lang/String;[Lcom/amazon/whisperlink/services/WPProcessor;I)Lcom/amazon/whisperlink/services/WPServer;
...
.method private getConvertedFilter(Lcom/amazon/whisperplay/discovery/Filter;)Ljava/util/Map;
    ...
    :cond_0
    const-string p1, "getConvertedFilter returning: %s"
...
.method private getServiceEndpointsSnapshot(Ljava/util/List;)Ljava/util/List;
    ...
    iget-object v5, v5, Lcom/amazon/whisperlink/service/Description;->sid:Ljava/lang/String;
...
.method private reverseLookUp(Ljava/util/Map;)Ljava/util/List;
    ...
    :cond_1
    const-string p1, "reverseLookUp returning: %s"
...
.method private declared-synchronized startCallbackHandler()V
    ...
    invoke-virtual {v0}, Lorg/apache/thrift/server/TServer;->isServing()Z
...
.method public addListener(Lcom/amazon/whisperplay/discovery/DiscoveryManager$DiscoveryListener;Lcom/amazon/whisperplay/discovery/Filter;)V
    ...
    iget-object v1, p0, Lcom/amazon/whisperlink/platform/DiscoveryManagerImpl;->whisperPlayImpl:Lcom/amazon/whisperlink/platform/WhisperPlayImpl;

    invoke-virtual {v1}, Lcom/amazon/whisperlink/platform/WhisperPlayImpl;->checkWPReady()V
    ...
    sget-object v3, Lcom/amazon/whisperlink/platform/DiscoveryManagerImpl$ListenerState;->REFRESH_CONTINUOUSLY:Lcom/amazon/whisperlink/platform/DiscoveryManagerImpl$ListenerState;
    ...
    invoke-direct {v3, p2, p1}, Lcom/amazon/whisperlink/platform/DiscoveryManagerImpl$RefreshListener;-><init>(Ljava/util/Map;Lcom/amazon/whisperplay/discovery/DiscoveryManager$DiscoveryListener;)V
    ...
    const-string v3, "added listener %s for %s"
    ...
    invoke-direct {p0, p2, v0}, Lcom/amazon/whisperlink/platform/DiscoveryManagerImpl;->addOrRemoveServiceFilterAsync(Ljava/util/Map;Z)V
...
.method getAuthDaemonInternalConnection()Lcom/amazon/whisperlink/util/Connection;
    ...
    invoke-direct {v0, v1, v2, v3}, Lcom/amazon/whisperlink/util/Connection;-><init>(Lcom/amazon/whisperlink/service/Device;Lcom/amazon/whisperlink/service/Description;Lorg/apache/thrift/TServiceClientFactory;)V
...
.method public refresh(Lcom/amazon/whisperplay/discovery/DiscoveryManager$DiscoveryListener;)V
    ...
    const-string v0, "There is no filter set for listener %s"
...
.method public removeListener(Lcom/amazon/whisperplay/discovery/DiscoveryManager$DiscoveryListener;)V
    ...
    const-string v4, "removed listener %s for %s"
    ...
    invoke-direct {p0, v2}, Lcom/amazon/whisperlink/platform/DiscoveryManagerImpl;->reverseLookUp(Ljava/util/Map;)Ljava/util/List;
    ...
    invoke-direct {p0, v2, v0}, Lcom/amazon/whisperlink/platform/DiscoveryManagerImpl;->addOrRemoveServiceFilterAsync(Ljava/util/Map;Z)V
...
.method protected servicesUpdate(Ljava/util/Map;Ljava/util/List;)V
    ...
    check-cast v2, Lcom/amazon/whisperplay/discovery/DiscoveryManager$DiscoveryListener;
    ...
    const-string v4, "Skipped servicesUpdate for refresh complete listener: %s"
    ...
    invoke-direct {p0, v2, v4}, Lcom/amazon/whisperlink/platform/DiscoveryManagerImpl;->updateListener(Lcom/amazon/whisperplay/discovery/DiscoveryManager$DiscoveryListener;Ljava/util/List;)V
    ...
    :cond_3
    :goto_1
    const-string p2, "servicesUpdated do not find the discovery listener for the corresponding filter: %s"
