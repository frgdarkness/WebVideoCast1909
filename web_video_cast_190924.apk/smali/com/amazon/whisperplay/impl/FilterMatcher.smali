...
.method private getActiveTransportsFromChannels()Ljava/util/List;
    ...
    const-string v1, "getActiveTransportsFromChannels gets channels: %s"
...
.method getChannelsOfMatchingProximity(Lcom/amazon/whisperlink/service/Device;Ljava/lang/String;)Ljava/util/List;
    ...
    :cond_0
    iget-object v2, p0, Lcom/amazon/whisperplay/impl/FilterMatcher;->filter:Ljava/util/Map;
    ...
    const-string v3, "passesFilter, found proximity: %s, pass in explorerId: %s"
    ...
    :cond_1
    invoke-direct {p0, v2}, Lcom/amazon/whisperplay/impl/FilterMatcher;->useSameBuildingProximity(Ljava/lang/String;)Z
    ...
    :cond_6
    const-string p1, "Proximity %s is not supported yet."
...
.method public isActiveSearchOnly()Z
    ...
    const-string v1, "isActiveSearchOnly gets channels: %s"
