...
.method private static final initAdapter()V
    ...
    new-instance v0, Lcom/amazon/whisperplay/fling/media/receiver/impl/ProxyPlayerService;

    sget-object v1, Lcom/amazon/whisperplay/fling/media/receiver/impl/WhisperplayReceiverAdaptor;->mContext:Landroid/content/Context;

    sget-object v2, Lcom/amazon/whisperplay/fling/media/receiver/impl/WhisperplayReceiverAdaptor;->mServiceId:Ljava/lang/String;

    sget-object v3, Lcom/amazon/whisperplay/fling/media/receiver/impl/WhisperplayReceiverAdaptor;->mProxyReceiver:Lcom/amazon/whisperplay/fling/media/service/CustomMediaPlayer;

    invoke-direct {v0, v1, v2, v3}, Lcom/amazon/whisperplay/fling/media/receiver/impl/ProxyPlayerService;-><init>(Landroid/content/Context;Ljava/lang/String;Lcom/amazon/whisperplay/fling/media/service/CustomMediaPlayer;)V
    ...
    instance-of v2, v0, Lcom/amazon/whisperlink/services/DefaultService;

    if-eqz v2, :cond_0

    check-cast v0, Lcom/amazon/whisperlink/services/DefaultService;
    ...
    invoke-virtual {v0, v2}, Lcom/amazon/whisperlink/services/DefaultService;->setExecutor(Lcom/amazon/whisperlink/services/DefaultService$ThreadExecutor;)V

    :cond_0
    const/16 v0, 0x8

    invoke-static {v1, v0}, Lcom/amazon/whisperlink/util/WhisperLinkUtil;->createDefaultServer([Lcom/amazon/whisperlink/services/WPProcessor;I)Lcom/amazon/whisperlink/services/WPServer;
