...
.field private mRemoteUserInfo:Lyf0;
...
.field private mVolumeCallback:LA71$d;

.field mVolumeProvider:LA71;

.field mVolumeType:I


# direct methods
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Landroid/content/ComponentName;Landroid/app/PendingIntent;Lm51;Landroid/os/Bundle;)V
    .locals 3
    ...
    iput-object v2, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeCallback:LA71$d;
    ...
    invoke-direct {p1, p3, p2, p5}, Landroid/support/v4/media/session/MediaSessionCompat$Token;-><init>(Ljava/lang/Object;Landroid/support/v4/media/session/IMediaSession;Lm51;)V
...
.method adjustVolume(II)V
    ...
    iget-object p2, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeProvider:LA71;

    if-eqz p2, :cond_1

    invoke-virtual {p2, p1}, LA71;->e(I)V
...
.method public getCurrentControllerInfo()Lyf0;
    .locals 2
    ...
    :try_start_0
    iget-object v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mRemoteUserInfo:Lyf0;
...
.method public setCurrentControllerInfo(Lyf0;)V
    ...
    :try_start_0
    iput-object p1, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mRemoteUserInfo:Lyf0;
...
.method public setPlaybackToLocal(I)V
    ...
    iget-object v0, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeProvider:LA71;

    if-eqz v0, :cond_0

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, LA71;->g(LA71$d;)V
...
.method public setPlaybackToRemote(LA71;)V
    .locals 7
    ...
    iput-object p1, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeProvider:LA71;
    ...
    iget-object v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeProvider:LA71;

    invoke-virtual {v1}, LA71;->c()I

    move-result v4

    iget-object v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeProvider:LA71;

    invoke-virtual {v1}, LA71;->b()I

    move-result v5

    iget-object v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeProvider:LA71;

    invoke-virtual {v1}, LA71;->a()I
    ...
    iget-object v0, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeCallback:LA71$d;

    invoke-virtual {p1, v0}, LA71;->g(LA71$d;)V
...
.method setVolumeTo(II)V
    ...
    invoke-virtual {p2, p1}, LA71;->f(I)V
