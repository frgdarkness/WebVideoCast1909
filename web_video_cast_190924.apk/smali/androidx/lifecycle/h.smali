...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/lifecycle/h;->b:Ljava/util/Map;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    sput-object v0, Landroidx/lifecycle/h;->c:Ljava/util/Map;
...
.method private final b(Ljava/lang/Class;)Ljava/lang/reflect/Constructor;
    ...
    invoke-static {v2}, Landroidx/lifecycle/h;->c(Ljava/lang/String;)Ljava/lang/String;
...
.method private final d(Ljava/lang/Class;)I
    ...
    sget-object v0, Landroidx/lifecycle/h;->b:Ljava/util/Map;
    ...
    :cond_0
    invoke-direct {p0, p1}, Landroidx/lifecycle/h;->g(Ljava/lang/Class;)I
...
.method public static final f(Ljava/lang/Object;)Landroidx/lifecycle/f;
    ...
    invoke-direct {v0, v1, p0}, Landroidx/lifecycle/DefaultLifecycleObserverAdapter;-><init>(Lay;Landroidx/lifecycle/f;)V
    ...
    invoke-direct {v0, p0, v2}, Landroidx/lifecycle/DefaultLifecycleObserverAdapter;-><init>(Lay;Landroidx/lifecycle/f;)V
    ...
    sget-object v1, Landroidx/lifecycle/h;->a:Landroidx/lifecycle/h;

    invoke-direct {v1, v0}, Landroidx/lifecycle/h;->d(Ljava/lang/Class;)I
    ...
    sget-object v3, Landroidx/lifecycle/h;->c:Ljava/util/Map;
    ...
    invoke-direct {v1, v0, p0}, Landroidx/lifecycle/h;->a(Ljava/lang/reflect/Constructor;Ljava/lang/Object;)Landroidx/lifecycle/b;
    ...
    new-array v3, v1, [Landroidx/lifecycle/b;

    :goto_0
    if-ge v4, v1, :cond_4

    sget-object v5, Landroidx/lifecycle/h;->a:Landroidx/lifecycle/h;
    ...
    invoke-direct {v5, v6, p0}, Landroidx/lifecycle/h;->a(Ljava/lang/reflect/Constructor;Ljava/lang/Object;)Landroidx/lifecycle/b;
    ...
    invoke-direct {p0, v3}, Landroidx/lifecycle/CompositeGeneratedAdaptersObserver;-><init>([Landroidx/lifecycle/b;)V
...
.method private final g(Ljava/lang/Class;)I
    ...
    :cond_0
    invoke-direct {p0, p1}, Landroidx/lifecycle/h;->b(Ljava/lang/Class;)Ljava/lang/reflect/Constructor;
    ...
    sget-object v1, Landroidx/lifecycle/h;->c:Ljava/util/Map;
    ...
    invoke-direct {p0, v0}, Landroidx/lifecycle/h;->e(Ljava/lang/Class;)Z
    ...
    invoke-direct {p0, v0}, Landroidx/lifecycle/h;->d(Ljava/lang/Class;)I
    ...
    sget-object v4, Landroidx/lifecycle/h;->c:Ljava/util/Map;
    ...
    invoke-direct {p0, v6}, Landroidx/lifecycle/h;->e(Ljava/lang/Class;)Z
    ...
    invoke-direct {p0, v6}, Landroidx/lifecycle/h;->d(Ljava/lang/Class;)I
    ...
    :cond_7
    sget-object v7, Landroidx/lifecycle/h;->c:Ljava/util/Map;
    ...
    sget-object v0, Landroidx/lifecycle/h;->c:Ljava/util/Map;
