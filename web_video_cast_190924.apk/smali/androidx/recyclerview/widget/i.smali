...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/recyclerview/widget/i;->f:Ljava/lang/ThreadLocal;

    new-instance v0, Landroidx/recyclerview/widget/i$a;

    invoke-direct {v0}, Landroidx/recyclerview/widget/i$a;-><init>()V

    sput-object v0, Landroidx/recyclerview/widget/i;->g:Ljava/util/Comparator;
...
.method constructor <init>()V
    ...
    iput-object v0, p0, Landroidx/recyclerview/widget/i;->a:Ljava/util/ArrayList;
...
.method private b()V
    ...
    iget-object v4, p0, Landroidx/recyclerview/widget/i;->a:Ljava/util/ArrayList;
    ...
    iget-object v5, v4, Landroidx/recyclerview/widget/RecyclerView;->mPrefetchRegistry:Landroidx/recyclerview/widget/i$b;
    ...
    iget-object v8, p0, Landroidx/recyclerview/widget/i;->d:Ljava/util/ArrayList;
    ...
    iget-object v9, p0, Landroidx/recyclerview/widget/i;->d:Ljava/util/ArrayList;
    ...
    sget-object v1, Landroidx/recyclerview/widget/i;->g:Ljava/util/Comparator;
...
.method private c(Landroidx/recyclerview/widget/i$c;J)V
    ...
    invoke-direct {p0, v2, p1, v0, v1}, Landroidx/recyclerview/widget/i;->i(Landroidx/recyclerview/widget/RecyclerView;IJ)Landroidx/recyclerview/widget/RecyclerView$E;
...
.method private d(J)V
    ...
    :goto_0
    iget-object v1, p0, Landroidx/recyclerview/widget/i;->d:Ljava/util/ArrayList;
...
.method private h(Landroidx/recyclerview/widget/RecyclerView;J)V
    ...
    :cond_1
    iget-object v0, p1, Landroidx/recyclerview/widget/RecyclerView;->mPrefetchRegistry:Landroidx/recyclerview/widget/i$b;
    ...
    invoke-direct {p0, p1, v2, p2, p3}, Landroidx/recyclerview/widget/i;->i(Landroidx/recyclerview/widget/RecyclerView;IJ)Landroidx/recyclerview/widget/RecyclerView$E;
    :try_end_0
...
.method private i(Landroidx/recyclerview/widget/RecyclerView;IJ)Landroidx/recyclerview/widget/RecyclerView$E;
    ...
    invoke-virtual {v0, p2, v1, p3, p4}, Landroidx/recyclerview/widget/RecyclerView$w;->N(IZJ)Landroidx/recyclerview/widget/RecyclerView$E;
...
.method f(Landroidx/recyclerview/widget/RecyclerView;II)V
    ...
    :cond_0
    iget-object p1, p1, Landroidx/recyclerview/widget/RecyclerView;->mPrefetchRegistry:Landroidx/recyclerview/widget/i$b;
...
.method public run()V
    ...
    iget-object v2, p0, Landroidx/recyclerview/widget/i;->a:Ljava/util/ArrayList;
    ...
    iget-object v6, p0, Landroidx/recyclerview/widget/i;->a:Ljava/util/ArrayList;
