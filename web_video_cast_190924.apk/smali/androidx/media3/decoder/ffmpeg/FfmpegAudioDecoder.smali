...
# direct methods
.method public constructor <init>(Landroidx/media3/common/a;IIIZ)V
    .locals 6
    ...
    invoke-direct {p0, p2, p3}, LmL0;-><init>([LLu;[Landroidx/media3/decoder/a;)V
    ...
    iget-object p2, p1, Landroidx/media3/common/a;->m:Ljava/lang/String;

    invoke-static {p2}, LO8;->e(Ljava/lang/Object;)Ljava/lang/Object;

    iget-object p2, p1, Landroidx/media3/common/a;->m:Ljava/lang/String;

    invoke-static {p2}, Landroidx/media3/decoder/ffmpeg/FfmpegLibrary;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    iput-object v1, p0, Landroidx/media3/decoder/ffmpeg/FfmpegAudioDecoder;->o:Ljava/lang/String;

    iget-object p2, p1, Landroidx/media3/common/a;->m:Ljava/lang/String;

    iget-object p3, p1, Landroidx/media3/common/a;->o:Ljava/util/List;

    invoke-static {p2, p3}, Landroidx/media3/decoder/ffmpeg/FfmpegAudioDecoder;->A(Ljava/lang/String;Ljava/util/List;)[B

    move-result-object v2

    iput-object v2, p0, Landroidx/media3/decoder/ffmpeg/FfmpegAudioDecoder;->p:[B
    ...
    :goto_0
    iput p2, p0, Landroidx/media3/decoder/ffmpeg/FfmpegAudioDecoder;->q:I
    ...
    iget v5, p1, Landroidx/media3/common/a;->z:I
    ...
    iput-wide p1, p0, Landroidx/media3/decoder/ffmpeg/FfmpegAudioDecoder;->s:J
    ...
    invoke-virtual {p0, p4}, LmL0;->s(I)V
    ...
    invoke-direct {p1, p2}, Landroidx/media3/decoder/ffmpeg/c;-><init>(Ljava/lang/String;)V
...
.method private static A(Ljava/lang/String;Ljava/util/List;)[B
    ...
    :pswitch_0
    invoke-static {p1}, Landroidx/media3/decoder/ffmpeg/FfmpegAudioDecoder;->x(Ljava/util/List;)[B
    ...
    :pswitch_2
    invoke-static {p1}, Landroidx/media3/decoder/ffmpeg/FfmpegAudioDecoder;->C(Ljava/util/List;)[B
...
.method private static synthetic D(Landroidx/media3/decoder/ffmpeg/FfmpegAudioDecoder;Landroidx/media3/decoder/a;)V
    .locals 0
...
.method private growOutputBuffer(Landroidx/media3/decoder/SimpleDecoderOutputBuffer;I)Ljava/nio/ByteBuffer;
    ...
    invoke-virtual {p1, p2}, Landroidx/media3/decoder/SimpleDecoderOutputBuffer;->n(I)Ljava/nio/ByteBuffer;
...
.method public static synthetic t(Landroidx/media3/decoder/ffmpeg/FfmpegAudioDecoder;Landroidx/media3/decoder/a;)V
    .locals 0

    invoke-static {p0, p1}, Landroidx/media3/decoder/ffmpeg/FfmpegAudioDecoder;->D(Landroidx/media3/decoder/ffmpeg/FfmpegAudioDecoder;Landroidx/media3/decoder/a;)V
...
.method protected bridge synthetic f()Landroidx/media3/decoder/a;
    ...
    invoke-virtual {p0}, Landroidx/media3/decoder/ffmpeg/FfmpegAudioDecoder;->u()Landroidx/media3/decoder/SimpleDecoderOutputBuffer;
...
.method protected bridge synthetic g(Ljava/lang/Throwable;)LKu;
    ...
    invoke-virtual {p0, p1}, Landroidx/media3/decoder/ffmpeg/FfmpegAudioDecoder;->v(Ljava/lang/Throwable;)Landroidx/media3/decoder/ffmpeg/c;
...
.method protected bridge synthetic h(LLu;Landroidx/media3/decoder/a;Z)LKu;
    ...
    invoke-virtual {p0, p1, p2, p3}, Landroidx/media3/decoder/ffmpeg/FfmpegAudioDecoder;->w(LLu;Landroidx/media3/decoder/SimpleDecoderOutputBuffer;Z)Landroidx/media3/decoder/ffmpeg/c;
...
.method public release()V
    ...
    invoke-super {p0}, LmL0;->release()V
...
.method protected u()Landroidx/media3/decoder/SimpleDecoderOutputBuffer;
    ...
    invoke-direct {v0, v1}, Landroidx/media3/decoder/SimpleDecoderOutputBuffer;-><init>(Landroidx/media3/decoder/a$a;)V

    return-object v0
.end method

.method protected v(Ljava/lang/Throwable;)Landroidx/media3/decoder/ffmpeg/c;
    .locals 2
    ...
    invoke-direct {v0, v1, p1}, Landroidx/media3/decoder/ffmpeg/c;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V

    return-object v0
.end method

.method protected w(LLu;Landroidx/media3/decoder/SimpleDecoderOutputBuffer;Z)Landroidx/media3/decoder/ffmpeg/c;
    .locals 8
    ...
    iget-object p3, p0, Landroidx/media3/decoder/ffmpeg/FfmpegAudioDecoder;->p:[B
    ...
    iget p1, p0, Landroidx/media3/decoder/ffmpeg/FfmpegAudioDecoder;->r:I

    invoke-virtual {p2, v0, v1, p1}, Landroidx/media3/decoder/SimpleDecoderOutputBuffer;->o(JI)Ljava/nio/ByteBuffer;
    ...
    iput-boolean v1, p2, Landroidx/media3/decoder/a;->d:Z
    ...
    :cond_3
    iget-boolean p3, p0, Landroidx/media3/decoder/ffmpeg/FfmpegAudioDecoder;->t:Z

    if-nez p3, :cond_5

    iget-wide v2, p0, Landroidx/media3/decoder/ffmpeg/FfmpegAudioDecoder;->s:J

    invoke-direct {p0, v2, v3}, Landroidx/media3/decoder/ffmpeg/FfmpegAudioDecoder;->ffmpegGetChannelCount(J)I

    move-result p3

    iput p3, p0, Landroidx/media3/decoder/ffmpeg/FfmpegAudioDecoder;->u:I
    ...
    iput p3, p0, Landroidx/media3/decoder/ffmpeg/FfmpegAudioDecoder;->v:I

    iget p3, p0, Landroidx/media3/decoder/ffmpeg/FfmpegAudioDecoder;->v:I

    if-nez p3, :cond_4

    const-string p3, "alac"

    iget-object v2, p0, Landroidx/media3/decoder/ffmpeg/FfmpegAudioDecoder;->o:Ljava/lang/String;
    ...
    iget-object v2, p0, Landroidx/media3/decoder/ffmpeg/FfmpegAudioDecoder;->p:[B

    invoke-direct {p3, v2}, Lys0;-><init>([B)V
    ...
    invoke-virtual {p3, v2}, Lys0;->U(I)V
    ...
    :cond_4
    iput-boolean v1, p0, Landroidx/media3/decoder/ffmpeg/FfmpegAudioDecoder;->t:Z

    :cond_5
    iget-object p2, p2, Landroidx/media3/decoder/SimpleDecoderOutputBuffer;->g:Ljava/nio/ByteBuffer;
