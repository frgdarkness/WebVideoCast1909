...
.field private final b:Lod1;

.field private final c:Lpx0;
...
.method public constructor <init>(Landroid/content/Context;Lod1;)V
    .locals 0
    ...
    iput-object p2, p0, Landroidx/work/impl/utils/ForceStopRunnable;->b:Lod1;

    invoke-virtual {p2}, Lod1;->q()Lpx0;

    move-result-object p1

    iput-object p1, p0, Landroidx/work/impl/utils/ForceStopRunnable;->c:Lpx0;
...
.method public a()Z
    ...
    iget-object v1, p0, Landroidx/work/impl/utils/ForceStopRunnable;->b:Lod1;

    invoke-virtual {v1}, Lod1;->u()Landroidx/work/impl/WorkDatabase;

    move-result-object v1

    invoke-static {v0, v1}, LtU0;->i(Landroid/content/Context;Landroidx/work/impl/WorkDatabase;)Z
    ...
    :try_start_0
    invoke-interface {v3}, LCd1;->u()Ljava/util/List;
    ...
    sget-object v9, Lgd1$c;->a:Lgd1$c;

    iget-object v10, v8, LBd1;->a:Ljava/lang/String;

    invoke-interface {v3, v9, v10}, LCd1;->e(Lgd1$c;Ljava/lang/String;)I

    iget-object v9, v8, LBd1;->a:Ljava/lang/String;

    const/16 v10, -0x200

    invoke-interface {v3, v9, v10}, LCd1;->d(Ljava/lang/String;I)V

    iget-object v8, v8, LBd1;->a:Ljava/lang/String;

    const-wide/16 v9, -0x1

    invoke-interface {v3, v8, v9, v10}, LCd1;->p(Ljava/lang/String;J)I

    goto :goto_2

    :cond_2
    invoke-interface {v4}, Lvd1;->c()V
...
.method public b()V
    ...
    iget-object v0, p0, Landroidx/work/impl/utils/ForceStopRunnable;->b:Lod1;

    invoke-virtual {v0}, Lod1;->x()V

    iget-object v0, p0, Landroidx/work/impl/utils/ForceStopRunnable;->b:Lod1;

    invoke-virtual {v0}, Lod1;->q()Lpx0;

    move-result-object v0

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, Lpx0;->e(Z)V
    ...
    iget-object v0, p0, Landroidx/work/impl/utils/ForceStopRunnable;->c:Lpx0;

    iget-object v1, p0, Landroidx/work/impl/utils/ForceStopRunnable;->b:Lod1;

    invoke-virtual {v1}, Lod1;->n()Landroidx/work/a;
    ...
    invoke-virtual {v0, v1, v2}, Lpx0;->d(J)V
    ...
    iget-object v2, p0, Landroidx/work/impl/utils/ForceStopRunnable;->b:Lod1;

    invoke-virtual {v2}, Lod1;->s()Ljava/util/List;
...
.method public e()Z
    ...
    invoke-static {v1, v2, v4, v4}, LxL;->a(Landroid/app/ActivityManager;Ljava/lang/String;II)Ljava/util/List;
    ...
    iget-object v2, p0, Landroidx/work/impl/utils/ForceStopRunnable;->c:Lpx0;

    invoke-virtual {v2}, Lpx0;->a()J
    ...
    invoke-static {v6}, LyL;->a(Ljava/lang/Object;)Landroid/app/ApplicationExitInfo;

    move-result-object v6

    invoke-static {v6}, LzL;->a(Landroid/app/ApplicationExitInfo;)I
    ...
    invoke-static {v6}, LAL;->a(Landroid/app/ApplicationExitInfo;)J
    ...
    invoke-virtual {v2, v3, v4, v1}, LU40;->l(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public f()Z
    ...
    invoke-static {v1, v0}, Lxy0;->b(Landroid/content/Context;Landroidx/work/a;)Z
...
.method public run()V
    ...
    invoke-static {v0}, Lad1;->d(Landroid/content/Context;)V
    :try_end_1
    ...
    invoke-static {v1}, LT31;->a(Landroid/content/Context;)Z
    ...
    invoke-virtual {v2, v3, v1, v0}, LU40;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v0}, Landroidx/work/a;->e()Lup;
    ...
    invoke-virtual {v1, v3, v4, v2}, LU40;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    invoke-interface {v0, v2}, Lup;->accept(Ljava/lang/Object;)V
    ...
    invoke-virtual {v5, v6, v1, v0}, LU40;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v2, v3, v1}, LU40;->c(Ljava/lang/String;Ljava/lang/String;)V
