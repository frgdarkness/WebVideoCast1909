...
# static fields
.field static final a0:Landroidx/appcompat/widget/SearchView$o;
...
.field M:Landroid/app/SearchableInfo;
...
.field private w:Landroidx/appcompat/widget/SearchView$m;

.field x:Landroid/view/View$OnFocusChangeListener;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, v7, Landroidx/appcompat/widget/SearchView;->O:Ljava/lang/Runnable;
    ...
    iput-object v0, v7, Landroidx/appcompat/widget/SearchView;->Q:Ljava/util/WeakHashMap;
    ...
    iput-object v8, v7, Landroidx/appcompat/widget/SearchView;->R:Landroid/view/View$OnClickListener;
    ...
    iput-object v0, v7, Landroidx/appcompat/widget/SearchView;->S:Landroid/view/View$OnKeyListener;
    ...
    iput-object v9, v7, Landroidx/appcompat/widget/SearchView;->T:Landroid/widget/TextView$OnEditorActionListener;
    ...
    iput-object v10, v7, Landroidx/appcompat/widget/SearchView;->U:Landroid/widget/AdapterView$OnItemClickListener;
    ...
    iput-object v11, v7, Landroidx/appcompat/widget/SearchView;->V:Landroid/widget/AdapterView$OnItemSelectedListener;
    ...
    sget-object v2, Landroidx/appcompat/R$styleable;->p2:[I
    ...
    invoke-static {v13, v3, v2, v5, v12}, Landroidx/appcompat/widget/C;->v(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroidx/appcompat/widget/C;

    move-result-object v14

    invoke-virtual {v14}, Landroidx/appcompat/widget/C;->r()Landroid/content/res/TypedArray;
    ...
    sget v1, Landroidx/appcompat/R$styleable;->z2:I

    sget v2, Landroidx/appcompat/R$layout;->t:I

    invoke-virtual {v14, v1, v2}, Landroidx/appcompat/widget/C;->n(II)I
    ...
    sget v1, Landroidx/appcompat/R$id;->F:I
    ...
    sget v3, Landroidx/appcompat/R$id;->P:I
    ...
    sget v4, Landroidx/appcompat/R$id;->D:I
    ...
    sget v5, Landroidx/appcompat/R$id;->G:I
    ...
    sget v6, Landroidx/appcompat/R$id;->E:I
    ...
    sget v13, Landroidx/appcompat/R$id;->K:I
    ...
    sget v2, Landroidx/appcompat/R$styleable;->A2:I

    invoke-virtual {v14, v2}, Landroidx/appcompat/widget/C;->g(I)Landroid/graphics/drawable/Drawable;
    ...
    sget v1, Landroidx/appcompat/R$styleable;->E2:I

    invoke-virtual {v14, v1}, Landroidx/appcompat/widget/C;->g(I)Landroid/graphics/drawable/Drawable;
    ...
    sget v1, Landroidx/appcompat/R$styleable;->D2:I
    ...
    sget v2, Landroidx/appcompat/R$styleable;->x2:I
    ...
    sget v2, Landroidx/appcompat/R$styleable;->u2:I
    ...
    sget v2, Landroidx/appcompat/R$styleable;->G2:I
    ...
    sget v1, Landroidx/appcompat/R$styleable;->C2:I
    ...
    sget v2, Landroidx/appcompat/R$string;->o:I

    invoke-virtual {v1, v2}, Landroid/content/res/Resources;->getString(I)Ljava/lang/String;

    move-result-object v1

    invoke-static {v4, v1}, LPX0;->a(Landroid/view/View;Ljava/lang/CharSequence;)V

    sget v1, Landroidx/appcompat/R$styleable;->F2:I

    sget v2, Landroidx/appcompat/R$layout;->s:I
    ...
    sget v1, Landroidx/appcompat/R$styleable;->v2:I

    invoke-virtual {v14, v1, v12}, Landroidx/appcompat/widget/C;->n(II)I
    ...
    iget-object v1, v7, Landroidx/appcompat/widget/SearchView;->S:Landroid/view/View$OnKeyListener;
    ...
    sget v1, Landroidx/appcompat/R$styleable;->y2:I

    const/4 v2, 0x1

    invoke-virtual {v14, v1, v2}, Landroidx/appcompat/widget/C;->a(IZ)Z
    ...
    invoke-virtual {v14, v1, v2}, Landroidx/appcompat/widget/C;->f(II)I
    ...
    invoke-virtual {v14, v1}, Landroidx/appcompat/widget/C;->p(I)Ljava/lang/CharSequence;

    move-result-object v1

    iput-object v1, v7, Landroidx/appcompat/widget/SearchView;->v:Ljava/lang/CharSequence;

    sget v1, Landroidx/appcompat/R$styleable;->B2:I

    invoke-virtual {v14, v1}, Landroidx/appcompat/widget/C;->p(I)Ljava/lang/CharSequence;

    move-result-object v1

    iput-object v1, v7, Landroidx/appcompat/widget/SearchView;->D:Ljava/lang/CharSequence;

    sget v1, Landroidx/appcompat/R$styleable;->t2:I

    invoke-virtual {v14, v1, v2}, Landroidx/appcompat/widget/C;->k(II)I
    ...
    :cond_1
    sget v1, Landroidx/appcompat/R$styleable;->s2:I
    ...
    :cond_2
    sget v1, Landroidx/appcompat/R$styleable;->q2:I
    ...
    invoke-virtual {v14}, Landroidx/appcompat/widget/C;->w()V
    ...
    :cond_3
    iget-boolean v0, v7, Landroidx/appcompat/widget/SearchView;->z:Z

    invoke-direct {v7, v0}, Landroidx/appcompat/widget/SearchView;->O(Z)V

    invoke-direct/range {p0 .. p0}, Landroidx/appcompat/widget/SearchView;->K()V
...
.method private G()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/SearchView;->O:Ljava/lang/Runnable;
...
.method private H(I)V
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/SearchView;->B:Lxr;

    invoke-virtual {v1}, Lxr;->d()Landroid/database/Cursor;
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/SearchView;->B:Lxr;

    invoke-virtual {p1, v1}, Lxr;->b(Landroid/database/Cursor;)Ljava/lang/CharSequence;
...
.method private K()V
    ...
    :cond_0
    invoke-direct {p0, v0}, Landroidx/appcompat/widget/SearchView;->o(Ljava/lang/CharSequence;)Ljava/lang/CharSequence;
...
.method private L()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/SearchView;->B:Lxr;

    if-eqz v0, :cond_1

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, Lxr;->a(Landroid/database/Cursor;)V
    ...
    iget-object v4, p0, Landroidx/appcompat/widget/SearchView;->Q:Ljava/util/WeakHashMap;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/SearchView;->B:Lxr;
    ...
    iget-boolean v1, p0, Landroidx/appcompat/widget/SearchView;->E:Z
    ...
    :cond_2
    invoke-virtual {v0, v2}, Landroidx/appcompat/widget/x;->x(I)V
...
.method private M()V
    ...
    invoke-direct {p0}, Landroidx/appcompat/widget/SearchView;->s()Z
...
.method private O(Z)V
    ...
    invoke-direct {p0, v4}, Landroidx/appcompat/widget/SearchView;->N(Z)V
    ...
    invoke-direct {p0, v3}, Landroidx/appcompat/widget/SearchView;->P(Z)V
...
.method private getPreferredHeight()I
    ...
    sget v1, Landroidx/appcompat/R$dimen;->g:I
...
.method private getPreferredWidth()I
    ...
    sget v1, Landroidx/appcompat/R$dimen;->h:I
...
.method private i(Landroid/database/Cursor;ILjava/lang/String;)Landroid/content/Intent;
    .locals 8
    ...
    invoke-static {p1, v1}, Landroidx/appcompat/widget/x;->o(Landroid/database/Cursor;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1, v3}, Landroidx/appcompat/widget/x;->o(Landroid/database/Cursor;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct/range {v1 .. v7}, Landroidx/appcompat/widget/SearchView;->h(Ljava/lang/String;Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;)Landroid/content/Intent;
...
.method private k(Landroid/content/Intent;Landroid/app/SearchableInfo;)Landroid/content/Intent;
    .locals 1
...
.method private n(Landroid/view/View;Landroid/graphics/Rect;)V
    .locals 4
...
.method private v(IILjava/lang/String;)Z
    ...
    invoke-virtual {v0}, Lxr;->d()Landroid/database/Cursor;
    ...
    invoke-direct {p0, v0, p2, p3}, Landroidx/appcompat/widget/SearchView;->i(Landroid/database/Cursor;ILjava/lang/String;)Landroid/content/Intent;
...
.method A()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/SearchView;->y:Landroid/view/View$OnClickListener;
...
.method B()V
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/SearchView;->w:Landroidx/appcompat/widget/SearchView$m;
...
.method C(Landroid/view/View;ILandroid/view/KeyEvent;)Z
    .locals 1
...
.method D(Ljava/lang/CharSequence;)V
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/SearchView;->J:Ljava/lang/CharSequence;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/SearchView;->w:Landroidx/appcompat/widget/SearchView$m;
...
.method F()V
    ...
    invoke-direct {p0, v1, v0}, Landroidx/appcompat/widget/SearchView;->k(Landroid/content/Intent;Landroid/app/SearchableInfo;)Landroid/content/Intent;
...
.method public c()V
    ...
    iget v2, p0, Landroidx/appcompat/widget/SearchView;->L:I
...
.method g()V
    ...
    invoke-static {p0}, Landroidx/appcompat/widget/F;->b(Landroid/view/View;)Z

    move-result v3

    iget-boolean v4, p0, Landroidx/appcompat/widget/SearchView;->z:Z
...
.method public getSuggestionsAdapter()Lxr;
    .locals 1
...
.method protected onLayout(ZIIII)V
    ...
    invoke-direct {p0, p1, p2}, Landroidx/appcompat/widget/SearchView;->n(Landroid/view/View;Landroid/graphics/Rect;)V
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    invoke-direct {p0, p1}, Landroidx/appcompat/widget/SearchView;->O(Z)V
...
.method public requestFocus(ILandroid/graphics/Rect;)Z
    ...
    invoke-direct {p0, v1}, Landroidx/appcompat/widget/SearchView;->O(Z)V
...
.method public setOnQueryTextListener(Landroidx/appcompat/widget/SearchView$m;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/SearchView;->w:Landroidx/appcompat/widget/SearchView$m;
...
.method public setQueryRefinementEnabled(Z)V
    ...
    :goto_0
    invoke-virtual {v0, p1}, Landroidx/appcompat/widget/x;->x(I)V
...
.method public setSuggestionsAdapter(Lxr;)V
    .locals 1

    iput-object p1, p0, Landroidx/appcompat/widget/SearchView;->B:Lxr;
...
.method u(ILjava/lang/String;Ljava/lang/String;)V
    .locals 7
    ...
    invoke-direct/range {v0 .. v6}, Landroidx/appcompat/widget/SearchView;->h(Ljava/lang/String;Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;)Landroid/content/Intent;
...
.method x(IILjava/lang/String;)Z
    .locals 0
