...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/appcompat/widget/q;->n:Lj$/util/concurrent/ConcurrentHashMap;
...
.method constructor <init>(Landroid/widget/TextView;)V
    ...
    :cond_1
    new-instance p1, Landroidx/appcompat/widget/q$f;

    invoke-direct {p1}, Landroidx/appcompat/widget/q$f;-><init>()V
...
.method private static k(Ljava/lang/String;)Ljava/lang/reflect/Method;
    ...
    sget-object v2, Landroidx/appcompat/widget/q;->m:Lj$/util/concurrent/ConcurrentHashMap;
...
.method d(Ljava/lang/CharSequence;Landroid/text/Layout$Alignment;II)Landroid/text/StaticLayout;
    ...
    iget-object v6, p0, Landroidx/appcompat/widget/q;->i:Landroid/widget/TextView;

    iget-object v7, p0, Landroidx/appcompat/widget/q;->h:Landroid/text/TextPaint;

    iget-object v8, p0, Landroidx/appcompat/widget/q;->k:Landroidx/appcompat/widget/q$f;
    ...
    invoke-static/range {v2 .. v8}, Landroidx/appcompat/widget/q$c;->a(Ljava/lang/CharSequence;Landroid/text/Layout$Alignment;IILandroid/widget/TextView;Landroid/text/TextPaint;Landroidx/appcompat/widget/q$f;)Landroid/text/StaticLayout;
    ...
    :cond_0
    iget-object p4, p0, Landroidx/appcompat/widget/q;->i:Landroid/widget/TextView;

    iget-object v0, p0, Landroidx/appcompat/widget/q;->h:Landroid/text/TextPaint;

    invoke-static {p1, p2, p3, p4, v0}, Landroidx/appcompat/widget/q$a;->a(Ljava/lang/CharSequence;Landroid/text/Layout$Alignment;ILandroid/widget/TextView;Landroid/text/TextPaint;)Landroid/text/StaticLayout;
...
.method o(Landroid/util/AttributeSet;I)V
    ...
    sget-object v3, Landroidx/appcompat/R$styleable;->i0:[I
    ...
    sget p1, Landroidx/appcompat/R$styleable;->n0:I
    ...
    :cond_0
    sget p1, Landroidx/appcompat/R$styleable;->m0:I
    ...
    :goto_0
    sget p2, Landroidx/appcompat/R$styleable;->k0:I
    ...
    :goto_2
    sget v3, Landroidx/appcompat/R$styleable;->l0:I
    ...
    invoke-direct {p0, v3}, Landroidx/appcompat/widget/q;->v(Landroid/content/res/TypedArray;)V
    ...
    :cond_7
    invoke-direct {p0, p2, v2, p1}, Landroidx/appcompat/widget/q;->z(FFF)V
