...
.field private g:Landroidx/appcompat/widget/AppCompatSpinner$i;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;IILandroid/content/res/Resources$Theme;)V
    ...
    sget-object v0, Landroidx/appcompat/R$styleable;->H2:[I

    const/4 v1, 0x0

    invoke-static {p1, p2, v0, p3, v1}, Landroidx/appcompat/widget/C;->v(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroidx/appcompat/widget/C;
    ...
    invoke-direct {v2, p1, p5}, Lbq;-><init>(Landroid/content/Context;Landroid/content/res/Resources$Theme;)V
    ...
    :cond_0
    sget p5, Landroidx/appcompat/R$styleable;->M2:I

    invoke-virtual {v0, p5, v1}, Landroidx/appcompat/widget/C;->n(II)I
    ...
    invoke-direct {v2, p1, p5}, Lbq;-><init>(Landroid/content/Context;I)V
    ...
    sget-object v4, Landroidx/appcompat/R$styleable;->H2:[I

    invoke-static {v3, p2, v4, p3, v1}, Landroidx/appcompat/widget/C;->v(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroidx/appcompat/widget/C;

    move-result-object v1

    sget v3, Landroidx/appcompat/R$styleable;->L2:I

    const/4 v4, -0x2

    invoke-virtual {v1, v3, v4}, Landroidx/appcompat/widget/C;->m(II)I

    move-result v3

    iput v3, p0, Landroidx/appcompat/widget/AppCompatSpinner;->h:I

    sget v3, Landroidx/appcompat/R$styleable;->J2:I

    invoke-virtual {v1, v3}, Landroidx/appcompat/widget/C;->g(I)Landroid/graphics/drawable/Drawable;
    ...
    sget v3, Landroidx/appcompat/R$styleable;->K2:I

    invoke-virtual {v0, v3}, Landroidx/appcompat/widget/C;->o(I)Ljava/lang/String;

    move-result-object v3

    invoke-virtual {p4, v3}, Landroidx/appcompat/widget/AppCompatSpinner$h;->g(Ljava/lang/CharSequence;)V

    invoke-virtual {v1}, Landroidx/appcompat/widget/C;->w()V

    iput-object p4, p0, Landroidx/appcompat/widget/AppCompatSpinner;->g:Landroidx/appcompat/widget/AppCompatSpinner$i;
    ...
    sget v1, Landroidx/appcompat/R$styleable;->K2:I

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/C;->o(I)Ljava/lang/String;

    move-result-object v1

    invoke-interface {p4, v1}, Landroidx/appcompat/widget/AppCompatSpinner$i;->g(Ljava/lang/CharSequence;)V

    :goto_5
    sget p4, Landroidx/appcompat/R$styleable;->I2:I

    invoke-virtual {v0, p4}, Landroidx/appcompat/widget/C;->q(I)[Ljava/lang/CharSequence;
...
.method b()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/AppCompatSpinner;->g:Landroidx/appcompat/widget/AppCompatSpinner$i;
    ...
    invoke-interface {v0, v1, v2}, Landroidx/appcompat/widget/AppCompatSpinner$i;->j(II)V
...
.method public getDropDownVerticalOffset()I
    ...
    invoke-interface {v0}, Landroidx/appcompat/widget/AppCompatSpinner$i;->k()I
...
.method public getPopupBackground()Landroid/graphics/drawable/Drawable;
    ...
    invoke-interface {v0}, Landroidx/appcompat/widget/AppCompatSpinner$i;->f()Landroid/graphics/drawable/Drawable;
...
.method public getPrompt()Ljava/lang/CharSequence;
    ...
    invoke-interface {v0}, Landroidx/appcompat/widget/AppCompatSpinner$i;->e()Ljava/lang/CharSequence;
...
.method protected onMeasure(II)V
    ...
    iget-object p2, p0, Landroidx/appcompat/widget/AppCompatSpinner;->g:Landroidx/appcompat/widget/AppCompatSpinner$i;
...
.method public onSaveInstanceState()Landroid/os/Parcelable;
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/AppCompatSpinner;->g:Landroidx/appcompat/widget/AppCompatSpinner$i;
...
.method public setAdapter(Landroid/widget/SpinnerAdapter;)V
    ...
    invoke-interface {v1, v2}, Landroidx/appcompat/widget/AppCompatSpinner$i;->l(Landroid/widget/ListAdapter;)V
...
.method public setDropDownHorizontalOffset(I)V
    ...
    invoke-interface {v0, p1}, Landroidx/appcompat/widget/AppCompatSpinner$i;->i(I)V

    iget-object v0, p0, Landroidx/appcompat/widget/AppCompatSpinner;->g:Landroidx/appcompat/widget/AppCompatSpinner$i;

    invoke-interface {v0, p1}, Landroidx/appcompat/widget/AppCompatSpinner$i;->d(I)V
...
.method public setDropDownVerticalOffset(I)V
    ...
    invoke-interface {v0, p1}, Landroidx/appcompat/widget/AppCompatSpinner$i;->h(I)V
...
.method public setPrompt(Ljava/lang/CharSequence;)V
    ...
    invoke-interface {v0, p1}, Landroidx/appcompat/widget/AppCompatSpinner$i;->g(Ljava/lang/CharSequence;)V
