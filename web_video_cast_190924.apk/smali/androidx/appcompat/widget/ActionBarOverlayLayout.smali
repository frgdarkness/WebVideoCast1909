...
.field private v:Landroidx/core/view/f;

.field private w:Landroidx/core/view/f;

.field private x:Landroidx/core/view/f;

.field private y:Landroidx/core/view/f;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget-object p2, Landroidx/core/view/f;->b:Landroidx/core/view/f;

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->v:Landroidx/core/view/f;

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->w:Landroidx/core/view/f;

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->x:Landroidx/core/view/f;

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->y:Landroidx/core/view/f;
    ...
    invoke-direct {p1, p0}, LEl0;-><init>(Landroid/view/ViewGroup;)V

    iput-object p1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->F:LEl0;
...
.method private l(Landroid/view/View;)LPu;
    .locals 3
...
.method public a()Z
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->f:LPu;

    invoke-interface {v0}, LPu;->a()Z
...
.method public f(I)V
    ...
    :cond_1
    iget-object p1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->f:LPu;

    invoke-interface {p1}, LPu;->w()V
...
.method public getNestedScrollAxes()I
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->F:LEl0;
...
.method public getTitle()Ljava/lang/CharSequence;
    ...
    invoke-interface {v0}, LPu;->getTitle()Ljava/lang/CharSequence;
...
.method public onApplyWindowInsets(Landroid/view/WindowInsets;)Landroid/view/WindowInsets;
    ...
    invoke-static {p1, p0}, Landroidx/core/view/f;->x(Landroid/view/WindowInsets;Landroid/view/View;)Landroidx/core/view/f;
    ...
    invoke-static {p0, p1, v1}, Landroidx/core/view/ViewCompat;->computeSystemWindowInsets(Landroid/view/View;Landroidx/core/view/f;Landroid/graphics/Rect;)Landroidx/core/view/f;
    ...
    invoke-virtual {p1, v2, v3, v4, v1}, Landroidx/core/view/f;->n(IIII)Landroidx/core/view/f;

    move-result-object v1

    iput-object v1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->v:Landroidx/core/view/f;

    iget-object v2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->w:Landroidx/core/view/f;

    invoke-virtual {v2, v1}, Landroidx/core/view/f;->equals(Ljava/lang/Object;)Z
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->v:Landroidx/core/view/f;

    iput-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->w:Landroidx/core/view/f;
    ...
    :cond_2
    invoke-virtual {p1}, Landroidx/core/view/f;->a()Landroidx/core/view/f;

    move-result-object p1

    invoke-virtual {p1}, Landroidx/core/view/f;->c()Landroidx/core/view/f;

    move-result-object p1

    invoke-virtual {p1}, Landroidx/core/view/f;->b()Landroidx/core/view/f;
...
.method protected onMeasure(II)V
    ...
    iget-object v6, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->v:Landroidx/core/view/f;

    iput-object v6, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->x:Landroidx/core/view/f;
    ...
    invoke-virtual {v6, v2, v5, v2, v2}, Landroidx/core/view/f;->n(IIII)Landroidx/core/view/f;

    move-result-object v2

    iput-object v2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->x:Landroidx/core/view/f;
    ...
    iget-object v4, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->x:Landroidx/core/view/f;

    invoke-virtual {v4}, Landroidx/core/view/f;->l()I

    move-result v4

    add-int/2addr v4, v5

    iget-object v5, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->x:Landroidx/core/view/f;

    invoke-virtual {v5}, Landroidx/core/view/f;->k()I

    move-result v5

    iget-object v6, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->x:Landroidx/core/view/f;

    invoke-virtual {v6}, Landroidx/core/view/f;->i()I

    move-result v6

    invoke-static {v2, v4, v5, v6}, LiV;->b(IIII)LiV;

    move-result-object v2

    new-instance v4, Landroidx/core/view/f$b;

    iget-object v5, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->x:Landroidx/core/view/f;

    invoke-direct {v4, v5}, Landroidx/core/view/f$b;-><init>(Landroidx/core/view/f;)V

    invoke-virtual {v4, v2}, Landroidx/core/view/f$b;->d(LiV;)Landroidx/core/view/f$b;

    move-result-object v2

    invoke-virtual {v2}, Landroidx/core/view/f$b;->a()Landroidx/core/view/f;
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->y:Landroidx/core/view/f;

    iget-object v4, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->x:Landroidx/core/view/f;

    invoke-virtual {v2, v4}, Landroidx/core/view/f;->equals(Ljava/lang/Object;)Z

    move-result v2

    if-nez v2, :cond_5

    iget-object v2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->x:Landroidx/core/view/f;

    iput-object v2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->y:Landroidx/core/view/f;

    iget-object v4, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->c:Landroidx/appcompat/widget/ContentFrameLayout;

    invoke-static {v4, v2}, Landroidx/core/view/ViewCompat;->dispatchApplyWindowInsets(Landroid/view/View;Landroidx/core/view/f;)Landroidx/core/view/f;
...
.method r()V
    ...
    sget v0, Landroidx/appcompat/R$id;->b:I
    ...
    invoke-direct {p0, v0}, Landroidx/appcompat/widget/ActionBarOverlayLayout;->l(Landroid/view/View;)LPu;

    move-result-object v0

    iput-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->f:LPu;
...
.method public setIcon(I)V
    ...
    invoke-interface {v0, p1}, LPu;->setIcon(I)V
...
.method public setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-interface {v0, p1}, LPu;->setIcon(Landroid/graphics/drawable/Drawable;)V
...
.method public setLogo(I)V
    ...
    invoke-interface {v0, p1}, LPu;->s(I)V
...
.method public setMenu(Landroid/view/Menu;Landroidx/appcompat/view/menu/j$a;)V
    ...
    invoke-interface {v0, p1, p2}, LPu;->setMenu(Landroid/view/Menu;Landroidx/appcompat/view/menu/j$a;)V
...
.method public setMenuPrepared()V
    ...
    invoke-interface {v0}, LPu;->setMenuPrepared()V
...
.method public setWindowCallback(Landroid/view/Window$Callback;)V
    ...
    invoke-interface {v0, p1}, LPu;->setWindowCallback(Landroid/view/Window$Callback;)V
