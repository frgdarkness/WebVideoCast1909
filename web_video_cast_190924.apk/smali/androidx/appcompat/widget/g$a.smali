...
.method private h(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    sget v2, Landroidx/appcompat/R$attr;->w:I
    ...
    invoke-static {v2, p2}, LGl;->k(II)I
...
.method private k(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    sget v3, Landroidx/appcompat/R$attr;->v:I
...
.method private l(Landroidx/appcompat/widget/u;Landroid/content/Context;I)Landroid/graphics/drawable/LayerDrawable;
    .locals 6
    ...
    sget v2, Landroidx/appcompat/R$drawable;->F:I

    invoke-virtual {p1, p2, v2}, Landroidx/appcompat/widget/u;->j(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;

    move-result-object v2

    sget v3, Landroidx/appcompat/R$drawable;->G:I

    invoke-virtual {p1, p2, v3}, Landroidx/appcompat/widget/u;->j(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method public a(Landroidx/appcompat/widget/u;Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p1, p2, v0}, Landroidx/appcompat/widget/u;->j(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    sget v1, Landroidx/appcompat/R$drawable;->k:I

    invoke-virtual {p1, p2, v1}, Landroidx/appcompat/widget/u;->j(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, p1, p2, p3}, Landroidx/appcompat/widget/g$a;->l(Landroidx/appcompat/widget/u;Landroid/content/Context;I)Landroid/graphics/drawable/LayerDrawable;
...
.method public b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    sget p2, Landroidx/appcompat/R$color;->e:I

    invoke-static {p1, p2}, LC6;->a(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    sget p2, Landroidx/appcompat/R$color;->h:I
    ...
    sget p2, Landroidx/appcompat/R$attr;->x:I
    ...
    sget p2, Landroidx/appcompat/R$color;->d:I
    ...
    sget p2, Landroidx/appcompat/R$color;->c:I
    ...
    :cond_9
    sget v0, Landroidx/appcompat/R$drawable;->A:I

    if-ne p2, v0, :cond_a

    sget p2, Landroidx/appcompat/R$color;->f:I
    ...
    :cond_b
    :goto_0
    sget p2, Landroidx/appcompat/R$color;->g:I
...
.method public c(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    sget p2, Landroidx/appcompat/R$attr;->v:I
    ...
    :cond_2
    sget v1, Landroidx/appcompat/R$drawable;->u:I
    ...
    :cond_3
    sget v1, Landroidx/appcompat/R$drawable;->l:I
