...
.method public constructor <init>(Landroidx/appcompat/widget/AppCompatSpinner;Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/AppCompatSpinner$h;->O:Landroidx/appcompat/widget/AppCompatSpinner;
    ...
    iput-object p2, p0, Landroidx/appcompat/widget/AppCompatSpinner$h;->M:Landroid/graphics/Rect;
    ...
    invoke-virtual {p0, p2}, Landroidx/appcompat/widget/ListPopupWindow;->N(I)V
    ...
    invoke-virtual {p0, p2}, Landroidx/appcompat/widget/ListPopupWindow;->J(Landroid/widget/AdapterView$OnItemClickListener;)V

    return-void
.end method

.method static synthetic Q(Landroidx/appcompat/widget/AppCompatSpinner$h;)V
    .locals 0
...
.method R()V
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/AppCompatSpinner$h;->O:Landroidx/appcompat/widget/AppCompatSpinner;

    iget-object v1, v1, Landroidx/appcompat/widget/AppCompatSpinner;->i:Landroid/graphics/Rect;

    invoke-virtual {v0, v1}, Landroid/graphics/drawable/Drawable;->getPadding(Landroid/graphics/Rect;)Z

    iget-object v0, p0, Landroidx/appcompat/widget/AppCompatSpinner$h;->O:Landroidx/appcompat/widget/AppCompatSpinner;

    invoke-static {v0}, Landroidx/appcompat/widget/F;->b(Landroid/view/View;)Z
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/AppCompatSpinner$h;->O:Landroidx/appcompat/widget/AppCompatSpinner;

    invoke-virtual {v2}, Landroid/view/View;->getPaddingRight()I

    move-result v2

    iget-object v3, p0, Landroidx/appcompat/widget/AppCompatSpinner$h;->O:Landroidx/appcompat/widget/AppCompatSpinner;

    invoke-virtual {v3}, Landroid/view/View;->getWidth()I

    move-result v3

    iget-object v4, p0, Landroidx/appcompat/widget/AppCompatSpinner$h;->O:Landroidx/appcompat/widget/AppCompatSpinner;
    ...
    iget-object v5, p0, Landroidx/appcompat/widget/AppCompatSpinner$h;->L:Landroid/widget/ListAdapter;
    ...
    iget-object v5, p0, Landroidx/appcompat/widget/AppCompatSpinner$h;->O:Landroidx/appcompat/widget/AppCompatSpinner;
    ...
    iget-object v6, p0, Landroidx/appcompat/widget/AppCompatSpinner$h;->O:Landroidx/appcompat/widget/AppCompatSpinner;
    ...
    invoke-static {v4}, Landroidx/appcompat/widget/F;->b(Landroid/view/View;)Z
    ...
    invoke-virtual {p0}, Landroidx/appcompat/widget/AppCompatSpinner$h;->S()I
...
.method public S()I
    ...
    iget v0, p0, Landroidx/appcompat/widget/AppCompatSpinner$h;->N:I
...
.method T(Landroid/view/View;)Z
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/AppCompatSpinner$h;->M:Landroid/graphics/Rect;
...
.method public e()Ljava/lang/CharSequence;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/AppCompatSpinner$h;->K:Ljava/lang/CharSequence;
...
.method public g(Ljava/lang/CharSequence;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/AppCompatSpinner$h;->K:Ljava/lang/CharSequence;
...
.method public i(I)V
    ...
    iput p1, p0, Landroidx/appcompat/widget/AppCompatSpinner$h;->N:I
...
.method public j(II)V
    ...
    invoke-virtual {p0}, Landroidx/appcompat/widget/AppCompatSpinner$h;->R()V
    ...
    invoke-virtual {p0}, Landroidx/appcompat/widget/ListPopupWindow;->n()Landroid/widget/ListView;
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/AppCompatSpinner$h;->O:Landroidx/appcompat/widget/AppCompatSpinner;
    ...
    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/ListPopupWindow;->I(Landroid/widget/PopupWindow$OnDismissListener;)V
...
.method public l(Landroid/widget/ListAdapter;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/AppCompatSpinner$h;->L:Landroid/widget/ListAdapter;
