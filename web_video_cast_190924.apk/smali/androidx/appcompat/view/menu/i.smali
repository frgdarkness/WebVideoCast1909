...
.method private a()Landroidx/appcompat/view/menu/h;
    ...
    invoke-virtual {v0, v1}, Landroidx/appcompat/view/menu/h;->b(Landroidx/appcompat/view/menu/e;)V

    iget-object v1, p0, Landroidx/appcompat/view/menu/i;->l:Landroid/widget/PopupWindow$OnDismissListener;

    invoke-virtual {v0, v1}, Landroidx/appcompat/view/menu/h;->k(Landroid/widget/PopupWindow$OnDismissListener;)V

    iget-object v1, p0, Landroidx/appcompat/view/menu/i;->f:Landroid/view/View;

    invoke-virtual {v0, v1}, Landroidx/appcompat/view/menu/h;->f(Landroid/view/View;)V
    ...
    invoke-virtual {v0, v1}, Landroidx/appcompat/view/menu/h;->h(Z)V

    iget v1, p0, Landroidx/appcompat/view/menu/i;->g:I

    invoke-virtual {v0, v1}, Landroidx/appcompat/view/menu/h;->i(I)V
...
.method private l(IIZZ)V
    ...
    invoke-virtual {v0, p4}, Landroidx/appcompat/view/menu/h;->l(Z)V
    ...
    invoke-static {p3, p4}, LcP;->b(II)I
    ...
    invoke-virtual {v0, p2}, Landroidx/appcompat/view/menu/h;->m(I)V
    ...
    invoke-virtual {v0, p4}, Landroidx/appcompat/view/menu/h;->g(Landroid/graphics/Rect;)V

    :cond_1
    invoke-interface {v0}, LOK0;->show()V
...
.method public g(Z)V
    ...
    invoke-virtual {v0, p1}, Landroidx/appcompat/view/menu/h;->h(Z)V
...
.method public j(Landroidx/appcompat/view/menu/j$a;)V
    ...
    invoke-interface {v0, p1}, Landroidx/appcompat/view/menu/j;->setCallback(Landroidx/appcompat/view/menu/j$a;)V
