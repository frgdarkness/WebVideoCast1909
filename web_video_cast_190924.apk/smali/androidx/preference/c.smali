...
.method private t(Landroid/app/Dialog;)V
    .locals 2
    ...
    :cond_0
    invoke-virtual {p0}, Landroidx/preference/c;->u()V
...
# virtual methods
.method public n()Landroidx/preference/DialogPreference;
    .locals 2

    iget-object v0, p0, Landroidx/preference/c;->a:Landroidx/preference/DialogPreference;
    ...
    iput-object v0, p0, Landroidx/preference/c;->a:Landroidx/preference/DialogPreference;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object p1, p0, Landroidx/preference/c;->a:Landroidx/preference/DialogPreference;
    ...
    iget-object p1, p0, Landroidx/preference/c;->a:Landroidx/preference/DialogPreference;
    ...
    iput-object p1, p0, Landroidx/preference/c;->d:Ljava/lang/CharSequence;
    ...
    iput-object p1, p0, Landroidx/preference/c;->f:Ljava/lang/CharSequence;

    iget-object p1, p0, Landroidx/preference/c;->a:Landroidx/preference/DialogPreference;

    invoke-virtual {p1}, Landroidx/preference/DialogPreference;->F0()I

    move-result p1

    iput p1, p0, Landroidx/preference/c;->g:I

    iget-object p1, p0, Landroidx/preference/c;->a:Landroidx/preference/DialogPreference;

    invoke-virtual {p1}, Landroidx/preference/DialogPreference;->E0()Landroid/graphics/drawable/Drawable;
    ...
    iput-object p1, p0, Landroidx/preference/c;->h:Landroid/graphics/drawable/BitmapDrawable;
    ...
    iput-object v0, p0, Landroidx/preference/c;->c:Ljava/lang/CharSequence;
    ...
    iput-object v0, p0, Landroidx/preference/c;->d:Ljava/lang/CharSequence;
    ...
    iput-object v0, p0, Landroidx/preference/c;->f:Ljava/lang/CharSequence;
    ...
    iput-object v0, p0, Landroidx/preference/c;->h:Landroid/graphics/drawable/BitmapDrawable;
...
.method public onCreateDialog(Landroid/os/Bundle;)Landroid/app/Dialog;
    ...
    iput p1, p0, Landroidx/preference/c;->i:I
    ...
    iget-object v0, p0, Landroidx/preference/c;->h:Landroid/graphics/drawable/BitmapDrawable;
    ...
    iget-object v0, p0, Landroidx/preference/c;->d:Ljava/lang/CharSequence;
    ...
    invoke-virtual {p0, v0}, Landroidx/preference/c;->q(Landroid/content/Context;)Landroid/view/View;

    move-result-object v0

    if-eqz v0, :cond_0

    invoke-virtual {p0, v0}, Landroidx/preference/c;->p(Landroid/view/View;)V
    ...
    :cond_0
    iget-object v0, p0, Landroidx/preference/c;->f:Ljava/lang/CharSequence;

    invoke-virtual {p1, v0}, Landroidx/appcompat/app/c$a;->setMessage(Ljava/lang/CharSequence;)Landroidx/appcompat/app/c$a;

    :goto_0
    invoke-virtual {p0, p1}, Landroidx/preference/c;->s(Landroidx/appcompat/app/c$a;)V

    invoke-virtual {p1}, Landroidx/appcompat/app/c$a;->create()Landroidx/appcompat/app/c;

    move-result-object p1

    invoke-virtual {p0}, Landroidx/preference/c;->o()Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-direct {p0, p1}, Landroidx/preference/c;->t(Landroid/app/Dialog;)V
...
.method public onDismiss(Landroid/content/DialogInterface;)V
    ...
    :goto_0
    invoke-virtual {p0, p1}, Landroidx/preference/c;->r(Z)V
...
.method public onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    iget-object v1, p0, Landroidx/preference/c;->d:Ljava/lang/CharSequence;

    invoke-virtual {p1, v0, v1}, Landroid/os/Bundle;->putCharSequence(Ljava/lang/String;Ljava/lang/CharSequence;)V

    const-string v0, "PreferenceDialogFragment.message"

    iget-object v1, p0, Landroidx/preference/c;->f:Ljava/lang/CharSequence;

    invoke-virtual {p1, v0, v1}, Landroid/os/Bundle;->putCharSequence(Ljava/lang/String;Ljava/lang/CharSequence;)V

    const-string v0, "PreferenceDialogFragment.layout"

    iget v1, p0, Landroidx/preference/c;->g:I
...
.method protected q(Landroid/content/Context;)Landroid/view/View;
    .locals 2

    iget p1, p0, Landroidx/preference/c;->g:I
