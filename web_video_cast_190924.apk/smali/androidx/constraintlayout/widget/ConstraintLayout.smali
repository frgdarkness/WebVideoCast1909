...
.field private mConstraintsChangedListener:Lqp;
...
.field protected mLayoutWidget:Lop;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Landroidx/constraintlayout/widget/ConstraintLayout;->mLayoutWidget:Lop;
    ...
    invoke-direct {p0, v0, p1, p1}, Landroidx/constraintlayout/widget/ConstraintLayout;->b(Landroid/util/AttributeSet;II)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {p0, p2, p1, p1}, Landroidx/constraintlayout/widget/ConstraintLayout;->b(Landroid/util/AttributeSet;II)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {p0, p2, p3, p1}, Landroidx/constraintlayout/widget/ConstraintLayout;->b(Landroid/util/AttributeSet;II)V

    return-void
.end method

.method private final a(I)Lnp;
    .locals 1

    if-nez p1, :cond_0

    iget-object p1, p0, Landroidx/constraintlayout/widget/ConstraintLayout;->mLayoutWidget:Lop;
    ...
    iget-object p1, p1, Landroidx/constraintlayout/widget/ConstraintLayout$b;->n0:Lnp;
...
.method private b(Landroid/util/AttributeSet;II)V
    .locals 5

    iget-object v0, p0, Landroidx/constraintlayout/widget/ConstraintLayout;->mLayoutWidget:Lop;

    invoke-virtual {v0, p0}, Lnp;->d0(Ljava/lang/Object;)V
    ...
    invoke-virtual {v0, v1}, Lop;->i1(Lhd$b;)V
    ...
    invoke-virtual {p1, p2}, Lop;->j1(I)V
...
.method private d()V
    ...
    invoke-virtual {p0, v2}, Landroidx/constraintlayout/widget/ConstraintLayout;->getViewWidget(Landroid/view/View;)Lnp;
    ...
    invoke-direct {p0, v3}, Landroidx/constraintlayout/widget/ConstraintLayout;->a(I)Lnp;

    move-result-object v3

    invoke-virtual {v3, v4}, Lnp;->e0(Ljava/lang/String;)V
    :try_end_0
    .catch Landroid/content/res/Resources$NotFoundException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    iget-object v2, p0, Landroidx/constraintlayout/widget/ConstraintLayout;->mLayoutWidget:Lop;
    ...
    iget-object v3, p0, Landroidx/constraintlayout/widget/ConstraintLayout;->mLayoutWidget:Lop;
    ...
    invoke-virtual {v0, v3}, LFb1;->b(Lnp;)V
    ...
    invoke-virtual/range {v0 .. v5}, Landroidx/constraintlayout/widget/ConstraintLayout;->applyConstraintsFromLayoutParams(ZLandroid/view/View;Lnp;Landroidx/constraintlayout/widget/ConstraintLayout$b;Landroid/util/SparseArray;)V
...
.method protected applyConstraintsFromLayoutParams(ZLandroid/view/View;Lnp;Landroidx/constraintlayout/widget/ConstraintLayout$b;Landroid/util/SparseArray;)V
    .locals 18
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Z",
    ...
    invoke-virtual {v7, v2}, Lnp;->E0(I)V
    ...
    invoke-virtual {v7, v11}, Lnp;->q0(Z)V
    ...
    :cond_0
    invoke-virtual {v7, v1}, Lnp;->d0(Ljava/lang/Object;)V
    ...
    iget-object v2, v0, Landroidx/constraintlayout/widget/ConstraintLayout;->mLayoutWidget:Lop;

    invoke-virtual {v2}, Lop;->d1()Z

    move-result v2

    invoke-virtual {v1, v7, v2}, Landroidx/constraintlayout/widget/ConstraintHelper;->n(Lnp;Z)V
    ...
    invoke-virtual {v1, v4}, LkP;->R0(F)V
    ...
    invoke-virtual {v1, v2}, LkP;->P0(I)V
    ...
    invoke-virtual {v1, v3}, LkP;->Q0(I)V
    ...
    invoke-virtual {v7, v1, v2, v3}, Lnp;->k(Lnp;FI)V
    ...
    invoke-virtual/range {v1 .. v6}, Lnp;->U(Ldp$b;Lnp;Ldp$b;II)V
    ...
    sget-object v3, Ldp$b;->g:Ldp$b;

    invoke-virtual {v7, v3}, Lnp;->n(Ldp$b;)Ldp;
    ...
    invoke-virtual {v4, v2, v10, v12, v11}, Ldp;->b(Ldp;IIZ)Z

    invoke-virtual {v7, v11}, Lnp;->h0(Z)V

    iget-object v1, v1, Landroidx/constraintlayout/widget/ConstraintLayout$b;->n0:Lnp;

    invoke-virtual {v1, v11}, Lnp;->h0(Z)V

    sget-object v1, Ldp$b;->c:Ldp$b;

    invoke-virtual {v7, v1}, Lnp;->n(Ldp$b;)Ldp;

    move-result-object v1

    invoke-virtual {v1}, Ldp;->l()V
    ...
    invoke-virtual {v7, v2}, Lnp;->j0(F)V
    ...
    invoke-virtual {v7, v2}, Lnp;->y0(F)V
    ...
    invoke-virtual {v7, v1, v2}, Lnp;->w0(II)V
    ...
    invoke-virtual {v7, v1}, Lnp;->m0(Lnp$b;)V
    ...
    invoke-virtual {v7, v10}, Lnp;->F0(I)V
    ...
    invoke-virtual {v7, v1}, Lnp;->F0(I)V

    iget v1, v8, Landroid/view/ViewGroup$MarginLayoutParams;->width:I

    if-ne v1, v2, :cond_17

    sget-object v1, Lnp$b;->b:Lnp$b;
    ...
    invoke-virtual {v7, v1}, Lnp;->B0(Lnp$b;)V
    ...
    invoke-virtual {v7, v10}, Lnp;->i0(I)V
    ...
    invoke-virtual {v7, v1}, Lnp;->i0(I)V
    ...
    invoke-virtual {v7, v1, v2, v3, v4}, Lnp;->n0(IIIF)V
    ...
    invoke-virtual {v7, v1, v2, v3, v4}, Lnp;->C0(IIIF)V
...
.method public fillMetrics(Lph0;)V
    .locals 1

    iget-object v0, p0, Landroidx/constraintlayout/widget/ConstraintLayout;->mLayoutWidget:Lop;

    invoke-virtual {v0, p1}, Lop;->W0(Lph0;)V
...
.method public final getViewWidget(Landroid/view/View;)Lnp;
    .locals 0
...
.method protected onLayout(ZIIII)V
    ...
    iget-object v1, v0, Landroidx/constraintlayout/widget/ConstraintLayout$b;->n0:Lnp;
    ...
    :cond_1
    invoke-virtual {v1}, Lnp;->R()I

    move-result v0

    invoke-virtual {v1}, Lnp;->S()I
...
.method protected onMeasure(II)V
    ...
    invoke-virtual {v0, v1}, Lop;->k1(Z)V
    ...
    invoke-virtual {p0, v0, v1, p1, p2}, Landroidx/constraintlayout/widget/ConstraintLayout;->resolveSystem(Lop;III)V
...
.method public onViewAdded(Landroid/view/View;)V
    ...
    invoke-virtual {p0, p1}, Landroidx/constraintlayout/widget/ConstraintLayout;->getViewWidget(Landroid/view/View;)Lnp;
    ...
    invoke-virtual {v1, v0}, LkP;->S0(I)V
...
.method public onViewRemoved(Landroid/view/View;)V
    ...
    invoke-virtual {v1, v0}, LFb1;->N0(Lnp;)V
...
.method protected resolveSystem(Lop;III)V
    .locals 20
    ...
    invoke-virtual/range {v0 .. v5}, Landroidx/constraintlayout/widget/ConstraintLayout;->setSelfDimensionBehaviour(Lop;IIII)V
    ...
    invoke-virtual/range {v7 .. v16}, Lop;->f1(IIIIIIIII)J
...
.method public setOnConstraintsChanged(Lqp;)V
    .locals 1
    ...
    invoke-virtual {v0, p1}, Landroidx/constraintlayout/widget/b;->c(Lqp;)V
...
.method public setOptimizationLevel(I)V
    ...
    invoke-virtual {v0, p1}, Lop;->j1(I)V

    return-void
.end method

.method protected setSelfDimensionBehaviour(Lop;IIII)V
    .locals 7
    ...
    :cond_a
    invoke-virtual {p1}, Lop;->b1()V

    :cond_b
    invoke-virtual {p1, v6}, Lnp;->G0(I)V

    invoke-virtual {p1, v6}, Lnp;->H0(I)V

    iget p4, p0, Landroidx/constraintlayout/widget/ConstraintLayout;->mMaxWidth:I

    sub-int/2addr p4, v0

    invoke-virtual {p1, p4}, Lnp;->t0(I)V

    iget p4, p0, Landroidx/constraintlayout/widget/ConstraintLayout;->mMaxHeight:I

    sub-int/2addr p4, v1

    invoke-virtual {p1, p4}, Lnp;->s0(I)V

    invoke-virtual {p1, v6}, Lnp;->v0(I)V

    invoke-virtual {p1, v6}, Lnp;->u0(I)V

    invoke-virtual {p1, p2}, Lnp;->m0(Lnp$b;)V

    invoke-virtual {p1, p3}, Lnp;->F0(I)V

    invoke-virtual {p1, v2}, Lnp;->B0(Lnp$b;)V

    invoke-virtual {p1, p5}, Lnp;->i0(I)V
    ...
    invoke-virtual {p1, p2}, Lnp;->u0(I)V
