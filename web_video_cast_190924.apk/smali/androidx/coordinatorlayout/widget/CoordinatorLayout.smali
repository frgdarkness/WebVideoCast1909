...
.field private static final sRectPool:LEw0;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "LEw0;"
        }
...
# instance fields
.field private mApplyWindowInsetsListener:LFq0;

.field private final mBehaviorConsumed:[I

.field private mBehaviorTouchView:Landroid/view/View;

.field private final mChildDag:LvA;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "LvA;"
        }
...
.field private mLastInsets:Landroidx/core/view/f;

.field private mNeedsPreDrawListener:Z

.field private final mNestedScrollingParentHelper:LEl0;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->sRectPool:LEw0;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->mChildDag:LvA;
    ...
    invoke-direct {v0, p0}, LEl0;-><init>(Landroid/view/ViewGroup;)V

    iput-object v0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->mNestedScrollingParentHelper:LEl0;
    ...
    invoke-static/range {v2 .. v8}, Lpq;->a(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/content/Context;[ILandroid/util/AttributeSet;Landroid/content/res/TypedArray;II)V
...
.method private static a()Landroid/graphics/Rect;
    ...
    sget-object v0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->sRectPool:LEw0;
...
.method private c(Landroidx/coordinatorlayout/widget/CoordinatorLayout$f;Landroid/graphics/Rect;II)V
    .locals 5
...
.method private d(Landroidx/core/view/f;)Landroidx/core/view/f;
    .locals 4

    invoke-virtual {p1}, Landroidx/core/view/f;->p()Z
    ...
    invoke-virtual {v3, p0, v2, p1}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$c;->onApplyWindowInsets(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroidx/core/view/f;)Landroidx/core/view/f;
...
.method private e(Landroid/view/View;ILandroid/graphics/Rect;Landroid/graphics/Rect;Landroidx/coordinatorlayout/widget/CoordinatorLayout$f;II)V
    .locals 5
    ...
    invoke-static {p1, p2}, LcP;->b(II)I
    ...
    invoke-static {p5, p2}, LcP;->b(II)I
...
.method private h(Landroid/view/View;)Z
    ...
    iget-object v0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->mChildDag:LvA;

    invoke-virtual {v0, p1}, LvA;->j(Ljava/lang/Object;)Z
...
.method private i(Landroid/view/View;I)V
    ...
    iget-object v1, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->mLastInsets:Landroidx/core/view/f;
    ...
    iget-object v2, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->mLastInsets:Landroidx/core/view/f;

    invoke-virtual {v2}, Landroidx/core/view/f;->j()I
    ...
    invoke-virtual {v2}, Landroidx/core/view/f;->l()I
    ...
    invoke-virtual {v2}, Landroidx/core/view/f;->k()I
    ...
    invoke-virtual {v2}, Landroidx/core/view/f;->i()I
    ...
    invoke-static/range {v1 .. v6}, LcP;->a(IIILandroid/graphics/Rect;Landroid/graphics/Rect;I)V
...
.method private k(Landroid/view/View;II)V
    ...
    invoke-static {v1, p3}, LcP;->b(II)I
...
.method private n()V
    ...
    iget-object v5, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->mChildDag:LvA;

    invoke-virtual {v5, v3}, LvA;->b(Ljava/lang/Object;)V
    ...
    iget-object v7, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->mChildDag:LvA;

    invoke-virtual {v7, v6}, LvA;->d(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v7, v6}, LvA;->b(Ljava/lang/Object;)V

    :cond_1
    iget-object v7, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->mChildDag:LvA;

    invoke-virtual {v7, v6, v3}, LvA;->a(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    iget-object v1, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->mChildDag:LvA;

    invoke-virtual {v1}, LvA;->i()Ljava/util/ArrayList;
...
.method private v()V
    ...
    iget-object v0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->mApplyWindowInsetsListener:LFq0;
    ...
    iput-object v0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->mApplyWindowInsetsListener:LFq0;

    :cond_0
    iget-object v0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->mApplyWindowInsetsListener:LFq0;

    invoke-static {p0, v0}, Landroidx/core/view/ViewCompat;->setOnApplyWindowInsetsListener(Landroid/view/View;LFq0;)V
...
.method public dispatchDependentViewsChanged(Landroid/view/View;)V
    ...
    invoke-virtual {v0, p1}, LvA;->g(Ljava/lang/Object;)Ljava/util/List;
...
.method public getDependencies(Landroid/view/View;)Ljava/util/List;
    ...
    invoke-virtual {v0, p1}, LvA;->h(Ljava/lang/Object;)Ljava/util/List;
...
.method getDescendantRect(Landroid/view/View;Landroid/graphics/Rect;)V
    ...
    invoke-static {p0, p1, p2}, LD61;->a(Landroid/view/ViewGroup;Landroid/view/View;Landroid/graphics/Rect;)V
...
.method getDesiredAnchoredChildRect(Landroid/view/View;ILandroid/graphics/Rect;Landroid/graphics/Rect;)V
    ...
    invoke-direct/range {v1 .. v8}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->e(Landroid/view/View;ILandroid/graphics/Rect;Landroid/graphics/Rect;Landroidx/coordinatorlayout/widget/CoordinatorLayout$f;II)V

    invoke-direct {p0, v0, p4, v9, v10}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->c(Landroidx/coordinatorlayout/widget/CoordinatorLayout$f;Landroid/graphics/Rect;II)V
...
.method public final getLastWindowInsets()Landroidx/core/view/f;
    .locals 1

    iget-object v0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->mLastInsets:Landroidx/core/view/f;
...
.method public getNestedScrollAxes()I
    ...
    iget-object v0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->mNestedScrollingParentHelper:LEl0;
...
.method offsetChildToAnchor(Landroid/view/View;I)V
    ...
    invoke-direct/range {v0 .. v7}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->e(Landroid/view/View;ILandroid/graphics/Rect;Landroid/graphics/Rect;Landroidx/coordinatorlayout/widget/CoordinatorLayout$f;II)V
    ...
    :goto_2
    invoke-direct {v8, v10, v13, v15, v0}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->c(Landroidx/coordinatorlayout/widget/CoordinatorLayout$f;Landroid/graphics/Rect;II)V
...
.method final onChildViewsChanged(I)V
    ...
    invoke-static {v12, v2}, LcP;->b(II)I
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-virtual {v0}, Landroidx/core/view/f;->l()I
...
.method protected onMeasure(II)V
    ...
    iget-object v3, v7, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->mLastInsets:Landroidx/core/view/f;
    ...
    invoke-static {v11, v10}, LcP;->b(II)I
    ...
    iget-object v0, v7, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->mLastInsets:Landroidx/core/view/f;

    invoke-virtual {v0}, Landroidx/core/view/f;->j()I

    move-result v0

    iget-object v2, v7, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->mLastInsets:Landroidx/core/view/f;
    ...
    iget-object v11, v7, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->mLastInsets:Landroidx/core/view/f;

    invoke-virtual {v11}, Landroidx/core/view/f;->i()I
...
.method public onNestedScrollAccepted(Landroid/view/View;Landroid/view/View;II)V
    ...
    invoke-virtual {v0, p1, p2, p3, p4}, LEl0;->c(Landroid/view/View;Landroid/view/View;II)V
...
.method public onStopNestedScroll(Landroid/view/View;I)V
    ...
    invoke-virtual {v0, p1, p2}, LEl0;->e(Landroid/view/View;I)V
...
.method final setWindowInsets(Landroidx/core/view/f;)Landroidx/core/view/f;
    .locals 3
    ...
    iput-object p1, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->mLastInsets:Landroidx/core/view/f;
    ...
    invoke-direct {p0, p1}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->d(Landroidx/core/view/f;)Landroidx/core/view/f;
