...
# virtual methods
.method public f(ILT1;Ljava/lang/Object;LQ1;)V
    .locals 8

    iget-object v0, p0, Landroidx/activity/ComponentActivity$b;->i:Landroidx/activity/ComponentActivity;

    invoke-virtual {p2, v0, p3}, LT1;->b(Landroid/content/Context;Ljava/lang/Object;)LT1$a;
    ...
    invoke-direct {p3, p0, p1, v1}, Landroidx/activity/ComponentActivity$b$a;-><init>(Landroidx/activity/ComponentActivity$b;ILT1$a;)V
    ...
    :cond_0
    invoke-virtual {p2, v0, p3}, LT1;->a(Landroid/content/Context;Ljava/lang/Object;)Landroid/content/Intent;
    ...
    invoke-virtual {p4}, LQ1;->b()Landroid/os/Bundle;
    ...
    :cond_4
    invoke-static {v0, p2, p1}, LG1;->g(Landroid/app/Activity;[Ljava/lang/String;I)V
    ...
    invoke-static/range {v0 .. v7}, LG1;->l(Landroid/app/Activity;Landroid/content/IntentSender;ILandroid/content/Intent;IIILandroid/os/Bundle;)V
    :try_end_0
    ...
    :cond_6
    invoke-static {v0, p2, p1, v7}, LG1;->k(Landroid/app/Activity;Landroid/content/Intent;ILandroid/os/Bundle;)V
