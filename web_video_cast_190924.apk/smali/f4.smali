...
.method public constructor <init>(Landroid/content/Context;Ljava/net/URL;)V
    ...
    iput-object p1, p0, Lf4;->a:Landroid/content/Context;

    iput-object p2, p0, Lf4;->b:Ljava/net/URL;
...
.method private b(Ljava/lang/String;Lorg/json/JSONObject;)LHB0;
    .locals 7
    ...
    invoke-direct {v0, p2, v1}, Lgo;-><init>(Ljava/lang/String;Ljava/util/Date;)V
    :try_end_1
    ...
    invoke-direct/range {v1 .. v6}, LKB0;-><init>(Lbo;Ljava/lang/String;ILjava/lang/String;Z)V
    ...
    invoke-direct {p2, v0, p1}, LSl0;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V

    throw p2
.end method

.method private c(Ljava/lang/String;Lz9;Ljava/lang/String;)[B
    .locals 2
    ...
    invoke-interface {p2}, Lz9;->a()Ljava/util/Map;
    ...
    invoke-direct {p2, p3, p1}, LSl0;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private d(Ljava/net/HttpURLConnection;)V
    ...
    invoke-direct {p0, p1}, Lf4;->e(Ljavax/net/ssl/HttpsURLConnection;)V
...
.method private e(Ljavax/net/ssl/HttpsURLConnection;)V
    ...
    invoke-direct {v0, v1}, Lf4$c;-><init>(Lf4$a;)V
    ...
    invoke-direct {v0, v1}, Lf4$b;-><init>(Lf4$a;)V
...
.method private f()Z
    ...
    iget-object v0, p0, Lf4;->a:Landroid/content/Context;
...
.method private static g(Ljava/net/URL;)Ljava/net/HttpURLConnection;
    ...
    invoke-direct {v0, v1, p0}, LSl0;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private h(Ljava/net/HttpURLConnection;)Lorg/json/JSONObject;
    ...
    invoke-direct {v1, v0, p1}, LSl0;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-direct {v3, v4, p1}, LSl0;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-direct {v0, v1, p1}, LSl0;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-direct {p1, v0}, LSl0;-><init>(Ljava/lang/String;)V
...
.method private j(Ljava/net/HttpURLConnection;[B)V
    ...
    invoke-direct {p2, v2, p1}, LSl0;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
...
# virtual methods
.method public a(Ljava/lang/String;Lz9;Ljava/lang/String;)LHB0;
    .locals 1
    ...
    invoke-direct {p0}, Lf4;->f()Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v0, p0, Lf4;->b:Ljava/net/URL;

    invoke-static {v0}, Lf4;->g(Ljava/net/URL;)Ljava/net/HttpURLConnection;

    move-result-object v0

    invoke-direct {p0, v0}, Lf4;->d(Ljava/net/HttpURLConnection;)V

    invoke-direct {p0, v0}, Lf4;->i(Ljava/net/HttpURLConnection;)V

    invoke-direct {p0, p1, p2, p3}, Lf4;->c(Ljava/lang/String;Lz9;Ljava/lang/String;)[B

    move-result-object p2

    invoke-direct {p0, v0, p2}, Lf4;->j(Ljava/net/HttpURLConnection;[B)V

    invoke-direct {p0, v0}, Lf4;->h(Ljava/net/HttpURLConnection;)Lorg/json/JSONObject;

    move-result-object p2

    invoke-direct {p0, p1, p2}, Lf4;->b(Ljava/lang/String;Lorg/json/JSONObject;)LHB0;
    ...
    invoke-direct {p1, p2}, LSl0;-><init>(Ljava/lang/String;)V
