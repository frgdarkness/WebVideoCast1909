...
.method constructor <init>(Ljava/io/File;Ljava/io/File;)V
    ...
    iput-object p1, p0, LIj0;->a:Ljava/io/File;

    iput-object p2, p0, LIj0;->c:Ljava/io/File;

    invoke-static {p1}, LIj0;->i(Ljava/io/File;)J

    move-result-wide v2

    iput-wide v2, p0, LIj0;->b:J
    ...
    iput-object p2, p0, LIj0;->d:Ljava/io/RandomAccessFile;
    ...
    iput-object p2, p0, LIj0;->f:Ljava/nio/channels/FileChannel;
    :try_end_0
    ...
    iput-object p2, p0, LIj0;->g:Ljava/nio/channels/FileLock;
    :try_end_1
    ...
    :goto_0
    iget-object p2, p0, LIj0;->f:Ljava/nio/channels/FileChannel;

    invoke-static {p2}, LIj0;->b(Ljava/io/Closeable;)V
    ...
    :goto_1
    iget-object p2, p0, LIj0;->d:Ljava/io/RandomAccessFile;
...
.method private a()V
    ...
    iget-object v0, p0, LIj0;->c:Ljava/io/File;

    new-instance v1, LIj0$a;

    invoke-direct {v1, p0}, LIj0$a;-><init>(LIj0;)V
    ...
    iget-object v2, p0, LIj0;->c:Ljava/io/File;
...
.method private static d(Ljava/util/zip/ZipFile;Ljava/util/zip/ZipEntry;Ljava/io/File;Ljava/lang/String;)V
    ...
    invoke-static {p0}, LIj0;->b(Ljava/io/Closeable;)V
...
.method private static i(Ljava/io/File;)J
    ...
    invoke-static {p0}, Lif1;->c(Ljava/io/File;)J
...
.method private static k(Landroid/content/Context;Ljava/io/File;JLjava/lang/String;)Z
    .locals 7

    invoke-static {p0}, LIj0;->e(Landroid/content/Context;)Landroid/content/SharedPreferences;
    ...
    invoke-static {p1}, LIj0;->g(Ljava/io/File;)J
...
.method private m(Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;
    ...
    iget-object v3, v0, LIj0;->a:Ljava/io/File;
    ...
    invoke-static/range {p1 .. p1}, LIj0;->e(Landroid/content/Context;)Landroid/content/SharedPreferences;
    ...
    new-instance v8, LIj0$b;

    iget-object v9, v0, LIj0;->c:Ljava/io/File;

    invoke-direct {v8, v9, v7}, LIj0$b;-><init>(Ljava/io/File;Ljava/lang/String;)V
    ...
    invoke-static {v8}, LIj0;->i(Ljava/io/File;)J

    move-result-wide v9

    iput-wide v9, v8, LIj0$b;->a:J
...
.method private n()Ljava/util/List;
    ...
    iget-object v6, v1, LIj0;->a:Ljava/io/File;
    ...
    invoke-direct/range {p0 .. p0}, LIj0;->a()V
    ...
    iget-object v0, v1, LIj0;->a:Ljava/io/File;
    ...
    new-instance v11, LIj0$b;

    iget-object v12, v1, LIj0;->c:Ljava/io/File;

    invoke-direct {v11, v12, v0}, LIj0$b;-><init>(Ljava/io/File;Ljava/lang/String;)V
    ...
    invoke-static {v8, v9, v11, v6}, LIj0;->d(Ljava/util/zip/ZipFile;Ljava/util/zip/ZipEntry;Ljava/io/File;Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    :try_start_1
    invoke-static {v11}, LIj0;->i(Ljava/io/File;)J

    move-result-wide v14

    iput-wide v14, v11, LIj0$b;->a:J
    :try_end_1
...
.method private static o(Landroid/content/Context;Ljava/lang/String;JJLjava/util/List;)V
    .locals 2
...
.method public close()V
    ...
    iget-object v0, p0, LIj0;->g:Ljava/nio/channels/FileLock;

    invoke-virtual {v0}, Ljava/nio/channels/FileLock;->release()V

    iget-object v0, p0, LIj0;->f:Ljava/nio/channels/FileChannel;

    invoke-virtual {v0}, Ljava/nio/channels/spi/AbstractInterruptibleChannel;->close()V

    iget-object v0, p0, LIj0;->d:Ljava/io/RandomAccessFile;
...
.method l(Landroid/content/Context;Ljava/lang/String;Z)Ljava/util/List;
    .locals 9
    ...
    iget-object v1, p0, LIj0;->a:Ljava/io/File;
    ...
    iget-object v0, p0, LIj0;->a:Ljava/io/File;

    iget-wide v2, p0, LIj0;->b:J

    invoke-static {p1, v0, v2, v3, p2}, LIj0;->k(Landroid/content/Context;Ljava/io/File;JLjava/lang/String;)Z
    ...
    :try_start_0
    invoke-direct {p0, p1, p2}, LIj0;->m(Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-direct {p0}, LIj0;->n()Ljava/util/List;

    move-result-object p3

    iget-object v0, p0, LIj0;->a:Ljava/io/File;

    invoke-static {v0}, LIj0;->g(Ljava/io/File;)J

    move-result-wide v4

    iget-wide v6, p0, LIj0;->b:J
    ...
    invoke-static/range {v2 .. v8}, LIj0;->o(Landroid/content/Context;Ljava/lang/String;JJLjava/util/List;)V
