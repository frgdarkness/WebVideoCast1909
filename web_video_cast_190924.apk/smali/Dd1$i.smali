...
.method constructor <init>(LDd1;LQD0;)V
    ...
    iput-object p1, p0, LDd1$i;->d:LDd1;
...
.method public bridge synthetic i(LOT0;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, LDd1$i;->n(LOT0;LBd1;)V

    return-void
.end method

.method public n(LOT0;LBd1;)V
    .locals 10
    ...
    invoke-virtual {p2}, Lpp;->d()Lam0;

    move-result-object v8

    invoke-static {v8}, LKd1;->g(Lam0;)I

    move-result v8

    int-to-long v8, v8

    invoke-interface {p1, v6, v8, v9}, LMT0;->x(IJ)V

    invoke-virtual {p2}, Lpp;->g()Z

    move-result v6

    int-to-long v8, v6

    invoke-interface {p1, v5, v8, v9}, LMT0;->x(IJ)V

    invoke-virtual {p2}, Lpp;->h()Z
    ...
    invoke-virtual {p2}, Lpp;->b()J

    move-result-wide v2

    invoke-interface {p1, v1, v2, v3}, LMT0;->x(IJ)V

    invoke-virtual {p2}, Lpp;->a()J

    move-result-wide v1

    invoke-interface {p1, v0, v1, v2}, LMT0;->x(IJ)V

    invoke-virtual {p2}, Lpp;->c()Ljava/util/Set;

    move-result-object p2

    invoke-static {p2}, LKd1;->i(Ljava/util/Set;)[B
    ...
    :cond_5
    invoke-interface {p1, v7, p2}, LMT0;->L(I[B)V
