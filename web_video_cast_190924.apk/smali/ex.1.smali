...
.field private static v:Lex;


# instance fields
.field private final a:Lcom/google/common/collect/ImmutableMap;

.field private final b:Lfb$a$a;

.field private final c:LGk;

.field private final d:Z

.field private final e:LGM0;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lex;->p:Lcom/google/common/collect/ImmutableList;
    ...
    sput-object v0, Lex;->q:Lcom/google/common/collect/ImmutableList;
    ...
    sput-object v4, Lex;->r:Lcom/google/common/collect/ImmutableList;
    ...
    sput-object v4, Lex;->s:Lcom/google/common/collect/ImmutableList;
    ...
    sput-object v1, Lex;->t:Lcom/google/common/collect/ImmutableList;
    ...
    sput-object v0, Lex;->u:Lcom/google/common/collect/ImmutableList;

    return-void
.end method

.method private constructor <init>(Landroid/content/Context;Ljava/util/Map;ILGk;Z)V
    .locals 0
    ...
    iput-object p2, p0, Lex;->a:Lcom/google/common/collect/ImmutableMap;

    new-instance p2, Lfb$a$a;

    invoke-direct {p2}, Lfb$a$a;-><init>()V

    iput-object p2, p0, Lex;->b:Lfb$a$a;

    new-instance p2, LGM0;

    invoke-direct {p2, p3}, LGM0;-><init>(I)V

    iput-object p2, p0, Lex;->e:LGM0;

    iput-object p4, p0, Lex;->c:LGk;

    iput-boolean p5, p0, Lex;->d:Z
    ...
    invoke-direct {p0, p2}, Lex;->l(I)J

    move-result-wide p2

    iput-wide p2, p0, Lex;->k:J

    new-instance p2, Ldx;

    invoke-direct {p2, p0}, Ldx;-><init>(Lex;)V

    invoke-virtual {p1, p2}, Lcm0;->i(Lcm0$c;)V
    ...
    invoke-direct {p0, p1}, Lex;->l(I)J

    move-result-wide p1

    iput-wide p1, p0, Lex;->k:J

    :goto_0
    return-void
.end method

.method synthetic constructor <init>(Landroid/content/Context;Ljava/util/Map;ILGk;ZLex$a;)V
    .locals 0

    invoke-direct/range {p0 .. p5}, Lex;-><init>(Landroid/content/Context;Ljava/util/Map;ILGk;Z)V

    return-void
.end method

.method public static synthetic i(Lex;I)V
    .locals 0

    invoke-direct {p0, p1}, Lex;->p(I)V
...
.method static synthetic j(Ljava/lang/String;)[I
    ...
    invoke-static {p0}, Lex;->k(Ljava/lang/String;)[I
...
.method private l(I)J
    ...
    iget-object v0, p0, Lex;->a:Lcom/google/common/collect/ImmutableMap;
    ...
    iget-object p1, p0, Lex;->a:Lcom/google/common/collect/ImmutableMap;
...
.method public static declared-synchronized m(Landroid/content/Context;)Lex;
    .locals 2
    ...
    :try_start_0
    sget-object v1, Lex;->v:Lex;

    if-nez v1, :cond_0

    new-instance v1, Lex$b;

    invoke-direct {v1, p0}, Lex$b;-><init>(Landroid/content/Context;)V

    invoke-virtual {v1}, Lex$b;->a()Lex;

    move-result-object p0

    sput-object p0, Lex;->v:Lex;
...
.method private static n(Lcu;Z)Z
    .locals 0
    ...
    invoke-virtual {p0, p1}, Lcu;->d(I)Z
...
.method private o(IJJ)V
    ...
    :cond_0
    iput-wide p4, p0, Lex;->l:J

    iget-object v3, p0, Lex;->b:Lfb$a$a;
    ...
    invoke-virtual/range {v3 .. v8}, Lfb$a$a;->c(IJJ)V
...
.method private declared-synchronized p(I)V
    ...
    iput-wide v0, p0, Lex;->k:J

    iget-object p1, p0, Lex;->c:LGk;
    ...
    :goto_0
    iget-wide v4, p0, Lex;->h:J

    iget-wide v6, p0, Lex;->k:J

    move-object v2, p0

    invoke-direct/range {v2 .. v7}, Lex;->o(IJJ)V

    iput-wide v0, p0, Lex;->g:J

    const-wide/16 v0, 0x0

    iput-wide v0, p0, Lex;->h:J

    iput-wide v0, p0, Lex;->j:J

    iput-wide v0, p0, Lex;->i:J

    iget-object p1, p0, Lex;->e:LGM0;

    invoke-virtual {p1}, LGM0;->i()V
    :try_end_2
...
.method public b(LXt;Lcu;Z)V
    .locals 0

    return-void
.end method

.method public declared-synchronized c(LXt;Lcu;ZI)V
    .locals 0

    monitor-enter p0

    :try_start_0
    invoke-static {p2, p3}, Lex;->n(Lcu;Z)Z
    ...
    :cond_0
    :try_start_1
    iget-wide p1, p0, Lex;->h:J

    int-to-long p3, p4

    add-long/2addr p1, p3

    iput-wide p1, p0, Lex;->h:J
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public declared-synchronized e(LXt;Lcu;Z)V
    .locals 10
    ...
    iget-wide v2, p0, Lex;->i:J

    int-to-long v6, v5

    add-long/2addr v2, v6

    iput-wide v2, p0, Lex;->i:J

    iget-wide v2, p0, Lex;->j:J

    iget-wide v6, p0, Lex;->h:J

    add-long/2addr v2, v6

    iput-wide v2, p0, Lex;->j:J
    ...
    invoke-virtual {p3, v2, p1}, LGM0;->c(IF)V
    ...
    invoke-virtual {p1, p3}, LGM0;->f(F)F

    move-result p1

    float-to-long v2, p1

    iput-wide v2, p0, Lex;->k:J

    :cond_3
    iget-wide v6, p0, Lex;->h:J

    iget-wide v8, p0, Lex;->k:J

    move-object v4, p0

    invoke-direct/range {v4 .. v9}, Lex;->o(IJJ)V
...
.method public declared-synchronized f(LXt;Lcu;Z)V
    .locals 0
...
.method public g(Landroid/os/Handler;Lfb$a;)V
    .locals 1
    ...
    iget-object v0, p0, Lex;->b:Lfb$a$a;

    invoke-virtual {v0, p1, p2}, Lfb$a$a;->b(Landroid/os/Handler;Lfb$a;)V
...
.method public h(Lfb$a;)V
    .locals 1

    iget-object v0, p0, Lex;->b:Lfb$a$a;

    invoke-virtual {v0, p1}, Lfb$a$a;->e(Lfb$a;)V
