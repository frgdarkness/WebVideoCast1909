...
.method public final o(Lj$/time/format/y;Ljava/lang/StringBuilder;)Z
    ...
    invoke-virtual/range {p1 .. p1}, Lj$/time/format/y;->d()Lj$/time/temporal/n;

    move-result-object v3

    sget-object v4, Lj$/time/temporal/ChronoField;->NANO_OF_SECOND:Lj$/time/temporal/ChronoField;

    invoke-interface {v3, v4}, Lj$/time/temporal/n;->f(Lj$/time/temporal/TemporalField;)Z
    ...
    invoke-interface {v2, v4}, Lj$/time/temporal/n;->v(Lj$/time/temporal/TemporalField;)J
    ...
    :goto_1
    invoke-virtual {v4, v1, v2}, Lj$/time/temporal/ChronoField;->R(J)I
    ...
    invoke-static {v5, v6, v3, v7}, Lj$/time/LocalDateTime;->a0(JILj$/time/ZoneOffset;)Lj$/time/LocalDateTime;
    ...
    invoke-virtual {v5}, Lj$/time/LocalDateTime;->T()I
    ...
    invoke-static {v7, v8, v3, v13}, Lj$/time/LocalDateTime;->a0(JILj$/time/ZoneOffset;)Lj$/time/LocalDateTime;
    ...
    invoke-virtual {v7}, Lj$/time/LocalDateTime;->U()I
...
.method public final q(Lj$/time/format/w;Ljava/lang/CharSequence;I)I
    ...
    invoke-virtual {v0, v4, v2}, Lj$/time/format/DateTimeFormatterBuilder;->n(Lj$/time/temporal/TemporalField;I)V

    invoke-virtual {v0, v3}, Lj$/time/format/DateTimeFormatterBuilder;->e(C)V

    sget-object v3, Lj$/time/temporal/ChronoField;->SECOND_OF_MINUTE:Lj$/time/temporal/ChronoField;

    invoke-virtual {v0, v3, v2}, Lj$/time/format/DateTimeFormatterBuilder;->n(Lj$/time/temporal/TemporalField;I)V
    ...
    invoke-virtual {v0, v7, v2, v5, v8}, Lj$/time/format/DateTimeFormatterBuilder;->b(Lj$/time/temporal/TemporalField;IIZ)V
    ...
    invoke-virtual {v0}, Lj$/time/format/DateTimeFormatter;->h()Lj$/time/format/e;
    ...
    invoke-virtual {v0, v5, v9, v6}, Lj$/time/format/e;->q(Lj$/time/format/w;Ljava/lang/CharSequence;I)I
    ...
    :try_start_0
    invoke-static/range {v12 .. v17}, Lj$/time/LocalDateTime;->Y(IIIIII)Lj$/time/LocalDateTime;
    ...
    invoke-static {v10, v11, v2, v3}, Lj$/com/android/tools/r8/a;->k(JJ)J
