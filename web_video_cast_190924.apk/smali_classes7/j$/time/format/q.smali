...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lj$/time/format/q;->i:Lj$/time/g;

    return-void
.end method

.method constructor <init>(Lj$/time/chrono/b;Lj$/time/temporal/TemporalField;)V
    .locals 9
    ...
    invoke-interface {p2}, Lj$/time/temporal/TemporalField;->o()Lj$/time/temporal/u;
...
.method synthetic constructor <init>(Lj$/time/temporal/TemporalField;Lj$/time/chrono/b;I)V
    .locals 7
...
.method final b(Lj$/time/format/y;J)J
    ...
    iget-object v2, p0, Lj$/time/format/q;->h:Lj$/time/chrono/b;
    ...
    invoke-interface {p1, v2}, Lj$/time/chrono/n;->p(Lj$/time/temporal/n;)Lj$/time/chrono/b;
...
.method final c(Lj$/time/format/w;)Z
    ...
    :cond_0
    invoke-super {p0, p1}, Lj$/time/format/k;->c(Lj$/time/format/w;)Z
...
.method final d(Lj$/time/format/w;JII)I
    ...
    invoke-interface {v1, v0}, Lj$/time/chrono/n;->p(Lj$/time/temporal/n;)Lj$/time/chrono/b;

    move-result-object v0

    iget-object v1, p0, Lj$/time/format/k;->a:Lj$/time/temporal/TemporalField;

    invoke-interface {v0, v1}, Lj$/time/temporal/n;->o(Lj$/time/temporal/TemporalField;)I
    ...
    invoke-virtual {p1, v8}, Lj$/time/format/w;->a(Lj$/time/format/p;)V
