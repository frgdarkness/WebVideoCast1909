...
.method private g(Ljava/util/Locale;)Lj$/time/format/k;
    ...
    invoke-virtual {v1, v2, v3}, Lj$/time/d;->R(J)Lj$/time/d;
    ...
    invoke-static {v0, p1}, Lj$/time/temporal/w;->g(Lj$/time/d;I)Lj$/time/temporal/w;
    ...
    invoke-virtual {p1}, Lj$/time/temporal/w;->j()Lj$/time/temporal/TemporalField;
    ...
    :cond_1
    invoke-virtual {p1}, Lj$/time/temporal/w;->d()Lj$/time/temporal/TemporalField;
    ...
    :cond_2
    invoke-virtual {p1}, Lj$/time/temporal/w;->h()Lj$/time/temporal/TemporalField;
    ...
    sget-object v0, Lj$/time/format/q;->i:Lj$/time/g;

    iget v2, p0, Lj$/time/format/k;->e:I

    invoke-direct {p1, v1, v0, v2}, Lj$/time/format/q;-><init>(Lj$/time/temporal/TemporalField;Lj$/time/chrono/b;I)V
    ...
    :cond_5
    invoke-virtual {p1}, Lj$/time/temporal/w;->i()Lj$/time/temporal/TemporalField;
