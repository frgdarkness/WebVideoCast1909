...
.method constructor <init>(Lj$/time/temporal/TemporalField;IIZ)V
    ...
    invoke-direct/range {v0 .. v5}, Lj$/time/format/h;-><init>(Lj$/time/temporal/TemporalField;IIZI)V
...
.method final e()Lj$/time/format/k;
    ...
    invoke-direct/range {v2 .. v7}, Lj$/time/format/h;-><init>(Lj$/time/temporal/TemporalField;IIZI)V
...
.method public final o(Lj$/time/format/y;Ljava/lang/StringBuilder;)Z
    ...
    invoke-interface {v0}, Lj$/time/temporal/TemporalField;->o()Lj$/time/temporal/u;

    move-result-object v1

    invoke-virtual {v1, v0, v3, v4}, Lj$/time/temporal/u;->b(Lj$/time/temporal/TemporalField;J)V
...
.method public final q(Lj$/time/format/w;Ljava/lang/CharSequence;I)I
    ...
    invoke-virtual {p0, p1}, Lj$/time/format/h;->c(Lj$/time/format/w;)Z
    ...
    iget-object p3, p0, Lj$/time/format/k;->a:Lj$/time/temporal/TemporalField;

    invoke-interface {p3}, Lj$/time/temporal/TemporalField;->o()Lj$/time/temporal/u;
    ...
    iget-object v5, p0, Lj$/time/format/k;->a:Lj$/time/temporal/TemporalField;
