...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v4, v1, v3}, Lj$/time/chrono/A;-><init>(ILj$/time/g;Ljava/lang/String;)V
    ...
    invoke-static {v4, v5, v3}, Lj$/time/g;->c0(III)Lj$/time/g;
    ...
    invoke-direct {v1, v4, v3, v5}, Lj$/time/chrono/A;-><init>(ILj$/time/g;Ljava/lang/String;)V
    ...
    invoke-static {v6, v7, v5}, Lj$/time/g;->c0(III)Lj$/time/g;

    move-result-object v5

    const-string v6, "Showa"

    invoke-direct {v3, v2, v5, v6}, Lj$/time/chrono/A;-><init>(ILj$/time/g;Ljava/lang/String;)V
    ...
    invoke-static {v6, v2, v7}, Lj$/time/g;->c0(III)Lj$/time/g;
    ...
    invoke-direct {v5, v7, v6, v8}, Lj$/time/chrono/A;-><init>(ILj$/time/g;Ljava/lang/String;)V
    ...
    invoke-static {v8, v9, v2}, Lj$/time/g;->c0(III)Lj$/time/g;
    ...
    invoke-direct {v6, v10, v8, v11}, Lj$/time/chrono/A;-><init>(ILj$/time/g;Ljava/lang/String;)V
...
.method private constructor <init>(ILj$/time/g;Ljava/lang/String;)V
    ...
    iput-object p2, p0, Lj$/time/chrono/A;->b:Lj$/time/g;
...
.method public static E()[Lj$/time/chrono/A;
    .locals 2
...
.method static h(Lj$/time/g;)Lj$/time/chrono/A;
    .locals 4

    sget-object v0, Lj$/time/chrono/z;->d:Lj$/time/g;

    invoke-virtual {p0, v0}, Lj$/time/g;->Y(Lj$/time/chrono/b;)Z
    ...
    iget-object v3, v2, Lj$/time/chrono/A;->b:Lj$/time/g;

    invoke-virtual {p0, v3}, Lj$/time/g;->M(Lj$/time/chrono/b;)I
...
.method static u()J
    ...
    iget-object v6, v5, Lj$/time/chrono/A;->b:Lj$/time/g;

    invoke-virtual {v6}, Lj$/time/g;->L()I

    move-result v6

    iget-object v7, v5, Lj$/time/chrono/A;->b:Lj$/time/g;

    invoke-virtual {v7}, Lj$/time/g;->V()I
    ...
    iget-object v5, v5, Lj$/time/chrono/A;->b:Lj$/time/g;

    invoke-virtual {v5}, Lj$/time/g;->V()I
...
.method static x()J
    ...
    iget-object v0, v0, Lj$/time/chrono/A;->b:Lj$/time/g;
    ...
    invoke-virtual {v6}, Lj$/time/g;->X()I
    ...
    iget-object v0, v5, Lj$/time/chrono/A;->b:Lj$/time/g;
...
.method final m()Lj$/time/g;
    .locals 1

    iget-object v0, p0, Lj$/time/chrono/A;->b:Lj$/time/g;
...
.method public final r(Lj$/time/temporal/TemporalField;)Lj$/time/temporal/u;
    ...
    invoke-virtual {p1, v0}, Lj$/time/chrono/x;->I(Lj$/time/temporal/ChronoField;)Lj$/time/temporal/u;
