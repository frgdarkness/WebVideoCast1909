...
.method public constructor <init>(Lj$/util/Spliterator;Lj$/util/stream/X3;I)V
    ...
    iput-boolean p3, p0, Lj$/util/stream/X3;->d:Z
    ...
    iget-object p1, p2, Lj$/util/stream/X3;->c:Ljava/util/concurrent/atomic/AtomicBoolean;

    iput-object p1, p0, Lj$/util/stream/X3;->c:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public final accept(Ljava/lang/Object;)V
    ...
    iput v0, p0, Lj$/util/stream/X3;->e:I
...
.method final b(Lj$/util/Spliterator;)Lj$/util/Spliterator;
    ...
    invoke-direct {v0, p1, p0, v1}, Lj$/util/stream/X3;-><init>(Lj$/util/Spliterator;Lj$/util/stream/X3;I)V
...
.method public final tryAdvance(Ljava/util/function/Consumer;)Z
    ...
    iget-boolean v0, p0, Lj$/util/stream/X3;->d:Z

    iget-object v1, p0, Lj$/util/stream/X3;->c:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-object v0, p0, Lj$/util/stream/X3;->f:Ljava/util/function/Predicate;

    iget-object v3, p0, Lj$/util/stream/X3;->g:Ljava/lang/Object;
    ...
    iput-boolean p1, p0, Lj$/util/stream/X3;->d:Z
    ...
    iput-boolean v0, p0, Lj$/util/stream/X3;->d:Z
    ...
    iget-object v3, p0, Lj$/util/stream/X3;->c:Ljava/util/concurrent/atomic/AtomicBoolean;

    const/4 v4, 0x1

    if-eqz v2, :cond_5

    iget v5, p0, Lj$/util/stream/X3;->e:I
    ...
    :cond_4
    iget-object v5, p0, Lj$/util/stream/X3;->f:Ljava/util/function/Predicate;
...
.method public trySplit()Lj$/util/Spliterator;
    ...
    invoke-virtual {p0}, Lj$/util/stream/X3;->c()Lj$/util/Spliterator;
    ...
    :pswitch_0
    iget-object v0, p0, Lj$/util/stream/X3;->c:Ljava/util/concurrent/atomic/AtomicBoolean;
