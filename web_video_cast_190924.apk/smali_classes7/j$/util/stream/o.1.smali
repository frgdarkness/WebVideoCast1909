...
# direct methods
.method static R(Lj$/util/stream/b;Lj$/util/Spliterator;)Lj$/util/stream/P0;
    .locals 7
...
.method final H(Lj$/util/stream/b;Lj$/util/Spliterator;Ljava/util/function/IntFunction;)Lj$/util/stream/L0;
    ...
    invoke-virtual {p1, p2, v1, p3}, Lj$/util/stream/b;->v(Lj$/util/Spliterator;ZLjava/util/function/IntFunction;)Lj$/util/stream/L0;
    ...
    :cond_0
    sget-object p3, Lj$/util/stream/i3;->ORDERED:Lj$/util/stream/i3;

    invoke-virtual {p1}, Lj$/util/stream/b;->D()I

    move-result v0

    invoke-virtual {p3, v0}, Lj$/util/stream/i3;->v(I)Z

    move-result p3

    if-eqz p3, :cond_1

    invoke-static {p1, p2}, Lj$/util/stream/o;->R(Lj$/util/stream/b;Lj$/util/Spliterator;)Lj$/util/stream/P0;
    ...
    invoke-direct {v2, v3, p3, v0}, Lj$/util/stream/q0;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V
...
.method final K(ILj$/util/stream/s2;)Lj$/util/stream/s2;
    ...
    invoke-direct {p1, p2}, Lj$/util/stream/m;-><init>(Lj$/util/stream/s2;)V
    ...
    invoke-direct {p1, p2}, Lj$/util/stream/n;-><init>(Lj$/util/stream/s2;)V
