...
.method constructor <init>(Lj$/util/stream/b;Lj$/util/Spliterator;Z)V
    ...
    iput-object p1, p0, Lj$/util/stream/k3;->b:Lj$/util/stream/b;

    const/4 p1, 0x0

    iput-object p1, p0, Lj$/util/stream/k3;->c:Ljava/util/function/Supplier;

    iput-object p2, p0, Lj$/util/stream/k3;->d:Lj$/util/Spliterator;

    iput-boolean p3, p0, Lj$/util/stream/k3;->a:Z
...
.method constructor <init>(Lj$/util/stream/b;Ljava/util/function/Supplier;Z)V
    ...
    iput-object p2, p0, Lj$/util/stream/k3;->c:Ljava/util/function/Supplier;

    const/4 p1, 0x0

    iput-object p1, p0, Lj$/util/stream/k3;->d:Lj$/util/Spliterator;
...
.method private b()Z
    ...
    iget-object v0, p0, Lj$/util/stream/k3;->e:Lj$/util/stream/s2;
    ...
    iget-object v0, p0, Lj$/util/stream/k3;->f:Ljava/util/function/BooleanSupplier;
    ...
    iput-boolean v4, p0, Lj$/util/stream/k3;->i:Z
...
.method final a()Z
    ...
    invoke-virtual {p0}, Lj$/util/stream/k3;->d()V

    iput-wide v1, p0, Lj$/util/stream/k3;->g:J
    ...
    invoke-interface {v0, v1, v2}, Lj$/util/stream/s2;->l(J)V

    invoke-direct {p0}, Lj$/util/stream/k3;->b()Z
    ...
    :cond_1
    iget-wide v4, p0, Lj$/util/stream/k3;->g:J

    const-wide/16 v6, 0x1

    add-long/2addr v4, v6

    iput-wide v4, p0, Lj$/util/stream/k3;->g:J
...
.method final c()V
    ...
    iget-object v0, p0, Lj$/util/stream/k3;->c:Ljava/util/function/Supplier;
    ...
    iput-object v0, p0, Lj$/util/stream/k3;->c:Ljava/util/function/Supplier;
...
.method public final characteristics()I
    ...
    invoke-virtual {v0}, Lj$/util/stream/b;->D()I

    move-result v0

    invoke-static {v0}, Lj$/util/stream/i3;->Q(I)I

    move-result v0

    sget v1, Lj$/util/stream/i3;->f:I
...
.method abstract e(Lj$/util/Spliterator;)Lj$/util/stream/k3;
.end method
...
.method public final getExactSizeIfKnown()J
    ...
    invoke-virtual {v1}, Lj$/util/stream/b;->D()I
...
.method public trySplit()Lj$/util/Spliterator;
    ...
    iget-boolean v0, p0, Lj$/util/stream/k3;->a:Z
    ...
    :cond_0
    invoke-virtual {p0, v0}, Lj$/util/stream/k3;->e(Lj$/util/Spliterator;)Lj$/util/stream/k3;
