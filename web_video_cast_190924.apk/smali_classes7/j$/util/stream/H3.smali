...
.method protected abstract f(I)Lj$/util/stream/o3;
.end method
...
.method public final forEachRemaining(Ljava/lang/Object;)V
    ...
    :goto_0
    invoke-virtual {p0}, Lj$/util/stream/K3;->d()Lj$/util/stream/J3;

    move-result-object v1

    sget-object v2, Lj$/util/stream/J3;->NO_MORE:Lj$/util/stream/J3;

    if-eq v1, v2, :cond_5

    sget-object v2, Lj$/util/stream/J3;->MAYBE_MORE:Lj$/util/stream/J3;

    iget-object v3, p0, Lj$/util/stream/K3;->a:Lj$/util/Spliterator;

    if-ne v1, v2, :cond_4

    iget v1, p0, Lj$/util/stream/K3;->c:I

    if-nez v0, :cond_0

    invoke-virtual {p0, v1}, Lj$/util/stream/H3;->f(I)Lj$/util/stream/o3;
    ...
    iput v2, v0, Lj$/util/stream/o3;->b:I
    ...
    invoke-interface {v2, v0}, Lj$/util/L;->tryAdvance(Ljava/lang/Object;)Z
    ...
    :cond_3
    invoke-virtual {p0, v6, v7}, Lj$/util/stream/K3;->b(J)J
...
.method public final tryAdvance(Ljava/lang/Object;)Z
    ...
    sget-object v1, Lj$/util/stream/J3;->NO_MORE:Lj$/util/stream/J3;
    ...
    invoke-virtual {p0, v0, v1}, Lj$/util/stream/K3;->b(J)J
    ...
    invoke-virtual {p0, p1}, Lj$/util/stream/H3;->e(Ljava/lang/Object;)V
